...
;(function ($) {
  ...
  function updateMenu() {
    ...
    for (var i = 0, len = elements.length; i < len; i++) {
      if (
        ...
        elements[i].parentElement.getAttribute('class') === 'nav-item dropdown active'
      ) {
  ...
  function layoutSetting() {
    ...
    body.hasAttribute('data-layout-mode') && body.getAttribute('data-layout-mode') == 'dark'
      ? updateRadio('layout-mode-dark')
      : updateRadio('layout-mode-light')
    body.hasAttribute('data-layout-size') && body.getAttribute('data-layout-size') == 'boxed'
    ...
    body.hasAttribute('data-topbar') && body.getAttribute('data-topbar') == 'dark'
      ? updateRadio('topbar-color-dark')
      : updateRadio('topbar-color-light')
    body.hasAttribute('data-sidebar-size') && body.getAttribute('data-sidebar-size') == 'sm'
      ? updateRadio('sidebar-size-small')
      : body.hasAttribute('data-sidebar-size') && body.getAttribute('data-sidebar-size') == 'md'
        ? updateRadio('sidebar-size-compact')
        : updateRadio('sidebar-size-default')
    body.hasAttribute('data-sidebar') && body.getAttribute('data-sidebar') == 'brand'
      ? updateRadio('sidebar-color-brand')
      : body.hasAttribute('data-sidebar') && body.getAttribute('data-sidebar') == 'dark'

;(function (g) {
  'function' === typeof define && define.amd
    ? define(['jquery', 'datatables.net', 'datatables.net-buttons'], function (j) {
  ...
  function x(a) {
    r === p &&
      (r = -1 === v.serializeToString(g.parseXML(q['xl/worksheets/sheet1.xml'])).indexOf('xmlns:r'))
      ...
      if (g.isPlainObject(d)) x(d)
        ...
        if (r) {
          ...
          for (e = c.attributes.length - 1; 0 <= e; e--) {
            ...
            ;-1 !== f.indexOf(':') && (i.push({ name: f, value: k }), c.removeAttribute(f))
          }
          e = 0
          for (f = i.length; e < f; e++)
            (k = d.createAttribute(i[e].name.replace(':', '_dt_b_namespace_token_'))),
              (k.value = i[e].value),
        ...
        var d = z(b),
          ...
          j = function (a) {
            for (var b = '', c = 0, d = a.length; c < d; c++)
              0 < c && (b += f), (b += e ? e + ('' + a[c]).replace(g, i + e) + e : a[c])
            return b
          },
  ...
  h.Buttons.swfPath = '//cdn.datatables.net/buttons/' + h.Buttons.version + '/swf/flashExport.swf'
    ...
    action: function (a, b, d, c) {
      ...
      var a = c._flash,
        ...
        d = {
          ...
          xl: {
            _rels: { 'workbook.xml.rels': g.parseXML(q['xl/_rels/workbook.xml.rels']) },
          ...
          for (var b = 0, d = a.length; b < d; b++) {
            ...
            for (var k = 0, n = B.length; k < n; k++) {
              ...
              if (a[b].match && !a[b].match(/^0\d+/) && a[b].match(l.match)) {
                h = a[b].replace(/[^\d\.\-]/g, '')
                l.fmt && (h = l.fmt(h))
                h = o(f, 'c', { attr: { r: g, s: l.style }, children: [o(f, 'v', { text: h })] })
                break
              }
            }
            h ||
              ...
              (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                ? (h = o(f, 'c', { attr: { t: 'n', r: g }, children: [o(f, 'v', { text: a[b] })] }))
                : ((l = !a[b].replace
                    ? a[b]
                    : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, '')),
                  (h = o(f, 'c', {
                    attr: { t: 'inlineStr', r: g },
                    children: { row: o(f, 'is', { children: { row: o(f, 't', { text: l }) } }) },
                  }))))
            m.appendChild(h)
          }
          i.appendChild(m)
      ...
      c.footer && k.footer && (h(k.footer, e), g('row:last c', f).attr('s', '2'))
      ...
      for (s = k.header.length; n < s; n++)
        h.appendChild(
          o(f, 'col', { attr: { min: n + 1, max: n + 1, width: C(k, n), customWidth: 1 } })
        )

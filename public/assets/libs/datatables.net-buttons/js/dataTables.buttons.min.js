...
;(function (e) {
  ...
  e.extend(n.prototype, {
    ...
    add: function (a, b) {
      ...
      if ('string' === typeof b) {
        for (var d = b.split('-'), e = this.s, c = 0, f = d.length - 1; c < f; c++)
          e = e.buttons[1 * d[c]]
        c = e.buttons
        b = 1 * d[d.length - 1]
      }
    ...
    _expandButton: function (a, b, c, d) {
      for (
        var g = this.s.dt, f = 0, b = !Array.isArray(b) ? [b] : b, h = 0, k = b.length;
        h < k;
        h++
      ) {
    ...
    _popover: function (a, b, c) {
      var d = this.c,
        ...
        h = function () {
          ...
          e(b.buttons('[aria-haspopup="true"][aria-expanded="true"]').nodes()).attr(
            'aria-expanded',
            'false'
          )
      ...
      g.collectionTitle &&
        c.prepend('<div class="dt-button-collection-title">' + g.collectionTitle + '</div>')
      ...
      if (
        ...
        c.hasClass(g.rightAlignClassName)
          ? ((o = p - s),
            l > k + o && ((k = l - (k + o)), (d -= s + o), (o = k > d ? o + d : o + k)))
          : ((o = l - k),
            d < s + o && ((k = l - (k + o)), (d -= s + o), (o = k > d ? o + d : o + k)))
      ...
      e('body')
        .on('click.dtb-collection', function (b) {
          ...
          ;((!e(b.target).parents()[c]().filter(a).length && !e(d).hasClass('dt-buttons')) ||
        ...
        g = function (a, b) {
          ...
          if (Array.isArray(a) || a instanceof e) {
            ...
            if (-1 !== a.indexOf(',')) {
              ...
              f = 0
              for (h = i.length; f < h; f++) i[f].name === n && c.push({ inst: b, node: i[f].node })
            } else
              e(f)
                .filter(a)
                .each(function () {
  ...
  i.Api.register('buttons().containers()', function () {
    ...
    this.iterator(!0, 'table', function (c) {
      if (c._buttons)
        for (var c = n.instanceSelector(b, c._buttons), d = 0, e = c.length; d < e; d++)
  ...
  i.Api.register('button().add()', function (a, b) {
    var c = this.context
    c.length &&
      ((c = n.instanceSelector(this._groupSelector, c[0]._buttons)), c.length && c[0].add(b, a))
  ...
  i.Api.register('buttons.exportInfo()', function (a) {
    ...
    b === m || null === b
      ? (b = null)
      : (-1 !== b.indexOf('*') && (b = b.replace('*', e('head > title').text()).trim()),

  ...
  a.sessionTimeout = function (b) {
    ...
    function d() {
      clearTimeout(g),
        ...
        (g = setTimeout(function () {
          'function' != typeof i.onWarn ? a('#session-timeout-dialog').modal('show') : i.onWarn(i),
            e()
        }, i.warnAfter))
    }
    function e() {
    ...
    function f(b, c) {
      clearTimeout(j.timer),
        'dialog' === b && c
          ...
          : 'session' === b && c && (j.timeLeft = Math.floor(i.redirAfter / 1e3)),
    ...
    if ('function' != typeof i.onWarn) {
      var k = i.countdownMessage
          ? '<p>' +
            i.countdownMessage.replace(/{timer}/g, '<span class="countdown-holder"></span>') +
            '</p>'
          : '',
        l = i.countdownBar

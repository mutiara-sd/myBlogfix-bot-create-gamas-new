...
;(function (d) {
  ...
  function r(a, b, c) {
    ...
    if (n[e]) {
      for (
        var a = a.cell(b, c).node(), c = n[e][0].parentNode.childNodes, b = [], d = 0, g = c.length;
        d < g;
        d++
      )
        b.push(c[d])
  ...
  d.extend(i.prototype, {
    ...
    _columnsVisiblity: function (a) {
      ...
      for (f = g.length; e < f; e++) {
        ...
        '-' === j[k] &&
          !c[k].control &&
          c[k].minWidth &&
          (s || 0 > h - c[k].minWidth ? ((s = !0), (j[k] = !1)) : (j[k] = !0), (h -= c[k].minWidth))
      }
      g = !1
      e = 0
    ...
    _detailsDisplay: function (a, b) {
      ...
      if (f && !1 !== f.type) {
        ...
        ;(!0 === g || !1 === g) &&
          d(e.table().node()).triggerHandler('responsive-display.dt', [e, a, g, b])
      }
    },
        ...
        d(b.table().body()).on(
          ...
          function (c) {
            if (
              ...
              d.inArray(d(this).closest('tr').get(0), b.rows().nodes().toArray()) !== -1
            ) {
              if (typeof e === 'number') {
              ...
              c.type === 'click'
                ...
                : c.type === 'mousedown'
                  ...
                  : c.type === 'mouseup' && d(this).trigger('blur').css('outline', '')
            }
          }
        )
    },
    ...
    _resize: function (a) {
      ...
      l &&
        ...
        d(c.table().node()).trigger('responsive-resize.dt', [c, this.s.current]),
        0 === c.page.info().recordsDisplay && d('td', c.table().body()).eq(0).attr('colspan', n))
      b._controlClass()
    },

    ...
    c.on('mousedown.dtSelect', d, function (b) {
      ...
      .on('click.dtSelect', d, function (b) {
        ...
        if (f) {
          ...
          if (
            (!d.anchorNode || e(d.anchorNode).closest('table')[0] === a.table().node()) &&
            d !== f
          )
            return
        }
      ...
      'os' === e
        ? a.ctrlKey || a.metaKey
          ...
          : a.shiftKey
            ...
            : ((a = c[d + 's']({ selected: !0 })),
              j && 1 === a.flatten().length ? c[d](f).deselect() : (a.deselect(), c[d](f).select()))
        : 'multi+shift' == e
          ? a.shiftKey
            ? 'cell' === d
              ? x(c, f, b._select_lastCell || null)
    ...
    function (a, c) {
      g.ext.selector[c.type].push(function (b, a, f) {
        ...
        for (var j = 0, k = f.length; j < k; j++)
          (e = b[c.prop][f[j]]),
            ((!0 === a && !0 === e._select_selected) || (!1 === a && !e._select_selected)) &&
              g.push(f[j])
        return g
      })
    }
      ...
      : this.iterator('table', function (c) {
          ...
          if (!c._select_init) {
            ...
            b.on('draw.dtSelect.dt select.dtSelect.dt deselect.dtSelect.dt info.dt', function () {
              var a = b.settings()[0]
              if (a._select.info && a.aanFeatures.i && 'api' !== b.select.style()) {

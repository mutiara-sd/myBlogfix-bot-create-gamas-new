...
var TimeGridEventRenderer = /** @class */ (function (_super) {
  ...
  TimeGridEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
    ...
    var isResizableFromStart =
      seg.isStart && computeEventStartResizable(this.context, eventDef, eventUi)
    ...
    return (
      ...
      (timeText
        ? '<div class="fc-time"' +
          ...
          '</div>'
        : '') +
      (eventDef.title ? '<div class="fc-title">' + htmlEscape(eventDef.title) + '</div>' : '') +
      '</div>' +
...
var TimeGrid = /** @class */ (function (_super) {
  ...
  function TimeGrid(el, renderProps) {
    ...
    _this.renderColumns = memoizeRendering(_this._renderColumns, _this._unrenderColumns, [
  ...
  TimeGrid.prototype.computeTimeTop = function (duration) {
    ...
    var slatCoverage =
      (duration.milliseconds - asRoughMs(dateProfile.minTime)) / asRoughMs(this.slotDuration) // floating-point value of # of slots covered
    var slatIndex
    var slatRemainder
    ...
    return (
      this.slatPositions.tops[slatIndex] + this.slatPositions.getHeight(slatIndex) * slatRemainder
    )
  }
...
var SimpleTimeGrid = /** @class */ (function (_super) {
  ...
  SimpleTimeGrid.prototype.render = function (props, context) {
    ...
    timeGrid.receiveProps(
      __assign(
        {},
        this.slicer.sliceProps(props, dateProfile, null, context.calendar, timeGrid, dayRanges),

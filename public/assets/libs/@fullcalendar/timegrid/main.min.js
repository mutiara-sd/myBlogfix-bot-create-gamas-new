...
!(function (e, t) {
    ...
    s = (function (e) {
      ...
      return (
        ...
        (r.prototype.attachSegs = function (e, t) {
          for (var r = this.timeGrid.groupSegsByCol(e), i = 0; i < r.length; i++)
            ...
            ((function (e) {
              ...
              for (t = 0; t < e.length; t++)
                for (r = e[t], i = 0; i < r.length; i++)
                  for ((n = r[i]).forwardSegs = [], o = t + 1; o < e.length; o++)
        ...
        (r.prototype.assignSegCss = function (e) {
          for (var r = 0, i = e; r < i.length; r++) {
            ...
            t.applyStyle(n.el, this.generateSegCss(n)),
              ...
              n.eventRange.def.title && n.bottom - n.top < 30 && n.el.classList.add('fc-short')
          }
        }),
    ...
    p = (function (e) {
      function i(r, i) {
        ...
        ;(n.isSlatSizesDirty = !1),
          ...
          (n.renderColumns = t.memoizeRendering(n._renderColumns, n._unrenderColumns, [
            n.renderSkeleton,
          ])),
          (n.renderProps = i)
        ...
        return (
          ...
          (n.renderEventResize = t.memoizeRendering(n._renderEventResize, n._unrenderEventResize, [
            o,
          ])),
          n
        )
      ...
      return (
        ...
        (i.prototype._processOptions = function (e) {
          ...
          ;(n = t.createDuration(n)),
            ...
            (this.labelFormat = t.createFormatter(
              i || { hour: 'numeric', minute: '2-digit', omitZeroMinute: !0, meridiem: 'short' }
            )),
        ...
        (i.prototype.computeLabelInterval = function (e) {
          ...
          for (r = u.length - 1; r >= 0; r--)
            if (
              ((i = t.createDuration(u[r])), null !== (n = t.wholeDivideDurations(i, e)) && n > 1)
            )
              return i
          return e
        }),
          ...
          for (
            ...
            (r = s.add(c, h)),
              ...
              (n =
                ...
                '">' +
                (i ? '<span>' + t.htmlEscape(s.format(r, this.labelFormat)) + '</span>' : '') +
                '</td>'),
              (d +=
                '<tr data-time="' +
        ...
        (i.prototype.renderContentSkeleton = function () {
          ...
          r && i.reverse(),
            (e = this.contentSkeletonEl =
              t.htmlToElement(
                '<div class="fc-content-skeleton"><table><tr>' + i.join('') + '</tr></table></div>'
              )),
        ...
        (i.prototype.unrenderNowIndicator = function () {
          this.nowIndicatorEls &&
            (this.nowIndicatorEls.forEach(t.removeElement), (this.nowIndicatorEls = null))
        }),
        ...
        (i.prototype.positionToHit = function (e, r) {
          ...
          if (null != a && null != l) {
            ...
            return {
              col: a,
              dateSpan: { range: { start: g, end: i.add(g, this.snapDuration) }, allDay: !1 },
              dayEl: this.colEls[a],
              relativeRect: { left: s.lefts[a], right: s.rights[a], top: d, bottom: d + c },
            }
          }
        }),
        ...
        (i.prototype._renderDateSelection = function (e) {
          e &&
            (this.context.options.selectMirror
              ? this.mirrorRenderer.renderSegs(this.context, e, { isSelecting: !0 })
              : this.fillRenderer.renderSegs('highlight', this.context, e))
        }),
        (i.prototype._unrenderDateSelection = function (e) {
          e &&
            (this.context.options.selectMirror
              ? this.mirrorRenderer.unrender(this.context, e, { isSelecting: !0 })
              : this.fillRenderer.unrender('highlight', this.context))
        }),
        i
      )
      ...
      return (
        ...
        (i.prototype.updateBaseSize = function (e, r, i) {
          var n,
            ...
            a = this
          if (
            ((this.axisWidth = t.matchCellWidths(t.findElements(this.el, '.fc-axis'))),
            ...
            ;(this.timeGrid.bottomRuleEl.style.display = 'none'),
              ...
              this.dayGrid &&
                ...
                (n = this.context.options.eventLimit) && 'number' != typeof n && (n = 5),
          ...
          this.header &&
            ...
            this.simpleDayGrid &&
              this.simpleDayGrid.receiveProps(
                o({}, d.allDay, { dateProfile: n, dayTable: l, nextDayThreshold: a, isRigid: !1 }),
                r
              ),
  ...
  var b = t.createPlugin({
    ...
    views: {
      timeGrid: { class: C, allDaySlot: !0, slotDuration: '00:30:00', slotEventOverlap: !0 },

...
var SimpleDayGridEventRenderer = /** @class */ (function (_super) {
  ...
  SimpleDayGridEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
    ...
    var isResizableFromStart =
      allDay && seg.isStart && computeEventStartResizable(context, eventDef, eventUi)
    var isResizableFromEnd =
      allDay && seg.isEnd && computeEventEndResizable(context, eventDef, eventUi)
  ...
  SimpleDayGrid.prototype.render = function (props, context) {
    ...
    dayGrid.receiveProps(
      __assign(
        ...
        { dateProfile: dateProfile, cells: dayTable.cells, isRigid: props.isRigid }
      ),
      context
    )
  }

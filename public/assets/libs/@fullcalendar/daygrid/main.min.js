      ...
      return (
        ...
        (r.prototype.buildRenderRange = function (r, n, i) {
          ...
          if (
            (/^(year|month)$/.test(n) &&
              ((a = s.startOfWeek(a)),
              (o = s.startOfWeek(d)).valueOf() !== d.valueOf() && (d = t.addWeeks(o, 1))),
    ...
    s = (function () {
      ...
      return (
        ...
        (e.prototype.hide = function () {
          this.isHidden ||
            ((this.el.style.display = 'none'), (this.isHidden = !0), this.trigger('hide'))
        }),
      ...
      return (
        ...
        (r.prototype.renderSegHtml = function (e, r) {
          ...
          return (
            ...
            (i = '<span class="fc-title">' + (t.htmlEscape(l.title || '') || '&nbsp;') + '</span>'),
            '<a class="' +
              u.join(' ') +
              '"' +
          ...
          for (n = 0; n < f; n++) {
            if (
              ...
              for (l = 0; l < i.length; l++) {
                ...
                for (
                  b(S),
                    d = t.createElement('td', { className: 'fc-event-container' }, a.el),
  ...
  var h = (function (e) {
      ...
      return (
        ...
        (r.prototype.renderFillRow = function (e, r) {
          ...
          ;(n = 'businessHours' === e ? 'bgevent' : e.toLowerCase()),
            (o = (i = t.htmlToElement(
              '<div class="fc-' + n + '-skeleton"><table><tr></tr></table></div>'
            )).getElementsByTagName('tr')[0]),
            d > 0 &&
              t.appendToElement(o, new Array(d + 1).join('<td style="pointer-events:none"></td>')),
            (r.el.colSpan = c - d),
            o.appendChild(r.el),
            c < a &&
              t.appendToElement(
                o,
                new Array(a - c + 1).join('<td style="pointer-events:none"></td>')
              )
    ...
    u = (function (e) {
      function r(r) {
        ...
        return (
          (n.renderFgEvents = t.memoizeRendering(i.renderSegs.bind(i), i.unrender.bind(i), [o])),
          (n.renderEventSelection = t.memoizeRendering(
            i.selectByInstanceId.bind(i),
            i.unselectByInstanceId.bind(i),
            [n.renderFgEvents]
          )),
          (n.renderEventDrag = t.memoizeRendering(i.hideByHash.bind(i), i.showByHash.bind(i), [o])),
          (n.renderEventResize = t.memoizeRendering(i.hideByHash.bind(i), i.showByHash.bind(i), [
            o,
          ])),
          n
        )
      ...
      return (
        ...
        (r.prototype.firstContext = function (e) {
          e.calendar.registerInteractiveComponent(this, { el: this.el, useEventCenter: !1 })
        }),
      ...
      return (
        (e.prototype.renderHtml = function (e) {
          ...
          return (
            e.cells.length ||
              t.push(
                '<td class="fc-day ' + this.context.theme.getClass('widgetContent') + '"></td>'
              ),
    ...
    b = (function (e) {
      function r(r, n) {
        ...
        return (
          ...
          (i.renderFgEvents = t.memoizeRendering(o.renderSegs.bind(o), o.unrender.bind(o), [l])),
          (i.renderEventSelection = t.memoizeRendering(
            o.selectByInstanceId.bind(o),
            o.unselectByInstanceId.bind(o),
            [i.renderFgEvents]
          )),
          (i.renderEventDrag = t.memoizeRendering(i._renderEventDrag, i._unrenderEventDrag, [l])),
          (i.renderEventResize = t.memoizeRendering(i._renderEventResize, i._unrenderEventResize, [
            l,
          ])),
          i
        )
      ...
      return (
        ...
        (r.prototype._renderCells = function (e, r) {
          ...
          for (
            this.el.innerHTML = p,
              ...
              this.colPositions = new t.PositionCache(this.el, this.cellEls.slice(0, h), !0, !1),
              n = 0;
            n < c;
            n++
          )
            for (i = 0; i < h; i++)
              s.publiclyTrigger('dayRender', [
                { date: d.toDate(e[n][i].date), el: this.getCellEl(n, i), view: l },
              ])
        ...
        (r.prototype.renderNumberCellsHtml = function (e) {
          ...
          for (t = 0; t < this.colCnt; t++)
            (r = this.props.cells[e][t].date), n.push(this.renderNumberCellHtml(r))
          ...
          return d || this.renderProps.cellWeekNumbersVisible
            ? ((r = t.getDayClasses(e, this.props.dateProfile, this.context)).unshift('fc-day-top'),
              ...
              (l +=
                ...
                r.join(' ') +
                '"' +
                (a ? ' data-date="' + o.formatIso(e, { omitTime: !0 }) + '"' : '') +
                '>'),
              this.renderProps.cellWeekNumbersVisible &&
                e.getUTCDay() === n &&
              ...
              d &&
                (l += t.buildGotoAnchorHtml(s, o, e, { class: 'fc-day-number' }, o.format(e, y))),
              (l += '</td>'))
            : '<td></td>'
        }),
        ...
        (r.prototype.limitRows = function (e) {
          ...
          for (t = 0; t < n.length; t++)
            this.unlimitRow(t),
              !1 !== (r = !!e && ('number' == typeof e ? e : this.computeRowLevelLimit(t))) &&
                this.limitRow(t, r)
        }),
        (r.prototype.computeRowLevelLimit = function (e) {
          ...
          for (r = 0; r < o.length; r++)
            if (((n = o[r]).classList.remove('fc-limited'), n.getBoundingClientRect().bottom > i))
              return r
          return !1
        }),
        (r.prototype.limitRow = function (e, r) {
          ...
          if (r && r < w.segLevels.length) {
            for (
              ...
              for (R(H), c = [], d = 0; E <= k; )
                (a = this.getCellSegs(e, E, r)), c.push(a), (d += a.length), E++
              if (d) {
                for (p = (h = i[r - 1][H]).rowSpan || 1, u = [], f = 0; f < c.length; f++)
                  (m = t.createElement('td', { className: 'fc-more-cell', rowSpan: p })),
                    (a = c[f]),
        ...
        (r.prototype.showSegPopover = function (e, r, n, i) {
          ...
          ;(o = 1 === this.rowCnt ? h.el : this.rowEls[e]),
            ...
            f ? (l.right = t.computeRect(g).right + 1) : (l.left = t.computeRect(g).left - 1),
        ...
        (r.prototype.resliceDaySegs = function (e, r) {
          for (
            var n = r, o = { start: n, end: t.addDays(n, 1) }, s = [], l = 0, a = e;
            l < a.length;
            l++
          ) {
            var d = a[l],
        ...
        (r.prototype.getCellSegs = function (e, t, r) {
          for (
            var n, i = this.eventRenderer.rowStructs[e].segMatrix, o = r || 0, s = [];
            o < i.length;
      ...
      function r() {
        ...
        return (
          ...
          (r.renderDayGridIntroHtml = function () {
            return r.colWeekNumbersVisible
              ? '<td class="fc-week-number" ' + r.weekNumberStyleAttr() + '></td>'
              : ''
          }),
          r
        )
      ...
      return (
        ...
        (r.prototype.setGridHeight = function (e, r) {
          this.context.options.monthMode
            ? (r && (e *= this.dayGrid.rowCnt / 6), t.distributeHeight(this.dayGrid.rowEls, e, !r))
            : r
  ...
  var C = (function (e) {
      ...
      return (
        ...
        (t.prototype.firstContext = function (e) {
          e.calendar.registerInteractiveComponent(this, { el: this.dayGrid.el })
        }),
        ...
        (t.prototype.render = function (e, t) {
          ...
          r.receiveContext(t),
            r.receiveProps(
              i({}, this.slicer.sliceProps(e, n, e.nextDayThreshold, t.calendar, r, o), {
                dateProfile: n,
                cells: o.cells,
                isRigid: e.isRigid,
              }),
        ...
        (r.prototype._renderSkeleton = function (r) {
          e.prototype._renderSkeleton.call(this, r),
            r.options.columnHeader &&
              (this.header = new t.DayHeader(this.el.querySelector('.fc-head-container'))),

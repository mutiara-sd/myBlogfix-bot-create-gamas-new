...
var DateEnv = /** @class */ (function () {
  function DateEnv(settings) {
    ...
    this.weekLabel =
      settings.weekLabel != null ? settings.weekLabel : settings.locale.options.weekLabel
...
var Toolbar = /** @class */ (function (_super) {
  ...
  function Toolbar(extraClassName) {
    ...
    _this._updateActiveButton = memoizeRendering(_this.updateActiveButton, null, [
      _this._renderLayout,
    ])
...
var CalendarComponent = /** @class */ (function (_super) {
  ...
  function CalendarComponent(el) {
    ...
    _this.renderToolbars = memoizeRendering(_this._renderToolbars, _this._unrenderToolbars, [
...
function buildTheme(calendarOptions) {
  var themeClass =
    this.pluginSystem.hooks.themeClasses[calendarOptions.themeSystem] || StandardTheme
  ...
  View.prototype.startNowIndicator = function (dateProfile, dateProfileGenerator) {
    ...
    if (options.nowIndicator && !this.initialNowDate) {
      ...
      if (unit) {
        ...
        delay =
          dateEnv
            .add(dateEnv.startOf(this.initialNowDate, unit), createDuration(1, unit))
...
var Slicer = /** @class */ (function () {
  ...
  Slicer.prototype.sliceProps = function (
    ...
    return {
      ...
      businessHourSegs: this.sliceBusinessHours.apply(
        this,
        [props.businessHours, dateProfile, nextDayThreshold, calendar, component].concat(extraArgs)
      ),
      ...
      eventResize: this.sliceEventResize.apply(
        this,
        [props.eventResize, eventUiBases, dateProfile, nextDayThreshold, component].concat(
          extraArgs
        )
      ),
      eventSelection: props.eventSelection,
  ...
  Slicer.prototype.sliceNowDate = function (
    ...
    return this._sliceDateSpan.apply(
      this,
      [{ range: { start: date, end: addMs(date, 1) }, allDay: false }, {}, component].concat(
        extraArgs
      )
    )
  }

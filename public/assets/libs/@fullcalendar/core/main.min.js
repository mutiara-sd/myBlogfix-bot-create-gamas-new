...
!(function (e, t) {
  ...
  function T(e, t) {
    ...
    return (
      b() && 'rtl' === n.direction ? (u.scrollbarLeft = s) : (u.scrollbarRight = s),
      t &&
  ...
  function he(e, t, n, r) {
    ...
    for (var o in t) {
      var a = t[o]
      void 0 !== e[o]
        ? (i[o] = a === Function ? ('function' == typeof e[o] ? e[o] : null) : a ? a(e[o]) : e[o])
        : void 0 !== n[o]
          ? (i[o] = n[o])
          : a === String
            ? (i[o] = '')
  ...
  function Oe(e, t, n) {
    ...
    i)) {
      ...
      if (s.recurringDef) {
        ...
        for (
          var l = 0, c = be(s, u, t, n.dateEnv, n.pluginSystem.hooks.recurringTypes);
          l < c.length;
          l++
        ) {
          var d = c[l],
  ...
  function Le(e, t) {
    ...
    for (e.sort(Be), n = 0; n < e.length; n++)
      (r = e[n]).start > o && i.push({ start: o, end: r.start }), r.end > o && (o = r.end)
  ...
  function dt(e, t, n, r) {
    ...
    for (var c in e.defs) {
      'inverse-background' === (S = e.defs[c]).rendering &&
        (S.groupId ? ((i[S.groupId] = []), a[S.groupId] || (a[S.groupId] = S)) : (o[c] = []))
    }
  ...
  function bt(e, t, n, r, i) {
    ...
    return (
      ...
      r.startDelta &&
        n.durationEditable &&
        (u.range = { start: o.add(u.range.start, r.startDelta), end: u.range.end }),
      r.endDelta &&
        n.durationEditable &&
        (u.range = { start: u.range.start, end: o.add(u.range.end, r.endDelta) }),
      s && (u.range = { start: u.range.start, end: i.getDefaultEventEnd(t.allDay, u.range.start) }),
      t.allDay && (u.range = { start: B(u.range.start), end: B(u.range.end) }),
      u.range.end < u.range.start && (u.range.end = i.getDefaultEventEnd(t.allDay, u.range.start)),
      u
    )
  }
          ...
          for (var p in s) {
            ...
            for (var b = t.state.eventStore, D = 0, T = g.allows; D < T.length; D++) {
              var w = T[D],
                ...
                I = b.instances[p],
                M = void 0
              if (((M = C ? new ct(t, C, I) : new ct(t, y)), !w(t.buildDateSpanApi(R), M)))
                return !1
            }
          }
          return !0
  ...
  function Zt(e, t, n, r) {
      ...
      a = (function (e, t, n, r, i) {
        for (var o = 0; o < r.length; o++) {
          ...
          if (s) {
            ...
            return (
              delete a.allDay,
              null == u && null == (u = t) && null == (u = s.allDayGuess) && (u = !1),
              Se(i, a),
    ...
    var s,
      ...
      l = (function (e, t, n, r, i) {
        ...
        null == u &&
          (u = null != t ? t : (!o || o.isTimeUnspecified) && (!a || a.isTimeUnspecified))
        u && l && (l = B(l))
        ...
        d
          ...
          : i ||
            ...
            (d = n.dateEnv.add(l, u ? n.defaultAllDayEventDuration : n.defaultTimedEventDuration)))
        return {
          allDay: u,
          hasEnd: c,
          range: { start: l, end: d },
  ...
  function $t(e, t, n, r, i) {
    var o, a, s, u
    return (
      n instanceof Date ? (o = n) : ((o = n.date), (a = n.type), (s = n.forceOff)),
      ...
      return (
        ...
        (t.prototype.triggerWith = function (e, t, n) {
          return (
            ...
            this._oneHandlers && (de(this._oneHandlers[e], t, n), delete this._oneHandlers[e]),
            this
          )
        }),
        (t.prototype.hasHandlers = function (e) {
          return (
            ...
            (this._oneHandlers && this._oneHandlers[e] && this._oneHandlers[e].length)
          )
        }),
        t
      )
      ...
      return (
        ...
        (t.prototype.lockOverflow = function (e) {
          ...
          ;(e = e || this.getScrollbarWidths()),
            ...
            'auto' === n &&
              (n = e.left || e.right || this.canScrollVertically() ? 'scroll' : 'hidden'),
      ...
      return (
        ...
        (e.prototype.compute = function () {
          ...
          ;(this.dirDefaults = i),
            ...
            (this.computed = Te([Mn, i, r, this.overrides, this.dynamicOverrides], _n))
        }),
        e
      )
    })(),
      ...
      return (
        ...
        (e.prototype.createMarkerMeta = function (e) {
          ...
          return (
            ...
            null !== t && Y(t) ? { marker: t, isTimeUnspecified: !1, forcedTzo: null } : null
          )
        }),
        ...
        (e.prototype.toDate = function (e, t) {
          return 'local' === this.timeZone
            ...
            : 'UTC' === this.timeZone
              ? new Date(e.valueOf())
              : this.namedTimeZoneImpl
                ? new Date(e.valueOf() - 1e3 * this.namedTimeZoneImpl.offsetForArray(Z(e)) * 60)
  ...
  var $n = (function () {
    ...
    return (
      ...
      (e.prototype.buildValidRange = function () {
        return (
          this.getRangeOption('validRange', this.calendar.getNow()) || { start: null, end: null }
        )
      }),
        ...
        return (
          c ||
            ((i = this.options.dateIncrement)
              ...
              : (c = r)),
          ee(n) <= 1 && this.isHiddenDay(a) && (a = B((a = this.skipHiddenDays(a, t)))),
          d(),
  ...
  function ur(e, t, n) {
    var r = (function (e, t) {
        ...
        return (
          (n.range = { start: i ? i.marker : null, end: o ? o.marker : null }), (n.allDay = a), n
        )
      })(e, t),
      i = r.range
      ...
      function (e) {
        return (function (e, t, n) {
          ...
          return {
            ...
            buttonTextDefault:
              l(n.localeDefaults) || l(n.dirDefaults) || e.defaults.buttonText || l(Mn) || e.type,
          }
        })(e, r, t)
      }
    )
                      ...
                      : ((r = f[e])
                          ...
                          : (s = c[e])
                            ...
                            : u[e] &&
                              ...
                              (g = p[e]) || (v = a.getIconClass(e)) || (g = h[e])),
                        d &&
      ...
      return (
        ...
        (t.prototype._renderSkeleton = function (e) {
          this.updateElClassNames(e),
            u(this.el, (this.contentEl = r('div', { className: 'fc-view-container' })))
          for (
            var t = e.calendar, n = 0, i = t.pluginSystem.hooks.viewContainerModifiers;
            n < i.length;
            n++
          ) {
        ...
        (t.prototype._unrenderSkeleton = function () {
          this.view &&
            ((this.savedScroll = this.view.queryScroll()), this.view.destroy(), (this.view = null)),
            c(this.contentEl),
        ...
        (t.prototype._renderToolbars = function (e, t, n, r) {
          ...
          d
            ? (o || ((o = this.header = new gr('fc-header-toolbar')), u(this.el, o.el)),
              o.receiveProps(Se({ layout: d }, m), i))
            : o && (o.destroy(), (o = this.header = null)),
            f
              ? (a || ((a = this.footer = new gr('fc-footer-toolbar')), s(this.el, a.el)),
        ...
        (t.prototype.renderView = function (e, t) {
          ...
          ;(n && n.viewSpec === a) ||
            ...
            this.savedScroll && (n.addScroll(this.savedScroll, !0), (this.savedScroll = null))),
            (n.title = t)
          for (
            var u = {
              ...
              l = 0,
              c = this.buildViewPropTransformers(i.pluginSystem.hooks.viewPropsTransformers);
            l < c.length;
            l++
          ) {
            var d = c[l]
        ...
        (t.prototype.computeHeightVars = function () {
          ...
          if (((this.isHeightAuto = 'auto' === t || 'auto' === n), 'number' == typeof n))
            ...
            this.viewHeight = Math.round(
              this.contentEl.getBoundingClientRect().width / Math.max(e.opt('aspectRatio'), 0.5)
            )
        }),
  ...
  function mr(e, t) {
    var n
    return (
      (n = /^(year|month)$/.test(e.currentRangeUnit) ? e.currentRange : e.activeRange),
  ...
  var Dr = {},
    Tr = (function (e) {
      function t(t) {
        ...
        var r = t.component
        return (
          (n.destroy = _(r.el, 'click', r.fgSegSelector + ',' + r.bgSegSelector, n.handleSegClick)),
          n
        )
      }
      return Ee(t, e), t
    ...
    return (
        ...
        if ((this.actionQueue.push(e), !this.isReducing)) {
          ...
          ;(this.isReducing = !1),
            !t.loadingLevel && n.loadingLevel
              ...
              : t.loadingLevel && !n.loadingLevel && this.publiclyTrigger('loading', [!1])
          ...
          t.eventStore !== n.eventStore && t.eventStore && (this.isEventsUpdated = !0),
            t.dateProfile !== n.dateProfile &&
              (t.dateProfile && r && this.publiclyTrigger('datesDestroy', [{ view: r, el: r.el }]),
              (this.isDatesUpdated = !0)),
            t.viewType !== n.viewType &&
              (t.viewType &&
                r &&
                this.publiclyTrigger('viewSkeletonDestroy', [{ view: r, el: r.el }]),
      ...
      (e.prototype.renderComponent = function () {
        ...
        t.receiveProps(
          ...
          this.isViewUpdated &&
            ((this.isViewUpdated = !1),
            this.publiclyTrigger('viewSkeletonRender', [{ view: t.view, el: t.view.el }])),
          this.isDatesUpdated &&
            ((this.isDatesUpdated = !1),
            this.publiclyTrigger('datesRender', [{ view: t.view, el: t.view.el }])),
      ...
      (e.prototype.mutateOptions = function (e, t, n, r) {
        ...
        for (var p in a)
          /^(height|contentHeight|aspectRatio)$/.test(p)
            ? (c = !0)
            : /^(defaultDate|defaultView)$/.test(p) || ((d = !0), 'timeZone' === p && (l = !0))
            ...
            if (
              (d
                ? (l && i.dispatch({ type: 'CHANGE_TIMEZONE', oldDateEnv: u }),
                  i.dispatch({ type: 'SET_VIEW_TYPE', viewType: i.state.viewType }))
                : c && i.updateSize(),
              r)
            )
      ...
      (e.prototype.zoomTo = function (e, t) {
        ...
        ;(t = t || 'day'),
          ...
          this.unselect(),
          n
            ? this.dispatch({ type: 'SET_VIEW_TYPE', viewType: n.type, dateMarker: e })
      ...
      (e.prototype.gotoDate = function (e) {
        this.unselect(),
          this.dispatch({ type: 'SET_DATE', dateMarker: this.dateEnv.createMarker(e) })
      }),
      ...
      (e.prototype.select = function (e, t) {
        var n = ur(
          null == t ? (null != e.start ? e : { start: e, end: null }) : { start: e, end: t },
          this.dateEnv,
          J({ days: 1 })
        )
      ...
      (e.prototype.unselect = function (e) {
        this.state.dateSelection &&
          (this.dispatch({ type: 'UNSELECT_DATES' }), this.triggerDateUnselect(e))
      }),
      ...
      (e.prototype.buildDatePointApi = function (e) {
        for (
          var t, n, r = {}, i = 0, o = this.pluginSystem.hooks.datePointTransforms;
          i < o.length;
          i++
        ) {
          var a = o[i]
      ...
      (e.prototype.buildDateSpanApi = function (e) {
        for (
          var t, n, r = {}, i = 0, o = this.pluginSystem.hooks.dateSpanTransforms;
          i < o.length;
          i++
        ) {
          var a = o[i]
      ...
      (e.prototype.getDefaultEventEnd = function (e, t) {
        ...
        return (
          e
            ? ((n = B(n)), (n = this.dateEnv.add(n, this.defaultAllDayEventDuration)))
        ...
        if (e instanceof ct) {
          ...
          return (
            this.state.eventStore.defs[n.defId] ||
              this.dispatch({ type: 'ADD_EVENTS', eventStore: _e({ def: n, instance: r }) }),
            e
          )
        }
        var i
      ...
      (e.prototype.addEventSource = function (e) {
        ...
        var t = Yn(e, this)
        return t
          ? (this.dispatch({ type: 'ADD_EVENT_SOURCES', sources: [t] }), new lt(this, t))
          : null
      }),
  ...
  var xr = (function (e) {
    function t(t, n) {
      ...
      return (
        ...
        (i.renderBusinessHoursMem = Xt(i.renderBusinessHours, i.unrenderBusinessHours, [
          i.renderDatesMem,
        ])),
        ...
        (i.renderEventSelectionMem = Xt(i.renderEventSelectionWrap, i.unrenderEventSelectionWrap, [
          i.renderEventsMem,
        ])),
        (i.renderEventDragMem = Xt(i.renderEventDragWrap, i.unrenderEventDragWrap, [
          i.renderDatesMem,
        ])),
        (i.renderEventResizeMem = Xt(i.renderEventResizeWrap, i.unrenderEventResizeWrap, [
          i.renderDatesMem,
        ])),
        (i.viewSpec = t),
        (i.type = t.type),
    ...
    return (
      ...
      (t.prototype.updateNowIndicator = function () {
        this.props.dateProfile &&
          ...
          this.renderNowIndicator(
            N(this.initialNowDate, new Date().valueOf() - this.initialNowQueriedMs)
          ),
      ...
      (t.prototype.applyScroll = function (e, t) {
        ...
        null == n ||
          r ||
          (delete e.duration, this.props.dateProfile && Se(e, this.computeDateScroll(n))),
  ...
  var Ur = (function () {
      ...
      return (
        ...
        (e.prototype.renderSegs = function (e, t, n) {
          ...
          o &&
            (r = this.containerElsByType[e] || (this.containerElsByType[e] = [])).push.apply(r, o),
            (this.segsByType[e] = i),
            'bgEvent' === e && yt(t, i, !1),
  ...
  function Br(e) {
    ...
    return (
      (e = Se({ timeZone: Mn.timeZone, calendarSystem: 'gregory' }, e, { locale: t })), new Fn(e)
    )
  }
  ...
  function Wr(e, t, n, r, i, o, a, s) {
    ...
    return (
      ...
      '<th class="' +
        p.join(' ') +
        '"' +
        (f && n ? ' data-date="' + l.formatIso(e, { omitTime: !0 }) + '"' : '') +
        (a > 1 ? ' colspan="' + a + '"' : '') +
        (s ? ' ' + s : '') +
        '>' +
  ...
  var Zr = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function (e, t) {
          ...
          for (
            var o = ot(t.options.columnHeaderFormat || Fr(r, n.length)), a = 0, s = n;
            a < s.length;
            a++
          ) {
            var u = s[a]
    ...
    jr = (function () {
      function e(e, t) {
        for (var n = e.start, r = e.end, i = [], o = [], a = -1; n < r; )
          t.isHiddenDay(n) ? i.push(a + 0.5) : (a++, i.push(a), o.push(n)), (n = x(n, 1))
    ...
    qr = (function () {
      ...
      return (
        ...
        (e.prototype.sliceEventRange = function (e, t, n) {
          for (
            var r = this.sliceRange.apply(this, [e.range].concat(n)), i = 0, o = r;
            i < o.length;
            i++
          ) {
            var a = o[i]
  ...
  function Gr(e, t) {
    ...
    return t
      ? n
      : { start: N(n.start, e.minTime.milliseconds), end: N(n.end, e.maxTime.milliseconds - 864e5) }
  }
  ;(e.Calendar = Cr),
    (e.Component = vn),
    ...
    (e.distributeHeight = function (e, t, n) {
      ...
      re(e),
        ...
        n && ((t -= u), (r = Math.floor(t / o.length)), (i = Math.floor(t - r * (o.length - 1)))),
    ...
    (e.formatIsoTimeString = function (e) {
      return (
        le(e.getUTCHours(), 2) + ':' + le(e.getUTCMinutes(), 2) + ':' + le(e.getUTCSeconds(), 2)
      )
    }),

...
!(function (e, t) {
      ...
      return (
        ...
        (e.prototype.tryStart = function (e) {
          var n = this.querySubjectEl(e),
            r = e.target
          return (
            !(!n || (this.handleSelector && !t.elementClosest(r, this.handleSelector))) &&
            ((this.subjectEl = n),
            (this.downEl = r),
            (this.isDragging = !0),
            (this.wasTouchScroll = !1),
  ...
  var d = (function () {
      ...
      return (
        ...
        (e.prototype.cleanup = function () {
          this.mirrorEl && (t.removeElement(this.mirrorEl), (this.mirrorEl = null)),
            (this.sourceEl = null)
        }),
        ...
        (e.prototype.getMirrorEl = function () {
          ...
          return (
            n ||
              ((n = this.mirrorEl = this.sourceEl.cloneNode(!0)).classList.add('fc-unselectable'),
      ...
      return (
        ...
        (e.prototype.handleMove = function (e, t) {
          if (this.isEnabled) {
            ...
            i < 0 ? (this.everMovedUp = !0) : i > 0 && (this.everMovedDown = !0),
              ...
              this.isAnimating || ((this.isAnimating = !0), this.requestAnimation(p()))
          }
        }),
        ...
        (e.prototype.queryScrollEls = function () {
          for (var e = [], t = 0, n = this.scrollQuery; t < n.length; t++) {
            ...
            'object' == typeof r
              ? e.push(r)
              : e.push.apply(e, Array.prototype.slice.call(document.querySelectorAll(r)))
          }
          return e
        }),
        e
    ...
    E = (function () {
      ...
      return (
        ...
        (e.prototype.isWithinClipping = function (e, n) {
          for (var r, i, o = { left: e, top: n }, a = 0, l = this.scrollCaches; a < l.length; a++) {
            var s = l[a]
            if (
              ((r = s.getEventTarget()),
              (i = void 0),
              'HTML' !== (i = r.tagName) && 'BODY' !== i && !t.pointInsideRect(o, s.clientRect))
            )
              return !1
          }
          return !0
        ...
        for (var a in r) {
          ...
          if (s.isWithinClipping(e, n)) {
            ...
            if (g >= 0 && g < p && u >= 0 && u < v) {
              ...
              !f ||
                (l.props.dateProfile &&
                  !t.rangeContainsRange(l.props.dateProfile.activeRange, f.dateSpan.range)) ||
                (o && !(f.layer > o.layer)) ||
                ((f.rect.left += c),
                (f.rect.right += c),
                (f.rect.top += d),
        ...
        ;(r.dragSelection = null),
          ...
          (r.handleHitUpdate = function (e, n) {
            ...
            e &&
              ...
              })(r.hitDragging.initialHit, e, o.pluginSystem.hooks.dateSelectionTransformers)) &&
          ...
          (r.handlePointerUp = function (e) {
            r.dragSelection &&
              (r.component.context.calendar.triggerDateSelect(r.dragSelection, e),
              (r.dragSelection = null))
          })
        var o = n.component,
          a = o.context.options,
            ...
            if (e) {
              ...
              a === l || (h.editable && h.droppable)
                ? (s = (function (e, n, r) {
                    ...
                    i.allDay !== o.allDay &&
                      ((s.allDay = o.allDay),
                      (s.hasEnd = n.component.context.options.allDayMaintainDuration),
          ...
          if (o.isDragging) {
            ...
            if (
              ...
              r.publiclyTrigger('eventDragStop', [
                { el: o.subjectSeg.el, event: u, jsEvent: e.origEvent, view: a },
              ]),
              c)
            ) {
              if (s === r) {
                ...
                for (
                  var f = {}, E = 0, m = r.pluginSystem.hooks.eventDropTransformers;
                  E < m.length;
                  E++
                ) {
                  var S = m[E]
                ...
                r.publiclyTrigger('eventLeave', [{ draggedEl: e.subjectEl, event: u, view: a }]),
                  r.dispatch({
                    type: 'REMOVE_EVENT_INSTANCES',
                    instances: o.mutatedRelevantEvents.instances,
                  }),
                  s.dispatch({ type: 'MERGE_EVENTS', eventStore: o.mutatedRelevantEvents }),
                  e.isTouch && s.dispatch({ type: 'SELECT_EVENT', eventInstanceId: g.instanceId })
      ...
      ;(r.draggingSeg = null),
          ...
          ;(r.dragging.minDistance = t.context.options.eventDragMinDistance),
            r.dragging.setIgnoreMove(
              !r.component.isValidSegDownEl(e.origEvent.target) ||
                (e.isTouch && r.component.props.eventSelection !== i.instance.instanceId)
            )
        }),
        (r.handleDragStart = function (e) {
        ...
        (r.handleHitUpdate = function (e, n, o) {
          ...
          e &&
            ...
            n || (d && S(s, e) && (d = null), (r.validMutation = d), (r.mutatedRelevantEvents = g))
        }),
        (r.handleDragEnd = function (e) {
          var n = r.component.context,
            i = n.calendar,
        ...
        ;(this.receivingCalendar = null),
          ...
          (this.handleHitUpdate = function (e, n, o) {
            ...
            e &&
              ...
              r.displayDrag(l, d),
              a.setMirrorIsVisible(n || !s || !document.querySelector('.fc-mirror')),
              c ? t.disableCursor() : t.enableCursor(),
              n || (a.setMirrorNeedsRevert(!s), (r.receivingCalendar = l), (r.droppableEvent = s))
          }),
          (this.handleDragEnd = function (e) {
            var n = r,
            ...
            if ((r.clearDrag(), o && a)) {
              ...
              o.publiclyTrigger('drop', [d]),
                c.create &&
                  (o.dispatch({ type: 'MERGE_EVENTS', eventStore: t.eventTupleToStore(a) }),
                  e.isTouch &&
                    o.dispatch({ type: 'SELECT_EVENT', eventInstanceId: a.instance.instanceId }),
        ...
        void 0 === n && (n = {}),
          (this.handlePointerDown = function (e) {
            var n = r.dragging,
              ...
              a = i.longPressDelay
            ;(n.minDistance =
              null != o ? o : e.isTouch ? 0 : t.globalDefaults.eventDragMinDistance),
              (n.delay = e.isTouch ? (null != a ? a : t.globalDefaults.longPressDelay) : 0)
          }),
          (this.handleDragStart = function (e) {
            e.isTouch &&
              r.dragging.delay &&

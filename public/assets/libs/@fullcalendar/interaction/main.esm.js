...
var EventDragging = /** @class */ (function (_super) {
  ...
  function EventDragging(settings) {
    ...
    _this.handlePointerDown = function (ev) {
      ...
      var isValid =
        component.isValidSegDownEl(origTarget) && !elementClosest(origTarget, '.fc-resizer') // NOT on a resizer
      ...
      if (_this.isDragging) {
        ...
        if (validMutation) {
          ...
          if (receivingCalendar === initialCalendar_1) {
            ...
            var transformed = {}
            for (
              var _i = 0, _b = initialCalendar_1.pluginSystem.hooks.eventDropTransformers;
              _i < _b.length;
              _i++
            ) {
  ...
  function ExternalDraggable(el, settings) {
    ...
    this.handlePointerDown = function (ev) {
      ...
      dragging.minDistance =
        minDistance != null ? minDistance : ev.isTouch ? 0 : globalDefaults.eventDragMinDistance

  ...
  return (function (t) {
    ...
    function (t, e, o) {
      ...
      function u(t, e = (t) => t) {
        function o(o) {
          ...
          ;(t.value = t.value.replace(/[\d.]+/g, (t, o) =>
            o <= r && o + t.length >= r ? ((r = o), e(Number(t), n, i)) : (i++, t)
          )),
            t.focus(),
      ...
      function y(t, e, o) {
        ...
        if (0 === r) s = a = 0
          ...
          const n = ((i - t) / 6 + r / 2) / r,
            l = ((i - e) / 6 + r / 2) / r,
            c = ((i - o) / 6 + r / 2) / r
          t === i ? (s = c - l) : e === i ? (s = 1 / 3 + n - c) : o === i && (s = 2 / 3 + l - n),
            s < 0 ? (s += 1) : s > 1 && (s -= 1)
        }
        ...
        t: for (const i in e) {
          ...
          switch (i) {
            ...
            case 'hexa': {
              ...
              let o = t.substring(6)
              return (
                (o = o ? parseInt(o, 16) / 255 : void 0), { values: [...w(e), o], a: o, type: i }
              )
            }
            case 'hsla': {
              const [, , , t, e, s, a] = o(n)
      ...
      function $(t) {
        const e = {
            ...
            _tapmove(t) {
              ...
              'h' !== i &&
                (r.style.left = `calc(${(l / a.width) * 100}% - ${r.offsetWidth / 2}px)`),
                'v' !== i &&
                  (r.style.top = `calc(${(c / a.height) * 100}% - ${r.offsetHeight / 2}px)`),
      ...
      const O = {
        ...
        E = (t, e, o) => {
          const n =
            'object' != typeof t || t instanceof HTMLElement ? { reference: t, popper: e, ...o } : t
          return {
            update(t = n) {
              ...
              return ((t, e, o) => {
                const {
                    ...
                    variantFlipOrder: s,
                    positionFlipOrder: a,
                  } = { container: document.documentElement.getBoundingClientRect(), ...O, ...o },
                ...
                for (const t of v) {
                  ...
                  if (!(n < p || n + s > l))
                    for (const s of b) {
                      const l = d[(o ? 'v' : 'h') + s]
                      if (!(l < f || l + a > c))
                        return (e.style[r] = l - u[r] + 'px'), (e.style[i] = n - u[i] + 'px'), t + s
                    }
                }
      ...
      class x {
                ...
                onchange(o, n) {
                  ...
                  ;(this.element.style.background = p),
                    ...
                    a.comparison
                      ...
                      : ((s.button.style.color = p), s.button.classList.remove('clear'))
        ...
        _parseLocalColor(t) {
          const { values: e, type: o, a: n } = A(t),
            ...
            r = void 0 !== n && 1 !== n
          return (
            e && 3 === e.length && (e[3] = void 0), { values: !e || (i && r) ? null : e, type: o }
          )
        }
        _t(t) {

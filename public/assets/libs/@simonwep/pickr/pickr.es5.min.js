  ...
  return (function (t) {
    ...
    function (t, e, r) {
      ...
      ;(t.exports = function (t, e, r, c) {
        ...
        'function' == typeof r &&
          ...
          t !== n
            ? (s ? !v && t[e] && (p = !0) : delete t[e], p ? (t[e] = r) : o(t, e, r))
            : p
              ? (t[e] = r)
              : a(e, r)
        ...
        n(
          ...
          function () {
            ...
            return (
              ...
              e +
              '/' +
              String(void 0 === r && t instanceof RegExp && !('flags' in c) ? a.call(t) : r)
            )
          },
          { unsafe: !0 }
        )
      ...
      var n = r(0),
        ...
        at = function (t, e, r) {
          ...
          return (
            ...
            f(q, n)
              ? (r.enumerable
                  ? (f(t, B) && t[B][n] && (t[B][n] = !1), (r = m(r, { enumerable: b(0, !1) })))
        ...
        { target: 'Array', proto: !0, forced: !f },
        {
          slice: function (t, e) {
            ...
            if (
              ...
              return v.call(f, g, y)
            for (n = new (void 0 === r ? Array : r)(h(y - g, 0)), l = 0; g < y; g++, l++)
              g in f && s(n, l, f[g])
            return (n.length = l), n
          },
        }
            ...
            (n =
              ...
              ''.split(/.?/).length
                ? function (t, r) {
                    ...
                    return (
                      h === n.length ? (!s && d.test('')) || l.push('') : l.push(n.slice(h)),
      ...
      t.exports = function (t, e, r, l, v, b, m) {
        ...
        if (
          (C &&
            ...
            h !== Object.prototype &&
              w.next &&
              (f || i(w) === h || (a ? a(w, h) : 'function' != typeof w[g] && u(w, g, y)),
              c(w, O, !0, !0),
              f && (p[O] = y))),
          'values' == v &&
            j &&
          ...
          if (((x = { values: _('values'), keys: b ? P : _('keys'), entries: _('entries') }), m))
        ...
        { target: 'Array', proto: !0, forced: !l },
        {
          splice: function (t, e) {
            ...
            if (((l.length = n), r < n)) {
              ...
              for (v = y - n; v > b; v--)
                (d = v + r - 1), (h = v + n - 1) in g ? (g[d] = g[h]) : delete g[d]
    ...
    function (t, e, r) {
      ...
      t.exports = function (t) {
        ...
        if ((b && (y = n(y, g > 2 ? arguments[2] : void 0, 2)), null == m || (d == Array && a(m))))
          for (r = new d((e = c(h.length))); e > w; w++) (v = b ? y(h[w], w) : h[w]), u(r, w, v)
        else
          for (p = (f = m.call(h)).next, r = new d(); !(l = p.call(f)).done; w++)
        ...
        return [
          ...
          function (t, n) {
            ...
            for (var _, O = '', A = 0, E = 0; E < x.length; E++) {
              S = x[E]
              for (
                var j = String(S[0]), P = f(p(a(S.index), y.length), 0), C = [], k = 1;
                k < S.length;
                k++
              )
    ...
    function (t, e, r) {
      ...
      function O(t, e, r) {
        ...
        return (
          0 !== n && (e = 1 === n ? 0 : n < 0.5 ? (e * r) / (2 * n) : (e * r) / (2 - 2 * n)),
          [t, 100 * e, 100 * n]
        )
      }
      function A(t, e, r) {
      ...
      function T(t) {
        var e = {
            ...
            _tapmove: function (t) {
              ...
              'h' !== o &&
                (i.style.left = 'calc(' + (c / a.width) * 100 + '% - ' + i.offsetWidth / 2 + 'px)'),
                'v' !== o &&
                  (i.style.top =
                    'calc(' + (u / a.height) * 100 + '% - ' + i.offsetHeight / 2 + 'px)'),
            ...
            if (!(k < H[0] || k + N[0] > F[0]))
              for (var G, V = L(S); !(G = V()).done; ) {
                var W = G.value,
                  z = g[(C ? 'v' : 'h') + W]
                if (!(z < $ || z + M > U))
                  return (e.style[R] = z - h[R] + 'px'), (e.style[T] = k - h[T] + 'px'), P + W
              }
          }
        ...
        return (
                    ...
                    if (r.palette) {
                      ...
                      ;(this.element.style.background = f),
                        (this.wrapper.style.background =
                          ...
                          '))\n                    '),
                        a.comparison
                          ? a.useAsButton || e._lastColor || s.style.setProperty('--pcr-color', f)
                          : ((i.button.style.color = f), i.button.classList.remove('clear'))
                      for (
                        var p, v = o.toHEXA().toString(), h = H(e._swatchColors);
                        !(p = h()).done;
              ...
              n = [
                ...
                l(e.interaction.result, ['keyup', 'input'], function (e) {
                  t.setColor(e.target.value, !0) &&
                    ...
                    (t._emit('change', t._color, 'input', t), t._emit('changestop', 'input', t)),
          ...
          (e._updateOutput = function (t) {
            ...
            if (e.interaction.type()) {
              ...
              e.interaction.result.value =
                'function' == typeof r[o] ? r[o]().toString(n.outputPrecision) : ''
            }
          ...
          (e._parseLocalColor = function (t) {
            var e = C(t),
              ...
              a = void 0 !== o && 1 !== o
            return (
              r && 3 === r.length && (r[3] = void 0), { values: !r || (i && a) ? null : r, type: n }
            )
          }),
          (e._t = function (e) {

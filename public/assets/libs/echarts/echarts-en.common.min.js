...
!(function (t, e) {
            ...
            : (function (t) {
                ...
                return {
                  ...
                  pointerEventsSupported:
                    'onpointerdown' in window && (e.edge || (e.ie && 11 <= e.version)),
  ...
  function m(t, e, i) {
    ...
    for (var n in e)
      if (e.hasOwnProperty(n)) {
        var r = t[n],
          o = e[n]
        !N(o) || !N(r) || O(o) || O(r) || V(o) || V(r) || R(o) || R(r) || $(o) || $(r)
          ? (!i && n in t) || (t[n] = b(e[n]))
          : m(r, o, i)
      }
    return t
    ...
    _drag: function (t) {
      ...
      if (e) {
        ...
        e !== (this._dropTarget = a) &&
          (s && a !== s && this.dispatchToElement(St(s, t), 'dragleave', t.event),
          a && a !== s && this.dispatchToElement(St(a, t), 'dragenter', t.event))
      }
    },
    _dragEnd: function (t) {
      var e = this._draggingTarget
      e && (e.dragging = !1),
        ...
        this._dropTarget && this.dispatchToElement(St(this._dropTarget, t), 'drop', t.event),
  ...
  function Ct(t, e, i, n, r, o) {
    ...
    var l = { h: n, one: o, query: i, ctx: r || t, callAtLast: n.zrEventfulCallAtLast },
      h = a[e].length - 1,
      u = a[e][h]
  ...
  function At(t, e, i, n, r, o) {
    ...
    for (var c = 0, d = 0, f = 0; d < s; d++) {
      var p = 1 << d
      p & r || ((c += (f % 2 ? -1 : 1) * t[i][d] * At(t, e - 1, u, h, r | p, o)), f++)
    }
    return (o[a] = c)
  }
  function Dt(t, e) {
    ...
    if (0 !== r) {
      for (var o = [], a = 0; a < 8; a++)
        for (var s = 0; s < 8; s++)
          null == o[s] && (o[s] = 0),
            (o[s] +=
              ((((a + s) % 2 ? -1 : 1) * At(i, 7, 0 === a ? 1 : 0, 1 << a, 1 << s, n)) / r) * e[a])
    ...
    if (e.getBoundingClientRect && v.domSupported && !Ot(e)) {
      var o = e[kt] || (e[kt] = {}),
        a = (function (t, e, i) {
          ...
          return a && r ? r : ((e.srcCoords = s), (e[n] = i ? Dt(l, s) : Dt(s, l)))
        })(
          (function (t, e) {
            var i = e.markers
            if (i) return i
            i = e.markers = []
            for (var n = ['left', 'right'], r = ['top', 'bottom'], o = 0; o < 4; o++) {
  ...
  Zt.prototype = {
    ...
    _doTrack: function (t, e, i) {
      ...
      if (n) {
        for (
          var r = { points: [], touches: [], target: e, event: t }, o = 0, a = n.length;
          o < a;
          o++
        ) {
          var s = n[o],
  ...
  ;($t.prototype = {
    ...
    mouseout: function (t) {
      ...
      'only_globalout' !== e && this.dispatchToElement(this._hovered, 'mouseout', t),
        'no_globalout' !== e && (i || this.trigger('globalout', { type: 'globalout', event: t }))
    },
    resize: function (t) {
      this._hovered = {}
    },
    ...
    findHover: function (t, e, i) {
      for (
        var n = this.storage.getDisplayList(), r = { x: t, y: e }, o = n.length - 1;
        0 <= o;
        o--
      ) {
        var a
    ...
    D(['click', 'mousedown', 'mouseup', 'mousewheel', 'dblclick', 'contextmenu'], function (a) {
      $t.prototype[a] = function (t) {
        var e,
          ...
          r = t.zrY,
          o = Jt(this, n, r)
        if ((('mouseup' === a && o) || (i = (e = this.findHover(n, r)).target), 'mousedown' === a))
          (this._downEl = i), (this._downPoint = [t.zrX, t.zrY]), (this._upEl = i)
  ...
  var ve = {
    ...
    elasticIn: function (t) {
      ...
      return 0 === t
        ...
        : 1 === t
          ? 1
          : ((e = !i || i < 1 ? ((i = 1), 0.1) : (0.4 * Math.asin(1 / i)) / (2 * Math.PI)),
    ...
    bounceInOut: function (t) {
      return t < 0.5 ? 0.5 * ve.bounceIn(2 * t) : 0.5 * ve.bounceOut(2 * t - 1) + 0.5
    },
  }
  function ye(t) {
  ...
  ;(xe.insert = function (t) {
    ...
    (xe.insertEntry = function (t) {
      this.head
        ? (((this.tail.next = t).prev = this.tail), (t.next = null), (this.tail = t))
  ...
  ;(Se.put = function (t, e) {
    ...
    if (null == n[t]) {
      ...
      a ? (a.value = e) : (a = new be(e)), (a.key = t), i.insertEntry(a), (n[t] = a)
    }
    return r
  }),
    (Se.get = function (t) {
    ...
    if (t) {
        ...
        return 4 === r.length
          ...
          : 7 === r.length
            ? 0 <= (n = parseInt(r.substr(1), 16)) && n <= 16777215
              ? (Pe(e, (16711680 & n) >> 16, (65280 & n) >> 8, 255 & n, 1), Ee(t, e), e)
              : void Pe(e, 0, 0, 0, 1)
            : void 0
      var o = r.indexOf('('),
        a = r.indexOf(')')
      if (-1 !== o && a + 1 === r.length) {
        ...
        switch (s) {
          ...
          case 'hsl':
            return 3 !== l.length ? void Pe(e, 0, 0, 0, 1) : (Re(l, e), Ee(t, e), e)
          default:
            return
        }
      }
  ...
  function Qe(t, e, i, n, r) {
    ...
    if (1 === r) for (var a = 0; a < o; a++) n[a] = $e(t[a], e[a], i)
      ...
      var s = o && t[0].length
      for (a = 0; a < o; a++) for (var l = 0; l < s; l++) n[a][l] = $e(t[a][l], e[a][l], i)
    }
  }
  function Je(t, e, i) {
    var n = t.length,
  ...
  function ti(t, e, i) {
    ...
    if (1 === i) {
      ...
      var o = t[0].length
      for (r = 0; r < n; r++) for (var a = 0; a < o; a++) if (t[r][a] !== e[r][a]) return !1
    }
    return !0
  }
  function ei(t, e, i, n, r, o, a, s, l) {
    var h = t.length
    if (1 === l) for (var u = 0; u < h; u++) s[u] = ii(t[u], e[u], i[u], n[u], r, o, a)
    else {
      var c = t[0].length
      for (u = 0; u < h; u++)
        for (var d = 0; d < c; d++) s[u][d] = ii(t[u][d], e[u][d], i[u][d], n[u][d], r, o, a)
    }
  }
  ...
  function oi(t, e, i, n, o, r) {
    ...
    if (h) {
      ...
      for (var g = [], m = [], v = n[0].value, y = !0, _ = 0; _ < h; _++) {
        g.push(n[_].time / u)
        var x = n[_].value
        if (((c && ti(x, v, p)) || (!c && x === v) || (y = !1), 'string' == typeof (v = x))) {
          var w = Ne(x)
          w ? ((x = w), (d = !0)) : (f = !0)
        }
        m.push(x)
            ...
            if (0 != n)
              if (((S = (e - g[i]) / n), l))
                if (
                  ...
                  if (d) (r = ei(M, I, C, T, S, S * S, S * S * S, k, 1)), (r = ri(k))
                  else {
  ...
  var si = 1
  'undefined' != typeof window && (si = Math.max(window.devicePixelRatio || 1, 1))
  var li = si,
    hi = function () {}
  function ui() {
    this.animators = []
  ...
  var pi = function (t) {
    de.call(this, t), It.call(this, t), ui.call(this, t), (this.id = t.id || n())
  }
  ;(pi.prototype = {
    type: 'element',
    name: '',
    ...
    attr: function (t, e) {
      ...
      else if (N(t)) for (var i in t) t.hasOwnProperty(i) && this.attrKV(i, t[i])
  ...
  ;(bi.prototype = {
    ...
    calculateTransform: function (t) {
      var e = t.width / this.width,
        ...
        n = ee()
      return oe(n, n, [-this.x, -this.y]), se(n, n, [e, i]), oe(n, n, [t.x, t.y]), n
    },
  ...
  var Si = function (t) {
    for (var e in ((t = t || {}), pi.call(this, t), t)) t.hasOwnProperty(e) && (this[e] = t[e])
  ...
  ;(Si.prototype = {
    ...
    _doAdd: function (t) {
      ...
      var e = (t.parent = this).__storage,
        i = this.__zr
      e && e !== t.__storage && (e.addToStorage(t), t instanceof Si && t.addChildrenToStorage(e)),
        i && i.refresh()
    },
    remove: function (t) {
      var e = this.__zr,
      ...
      return (
        r < 0 ||
          (n.splice(r, 1),
          (t.parent = null),
          i && (i.delFromStorage(t), t instanceof Si && t.delChildrenFromStorage(i)),
          e && e.refresh()),
        this
      )
    },
    removeAll: function () {
      ...
      for (e = 0; e < i.length; e++)
        (t = i[e]),
          n && (n.delFromStorage(t), t instanceof Si && t.delChildrenFromStorage(n)),
          (t.parent = null)
    ...
    getBoundingRect: function (t) {
      for (
        var e = null, i = new bi(0, 0, 0, 0), n = t || this._children, r = [], o = 0;
        o < n.length;
        o++
      ) {
        var a = n[o]
  ...
  function Ai(t, e, i, n, r, o) {
    var a = 0,
      ...
      l = 1
    if (0 < o(t, e[i + r])) {
      for (s = n - r; l < s && 0 < o(t, e[i + r + l]); ) (l = 1 + ((a = l) << 1)) <= 0 && (l = s)
      s < l && (l = s), (a += r), (l += r)
    } else {
      for (s = r + 1; l < s && o(t, e[i + r - l]) <= 0; ) (l = 1 + ((a = l) << 1)) <= 0 && (l = s)
      s < l && (l = s)
      var h = a
      ;(a = r - l), (l = r - h)
    }
  ...
  function ki(p, g) {
    ...
    function e(t) {
      var e = a[t],
        ...
        n = a[t + 1],
        r = s[t + 1]
      ;(s[t] = i + r), t === l - 3 && ((a[t + 1] = a[t + 2]), (s[t + 1] = s[t + 2])), l--
        ...
        0 !== (i -= o) &&
          ...
          (i <= r
            ...
            : (function (t, e, i, n) {
                ...
                if (1 === n) {
                  for (h = (s -= e) + 1, l = (o -= e) + 1, r = e - 1; 0 <= r; r--)
                    p[h + r] = p[l + r]
                  return (p[s] = v[a])
                }
                var u = m
                for (;;) {
                  ...
                  do {
                    if (0 !== (c = e - Di(v[a], p, t, e, e - 1, g))) {
                      for (e -= c, h = (s -= c) + 1, l = (o -= c) + 1, r = c - 1; 0 <= r; r--)
                        p[h + r] = p[l + r]
                      if (0 === e) {
                        f = !0
                        break
                    ...
                    if (0 !== (d = n - Ai(p[o], v, 0, n, n - 1, g))) {
                      for (n -= d, h = (s -= d) + 1, l = (a -= d) + 1, r = 0; r < d; r++)
                        p[h + r] = v[l + r]
                      if (n <= 1) {
                        f = !0
                        break
  ...
  Oi.prototype = {
    ...
    updateDisplayList: function (t) {
      ...
      for (var e = this._roots, i = this._displayList, n = 0, r = e.length; n < r; n++)
    ...
    _updateAndAddDisplayable: function (t, e, i) {
      if (!t.ignore || i) {
        ...
        if (n) {
          e = e ? e.slice() : []
          for (var r = n, o = t; r; )
            (r.parent = o), r.updateTransform(), e.push(r), (r = (o = r).clipPath)
        }
        if (t.isGroup) {
    ...
    addRoot: function (t) {
      t.__storage !== this &&
        (t instanceof Si && t.addChildrenToStorage(this), this.addToStorage(t), this._roots.push(t))
    },
    delRoot: function (t) {
      if (null == t) {
  ...
  Vi.prototype = {
    ...
    getGradient: function (t, e, i) {
      for (
        var n = ('radial' === e.type ? Hi : Fi)(t, e, i), r = e.colorStops, o = 0;
        o < r.length;
        o++
      )
    ...
    clear: function (t, e) {
      ...
      s &&
        ...
        e &&
          ...
          (e.colorStops
            ? ((i =
                e.__canvasGradient || Vi.getGradient(r, e, { x: 0, y: 0, width: o, height: a })),
  ...
  function yn(t, e, i, n, r) {
    ...
    return { lines: a, height: s, outerHeight: l, lineHeight: o, canCacheByTextString: h }
  }
  function _n(t, e) {
        ...
        if ('string' == typeof S && '%' === S.charAt(S.length - 1))
          ...
          null != A &&
            ...
            (!M || A < T
              ...
              : ((D.text = fn(D.text, A - T, w, c.ellipsis, { minChar: c.minChar })),
                (D.textWidth = ln(D.text, w)),
                (S = D.textWidth + T)))
        }
  ...
  function kn(t) {
    if (t) {
      t.font = wn(t)
      var e = t.textAlign
      'middle' === e && (e = 'center'), (t.textAlign = null == e || Mn[e] ? e : 'left')
  ...
  function Pn(t, e, i, n, r, o) {
    n.rich
          ...
          !(function (t, e, i, n, r) {
            ...
            for (var _ = 0; _ < i.lines.length; _++) {
              for (
                ...
                On(t, e, x, n, M, v, T, 'left'), (I -= x.width), (T += x.width), C++
              for (; 0 <= D && 'right' === (x = b[D]).textAlign; )
                On(t, e, x, n, M, v, A, 'right'), (I -= x.width), (A -= x.width), D--
              for (T += (o - (T - m) - (y - A) - I) / 2; C <= D; )
                (x = b[C]), On(t, e, x, n, M, v, T + x.width / 2, 'center'), (T += x.width), C++
              v += M
            }
          })(t, e, a, n, r)
        })(t, e, i, n, r, o)
      : (function (t, e, i, n, r, o) {
          ...
          ;(p && !t.__dirtyText) || (p = t.__textCotentBlock = yn(i, c, d, f, n.truncate))
          var g = p.outerHeight,
            m = p.lines,
            v = p.lineHeight,
            y = Rn(An, t, n, r),
          ...
          if (1 === m.length) R && e.strokeText(m[0], M, I), B && e.fillText(m[0], M, I)
          else
            for (A = 0; A < m.length; A++)
              R && e.strokeText(m[A], M, I), B && e.fillText(m[A], M, I), (I += v)
        })(t, e, i, n, r, o)
  }
  ...
  function On(t, e, i, n, r, o, a, s) {
    ...
    c && ((a = Wn(a, s, c)), (u -= i.height / 2 - c[2] - i.textHeight / 2)),
      ...
      Bn(e, 'shadowColor', l.textShadowColor || n.textShadowColor || 'transparent'),
    ...
    d && (Bn(e, 'lineWidth', p), Bn(e, 'strokeStyle', d), e.strokeText(i.text, a, u)),
  ...
  function En(t, e, i, n, r, o, a) {
    ...
    if (
      ...
      c ? bn(e, { x: n, y: r, width: o, height: a, r: c }) : e.rect(n, r, o, a), e.closePath()
    }
    if (u)
    ...
    if (l && h)
      if ((Bn(e, 'lineWidth', l), Bn(e, 'strokeStyle', h), null != i.strokeOpacity)) {
        d = e.globalAlpha
  ...
  function Rn(t, e, i, n) {
    ...
    if (n) {
      ...
      if (l instanceof Array) (r = n.x + Hn(l[0], n.width)), (o = n.y + Hn(l[1], n.height))
      else {
        var h = e && e.calculateTextPosition ? e.calculateTextPosition(Tn, i, n) : dn(Tn, i, n)
        ;(r = h.x), (o = h.y), (a = a || h.textAlign), (s = s || h.textVerticalAlign)
      }
      var u = i.textOffset
      u && ((r += u[0]), (o += u[1]))
    }
    return ((t = t || {}).baseX = r), (t.baseY = o), (t.textAlign = a), (t.textVerticalAlign = s), t
  }
  function Bn(t, e, i) {
  ...
  ;(Xn.prototype = {
    ...
    (Yn.prototype = {
      ...
      getBoundingRect: function () {
        var t = this.style
        return (
          this._rect || (this._rect = new bi(t.x || 0, t.y || 0, t.width || 0, t.height || 0)),
          this._rect
        )
      },
    }),
  ...
  Qn.prototype = {
    ...
    _doPaintList: function (t, e) {
      ...
      for (var o = !0, a = 0; a < i.length; a++) {
        ...
        ;-1 === u &&
          (console.error('For some unknown reason. drawIndex is -1'), (u = s.__startIndex))
        for (var g = u; g < s.__endIndex; g++) {
          var m = t[g]
          if ((this._doPaintEl(m, s, e, h), (m.__dirty = m.__dirtyText = !1), c))
      ...
      return (
        i ||
          ...
          this._layerConfig[t]
            ...
            : this._layerConfig[t - 0.01] && m(i, this._layerConfig[t - 0.01], !0),
          e && (i.virtual = e),
    ...
    _updateLayerStatus: function (t) {
      ...
      for (i = 0; i < t.length; i++) {
        ...
        n !== l && ((n = l), (o = 0)),
          a.incremental
            ? (((s = this.getLayer(l + 0.001, this._needsManuallyCompositing)).incremental = !0),
              (o = 1))
            : (s = this.getLayer(l + (0 < o ? 0.01 : 0), this._needsManuallyCompositing)),
          s.__builtin__ || ci('ZLevel ' + l + ' has been used by unkown layer ' + s.id),
          s !== r &&
            ((s.__used = !0),
    ...
    resize: function (e, i) {
      if (this._domRoot.style) {
        ...
        if (
          ...
          for (var r in ((t.style.width = e + 'px'), (t.style.height = i + 'px'), this._layers))
    ...
    _getSize: function (t) {
      ...
      return ((a[n] || qn(s[i]) || qn(a.style[i])) - (qn(s[r]) || 0) - (qn(s[o]) || 0)) | 0
    },
  ...
  ;(Jn.prototype = {
    ...
    _update: function () {
      ...
      for (a = 0; a < n; ) i[a]._needsRemove ? ((i[a] = i[n - 1]), i.pop(), n--) : a++
      n = r.length
  ...
  var tr,
    ...
    rr = { mouse: ['mousemove', 'mouseup'], pointer: ['pointermove', 'pointerup'] }
  function or(t) {
  ...
  function lr(t, e) {
    for (
      var i = e, n = !1;
      i && 9 !== i.nodeType && !(n = i.domBelongToZr || (i !== e && i === t.painterRoot));
  ...
  var cr = {
    ...
    mousemove: function (t) {
      ...
      !e || (t.zrX === e[0] && t.zrY === e[1]) || vr(this, !0), this.trigger('mousemove', t)
    },
    mouseup: function (t) {
      ;(t = Ft(this.dom, t)), vr(this, !1), this.trigger('mouseup', t)
    },
    mouseout: function (t) {
      ;(t = Ft(this.dom, t)), this._pointerCapturing && (t.zrEventControl = 'no_globalout')
  ...
  function pr(i, n) {
    ...
    v.pointerEventsSupported ? D(rr.pointer, t) : v.touchEventsSupported || D(rr.mouse, t)
  }
  function gr(t, e, i, n) {
  ...
  var Cr = function (t, e, i) {
    ...
    var n = this,
      ...
      o = i.renderer
    if (wr) {
      if (!br.vml) throw new Error("You need to require 'zrender/vml/vml' to support IE8")
      o = 'vml'
  ...
  function Rr(t) {
    ...
    Ar(t, function (t, e) {
      ...
      Ar(t, function (t, e) {
        var i = t.option
        X(!i || null == i.id || !a.get(i.id) || a.get(i.id) === t, 'id duplicates: ' + (i && i.id)),
      ...
      Ar(t, function (t, e) {
        ...
        if (Dr(n)) {
          ...
          else for (var o = 0; (r.id = '\0' + r.name + '\0' + o++), a.get(r.id); );
          a.set(r.id, t)
        }
      })
  }
  ...
  function Gr(s, l, h) {
    ...
    !e || Zr(l, e + 'Index') || Zr(l, e + 'Id') || Zr(l, e + 'Name') || (l[e + 'Index'] = 0)
    var u = {}
    return (
      Ar(l, function (t, e) {
        t = l[e]
  ...
  function qr(t) {
    var e = { main: '', sub: '' }
    return t && ((t = t.split(Yr)), (e.main = t[0] || ''), (e.sub = t[1] || '')), e
  }
  function $r(t) {
  ...
  function Eo(t, e, i) {
    if (0 !== t.length) {
      ...
      for (n = 1; n < t.length; n++)
        (r = t[n]), (o = To(o, r[0])), (a = Ao(a, r[0])), (s = To(s, r[1])), (l = Ao(l, r[1]))
  ...
  function Fo(t, e, i, n, r, o, a, s, l) {
    var h = _t,
      ...
      c = Math.abs(r - o)
    if (c % Po < 1e-4 && 1e-4 < c)
      return (s[0] = t - i), (s[1] = e - n), (l[0] = t + i), void (l[1] = e + n)
    if (
      ((Lo[0] = ko(r) * i + t),
      (Lo[1] = Do(r) * n + e),
      (Oo[0] = ko(o) * i + t),
    ...
    for (var f = 0; f < o; f += Math.PI / 2)
      r < f && ((zo[0] = ko(f) * i + t), (zo[1] = Do(f) * n + e), h(s, zo, s), u(l, zo, l))
  }
  ...
  function ea(t, e, i, n, r, o, a, s, l, h, u) {
    ...
    return (
      ...
      (function (t, e, i, n, r, o, a, s, l, h, u) {
        ...
        return u && ((u[0] = _o(t, i, r, a, c)), (u[1] = _o(e, n, o, s, c))), lo(v)
  ...
  ;(Jo.prototype = {
    ...
    setScale: function (t, e, i) {
      ;(i = i || 0), (this._ux = Ko(i / li / t) || 0), (this._uy = Ko(i / li / e) || 0)
    },
    getContext: function () {
      return this._ctx
    },
    ...
    lineTo: function (t, e) {
      var i = Ko(t - this._xi) > this._ux || Ko(e - this._yi) > this._uy || this._len < 5
      return (
    ...
    rect: function (t, e, i, n) {
      return this._ctx && this._ctx.rect(t, e, i, n), this.addData(Ho.R, t, e, i, n), this
    },
    closePath: function () {
      this.addData(Ho.Z)
      var t = this._ctx,
    ...
    setData: function (t) {
      var e = t.length
      ;(this.data && this.data.length === e) || !Qo || (this.data = new Float32Array(e))
    ...
    appendPath: function (t) {
      ...
      Qo && this.data instanceof Float32Array && (this.data = new Float32Array(n + i))
      for (r = 0; r < e; r++)
    ...
    toStatic: function () {
      var t = this.data
      t instanceof Array && ((t.length = this._len), Qo && (this.data = new Float32Array(t)))
    },
    getBoundingRect: function () {
      ...
      for (
        ...
        switch ((1 === _ && ((v = g = p[_]), (y = m = p[_ + 1])), x)) {
          case Ho.M:
            ;(g = v = p[_++]), (m = y = p[_++]), (Zo[0] = v), (Zo[1] = y), (Uo[0] = v), (Uo[1] = y)
            break
          case Ho.L:
          ...
          case Ho.A:
            ...
            break
          case Ho.R:
            No((v = g = p[_++]), (y = m = p[_++]), v + p[_++], y + p[_++], Zo, Uo)
            break
          case Ho.Z:
            ;(g = v), (m = y)
        }
    ...
    rebuildPath: function (t) {
      for (
        var e, i, n, r, o, a, s = this.data, l = this._ux, h = this._uy, u = this._len, c = 0;
        c < u;
        ...
        switch ((1 === c && ((e = n = s[c]), (i = r = s[c + 1])), d)) {
          ...
          case Ho.L:
            ;(o = s[c++]),
              (a = s[c++]),
              (Ko(o - n) > l || Ko(a - r) > h || c === u - 1) && (t.lineTo(o, a), (n = o), (r = a))
            break
          case Ho.C:
  ...
  function aa(t, e, i, n, r, o, a, s, l) {
    ...
    return d < 0 && (d += oa), (n <= d && d <= r) || (n <= d + oa && d + oa <= r)
  }
  ...
  function fa(t, e, i, n, r, o, a, s, l, h) {
      ...
      c = (function (t, e, i, n, r, o) {
        ...
        if (vo(u) && vo(c)) {
          ...
          if (vo(p)) {
            var g = c / u,
              m = -g / 2
            0 <= (M = -s / a + g) && M <= 1 && (o[f++] = M), 0 <= m && m <= 1 && (o[f++] = m)
          } else if (0 < p) {
            var v = lo(p),
              y = u * s + 1.5 * a * (-c + v),
              _ = u * s + 1.5 * a * (-c - v)
            0 <=
              (M =
                (-s -
                  ((y = y < 0 ? -so(-y, fo) : so(y, fo)) + (_ = _ < 0 ? -so(-_, fo) : so(_, fo)))) /
                (3 * a)) &&
              M <= 1 &&
              (o[f++] = M)
          } else {
    ...
    for (var d, f, p = 0, g = -1, m = 0; m < c; m++) {
      ...
      _o(t, i, r, a, v) < l ||
        (g < 0 &&
          ((g = wo(e, n, o, s, da)),
          da[1] < da[0] && 1 < g && (void 0, (u = da[0]), (da[0] = da[1]), (da[1] = u)),
          (d = _o(e, n, o, s, da[0])),
  ...
  function pa(t, e, i, n, r, o, a, s) {
    ...
    if (0 <= h && h <= 1) {
      for (var u = 0, c = So(e, n, o, h), d = 0; d < l; d++) {
        ...
        So(t, i, r, ca[d]) < a || (ca[d] < h ? (u += c < e ? f : -f) : (u += o < c ? f : -f))
      }
      return u
    }
  ...
  function ma(t, e, i, n, r) {
    for (var o = 0, a = 0, s = 0, l = 0, h = 0, u = 0; u < t.length; ) {
      ...
      switch (
        ...
        case la.C:
          if (i) {
            if (ea(a, s, t[u++], t[u++], t[u++], t[u++], t[u], t[u + 1], e, n, r)) return !0
          } else o += fa(a, s, t[u++], t[u++], t[u++], t[u++], t[u], t[u + 1], n, r) || 0
          ;(a = t[u++]), (s = t[u++])
          break
        case la.Q:
          if (i) {
  ...
  ;(xa.prototype = {
    ...
    brush: function (t, e) {
      ...
      n.bind(t, this, e),
        this.setTransform(t),
        this.__dirty &&
          (h && ((i = i || this.getBoundingRect()), (this._fillGradient = n.getGradient(t, s, i))),
          u && ((i = i || this.getBoundingRect()), (this._strokeGradient = n.getGradient(t, l, i))))
      h ? (t.fillStyle = this._fillGradient) : c && (t.fillStyle = va.call(s, t)),
        u ? (t.strokeStyle = this._strokeGradient) : d && (t.strokeStyle = va.call(l, t))
      var f = n.lineDash,
        p = n.lineDashOffset,
        g = !!t.setLineDash,
      ...
      if (((this._rect = t), e.hasStroke())) {
        ...
        if (this.__dirty || i) {
          ...
          e.hasFill() || (o = Math.max(o, this.strokeContainThreshold || 4)),
            1e-10 < a &&
              ((r.width += o / a), (r.height += o / a), (r.x -= o / a / 2), (r.y -= o / a / 2))
        }
        return r
      }
      return t
    ...
    (xa.extend = function (r) {
      ...
      for (var e in (w(t, xa), r)) 'style' !== e && 'shape' !== e && (t.prototype[e] = r[e])
      return t
    }),
    w(xa, Xn)
  function wa(t) {
  ...
  var ba = Jo.CMD,
    ...
    Ca = function (t, e) {
      ...
      for (o = r = 0; r < s.length; ) {
        ...
        for (a = 0; a < n; a++) {
          var _
          ;((_ = Sa[a])[0] = s[r++]), (_[1] = s[r++]), yt(_, _, e), (s[o++] = _[0]), (s[o++] = _[1])
        }
      }
    },
    Ta = Math.sqrt,
  ...
  function Na(t, e) {
    var i = (function (t) {
      if (!t) return new Jo()
      for (
        var e, i = 0, n = 0, r = i, o = n, a = new Jo(), s = Jo.CMD, l = t.match(za), h = 0;
        h < l.length;
        h++
      ) {
        for (
          var u, c = l[h], d = c.charAt(0), f = c.match(Ea) || [], p = f.length, g = 0;
          g < p;
          g++
        )
          f[g] = parseFloat(f[g])
          ...
          switch (d) {
            ...
            case 'A':
              ;(_ = f[m++]),
                ...
                (b = f[m++]),
                (S = f[m++]),
                Oa((M = i), (I = n), (i = f[m++]), (n = f[m++]), b, S, _, x, w, (u = s.A), a)
              break
            case 'a':
              ;(_ = f[m++]),
                (x = f[m++]),
  ...
  ;(Ba.prototype = {
    ...
    brush: function (t, e) {
      ...
      null != n && (n += ''),
        Gn(n, i)
          ? (this.setTransform(t), Pn(this, t, n, i, null, e), this.restoreTransform(t))
  ...
  function Va(l) {
    return v.browser.ie && 11 <= v.browser.version
      ? function () {
          ...
          if ((l.apply(this, arguments), t)) for (s = 0; s < Ha.length; s++) i[Ha[s][0]] = Ha[s][2]
        }
      : l
  }
  var Fa = xa.extend({
    ...
    if (n && 2 <= n.length) {
      if (r && 'spline' !== r) {
        var o = (function (t, e, i, n) {
          ...
          if (n) {
            ;(a = [1 / 0, 1 / 0]), (s = [-1 / 0, -1 / 0])
            for (var d = 0, f = t.length; d < f; d++) _t(a, a, t[d]), xt(s, s, t[d])
          ...
          for (d = 0, f = t.length; d < f; d++) {
            ...
            var y = ot([], p, u),
              _ = ot([], p, c)
            n && (xt(y, y, a), _t(y, y, s), xt(_, _, a), _t(_, _, s)), l.push(y), l.push(_)
          }
        ...
        'spline' === r &&
          (n = (function (t, e) {
            for (var i = t.length, n = [], r = 0, o = 1; o < i; o++) r += pt(t[o - 1], t[o])
            var a = r / 2
            a = a < i ? i : a
            for (o = 0; o < a; o++) {
              var s,
                ...
                f = t[c % i]
              h = e
                ? ((s = t[(c - 1 + i) % i]), (l = t[(c + 1) % i]), t[(c + 2) % i])
                : ((s = t[0 === c ? c : c - 1]),
                  (l = t[i - 2 < c ? i - 1 : c + 1]),
                  t[i - 3 < c ? i - 1 : c + 2])
              var p = d * d,
                g = d * p
              n.push([Za(s[0], f[0], l[0], h[0], d, p, g), Za(s[1], f[1], l[1], h[1], d, p, g)])
            }
            return n
          })(n, i)),
          t.moveTo(n[0][0], n[0][1])
    ...
    es = xa.extend({
      ...
      buildPath: function (t, e) {
        ...
        o = this.subPixelOptimize
          ? (qa(ts, e, this.style), (i = ts.x1), (n = ts.y1), (r = ts.x2), ts.y2)
  ...
  function ns(t, e, i) {
    ...
    return null === n || null === r
      ? [(i ? xo : _o)(t.x1, t.cpx1, t.cpx2, t.x2, e), (i ? xo : _o)(t.y1, t.cpy1, t.cpy2, t.y2, e)]
      : [(i ? Mo : So)(t.x1, t.cpx1, t.x2, e), (i ? Mo : So)(t.y1, t.cpy1, t.y2, e)]
  }
  function rs(t) {
    this.colorStops = t || []
  }
  ...
  ;(us.prototype.getBoundingRect = function () {
    if (!this._rect) {
      for (
        ...
        i.needLocalTransform() && n.applyTransform(i.getLocalTransform(cs)), t.union(n)
      }
      this._rect = t
    }
    return this._rect
  ...
  function Ms(t, e, i, n) {
    var r = Ra(t, e)
    return i && ('center' === n && (i = Cs(i, r.getBoundingRect())), As(r, i)), r
  }
  function Is(t, i, n) {
    var r = new Yn({
  ...
  function Cs(t, e) {
    ...
    return (
      ...
      { x: t.x + t.width / 2 - r / 2, y: t.y + t.height / 2 - i / 2, width: r, height: i }
    )
  }
  function Ts(t, e) {
  ...
  function Ys(t, e, i, n, r, o, a) {
    ...
    ;(d || f) &&
      ...
      null == s && (s = z(r.defaultText) ? r.defaultText(h, r) : r.defaultText))
    var p = d ? s : null,
      g = f ? W(l ? l.getFormattedLabel(h, 'emphasis', null, u, c) : null, s) : null
    ;(null == p && null == g) || (js(t, i, o, r), js(e, n, a, r, !0)), (t.text = p), (e.text = g)
  }
  ...
  function qs(t, e, i, n) {
    if ((i = i || ps).isRectText) {
      ...
      i.getTextPosition
        ...
        : 'outside' === (r = e.getShallow('position') || (n ? null : 'inside')) && (r = 'top'),
        (t.textPosition = r),
    ...
    return (t.rich = a), $s(t, e, l, i, n, !0), i.forceRich && !i.textStyle && (i.textStyle = {}), t
  }
  function $s(t, e, i, n, r, o) {
    ;(i = (!r && i) || ps),
      (t.textFill = Ks(e.getShallow('color'), n) || i.color),
      (t.textStroke = Ks(e.getShallow('textBorderColor'), n) || i.textBorderColor),
      (t.textStrokeWidth = W(e.getShallow('textBorderWidth'), i.textBorderWidth)),
      r ||
        (o && ((t.insideRollbackOpt = n), Qs(t)), null == t.textFill && (t.textFill = n.autoColor)),
  ...
  function Qs(t) {
    ...
    if (n && null == t.textFill) {
      var r = n.autoColor,
        o = n.isRectText,
        a = n.useInsideStyle,
        s = !1 !== a && (!0 === a || (o && i && 'string' == typeof i && 0 <= i.indexOf('inside'))),
        l = !s && null != r
      ;(s || l) &&
        (e = {
          textFill: t.textFill,
  ...
  function el(t, e, i, n, r, o) {
    if (('function' == typeof r && ((o = r), (r = null)), n && n.isAnimationEnabled())) {
      ...
      'function' == typeof h &&
        (h = h(r, n.getAnimationDelayParams ? n.getAnimationDelayParams(e, r) : null)),
        'function' == typeof s && (s = s(r)),
        0 < s ? e.animateTo(i, s, h || 0, l, o, !!o) : (e.stopAnimation(), e.attr(i), o && o())
  ...
  function rl(t, e) {
    for (var i = ie([]); t && t !== e; ) re(i, t.getLocalTransform(), i), (t = t.parent)
    return i
  }
  function ol(t, e, i) {
    return e && !L(e) && (e = de.getLocalTransform(e)), i && (e = le([], e)), yt([], t, e)
  }
  function al(t, e, i) {
    ...
    return (
      (o = ol(o, e, i)),
      Math.abs(o[0]) > Math.abs(o[1]) ? (0 < o[0] ? 'right' : 'left') : 0 < o[1] ? 'bottom' : 'top'
    )
  }
  function sl(t, e, n, i) {
    if (t && e) {
  ...
  var dl = (Object.freeze || Object)({
      ...
      modifyLabelStyle: function (t, e, i) {
        var n = t.style
        e && (Js(n), t.setStyle(e), Qs(n)), (n = t.__hoverStl), i && n && (Js(n), k(n, i), Qs(n))
      },
      setTextStyle: js,
      ...
      clipRectByRect: function (t, e) {
        ...
        if (i <= n && r <= o) return { x: i, y: r, width: n - i, height: o - r }
      },
      createIcon: hl,
  ...
  function xl(t, e, i) {
    for (
      var n = 0;
      n < e.length && (!e[n] || null != (t = t && 'object' == typeof t ? t[e[n]] : null));
      n++
    );
  ...
  ;(_l.prototype = {
    ...
    get: function (t, e) {
      return null == t ? this.option : xl(this.option, this.parsePath(t), !e && wl(this, t))
    },
  ...
  function Tl(t, e, i) {
    return (
      null == e && (e = 10), (e = Math.min(Math.max(0, e), 20)), (t = (+t).toFixed(e)), i ? t : +t
    )
  }
  function Al(t) {
    return (
  ...
  function Ll(t, e, i) {
    ...
    for (
      ...
      for (var u = Number.NEGATIVE_INFINITY, c = null, d = 0, f = h.length; d < f; ++d)
        h[d] > u && ((u = h[d]), (c = d))
      ++s[c], (h[c] = 0), ++l
    }
    return s[e] / r
  ...
  function Nl(t) {
    ...
    if (e[8]) {
      ...
      return (
        ...
        new Date(
          Date.UTC(+e[1], +(e[2] || 1) - 1, +e[3] || 1, i, +(e[5] || 0), +e[6] || 0, +e[7] || 0)
        )
      )
    }
    return new Date(
    ...
    reformIntervals: function (t) {
      ...
      for (var e = -1 / 0, i = 1, n = 0; n < t.length; ) {
        for (var r = t[n].interval, o = t[n].close, a = 0; a < 2; a++)
          r[a] <= e && ((r[a] = e), (o[a] = a ? 1 : 1 - i)), (e = r[a]), (i = o[a])
      ...
      ? 'html' === r
        ? 'subItem' === n
          ...
          : '<span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:' +
            ...
            (e || '') +
            '"></span>'
        : { renderMode: r, content: '{marker' + o + '|}  ', style: { color: i } }
      : ''
  }
  function Kl(t, e) {
  ...
  function hh(t, e, i, n, r) {
    ...
    if (o || a) {
      var l
      if ('raw' === s)
        l = 'group' === t.type ? new bi(0, 0, +e.width || 0, +e.height || 0) : t.getBoundingRect()
  ...
  function uh(l, h, t) {
    ...
    function n(t, e) {
      ...
      if (
        ...
        return d(h, t[1]) ? (r[t[2]] = null) : d(h, t[2]) && (r[t[1]] = null), r
      if (2 !== o && n) {
        if (2 <= n) return i
    ...
    vh = _l.extend({
      ...
      mergeDefaultAndTheme: function (t, e) {
        var i = this.layoutMode,
          n = i ? ch(t) : {}
        m(t, e.getTheme().get(this.mainType)), m(t, this.getDefaultOption()), i && uh(t, n, i)
      },
  ...
  function zh(t) {
    ...
    var u = (function (t, e, i, n, r) {
      ...
      return { startIndex: a, dimensionsDefine: Eh(r), dimensionsDetectCount: o }
    })(i, n, o, a, s)
    Oh(t).source = new Ph({
      data: i,
      fromDataset: r,
  ...
  function Fh(t, e, i, n, r, o) {
    ...
    if (e === Mh)
      ...
      for (c = 0; c < u.length && c < 5; c++) if (null != (a = g(u[c]))) return a
    } else if (e === Sh)
      for (c = 0; c < t.length && c < 5; c++) {
        var f,
          p = Er((f = t[c]))
  ...
  var Hh = '\0_ec_inner',
    Wh = _l.extend({
      init: function (t, e, i, n) {
        ;(i = i || {}), (this.option = null), (this._theme = new _l(i)), (this._optionManager = n)
      },
      ...
      mergeOption: function (n) {
        ...
        !(function (t) {
          ...
          D(n, function (t, e) {
            null != t &&
              (vh.hasClass(e) ? e && i.push(e) : (l[e] = null == l[e] ? b(t) : m(l[e], t, !0)))
          }),
                ...
                D(i, function (t, e) {
                  ...
                  N(i) &&
                    ...
                    (t.keyInfo.subType = (function (t, e, i) {
                      return e.type ? e.type : i ? i.subType : vh.determineSubType(t, e)
                    })(a, i, t.exist)))
                })
              var s = (function (e, t) {
                O(t) || (t = t ? [t] : [])
                  ...
                  function (t, e) {
                    ...
                    if ((X(N(n) || i, 'Empty component definition'), n)) {
                      ...
                      if (i && i.constructor === r)
                        (i.name = t.keyInfo.name), i.mergeOption(n, this), i.optionUpdated(n, !1)
                      else {
                        var o = k({ dependentModels: s, componentIndex: e }, t.keyInfo)
      ...
      getOption: function () {
        ...
        return (
          D(n, function (t, e) {
            if (vh.hasClass(e)) {
              for (var i = (t = Lr(t)).length - 1; 0 <= i; i--) Vr(t[i]) && t.splice(i, 1)
              n[e] = t
            }
          }),
          delete n[Hh],
  ...
  tu.prototype = {
              ...
              qh((t = t || {}), function (t, e) {
                if (null != t) {
                  ...
                  if (vh.hasClass(e)) {
                    ...
                    var n = Nr((i = Lr(i)), t)
                    r[e] = Kh(n, function (t) {
                      return t.option && t.exist ? Qh(t.exist, t.option, !0) : t.exist || t.option
                    })
                  } else r[e] = Qh(i, t, !0)
                }
              })
    ...
    getMediaOption: function (t) {
      ...
      for (var s = 0, l = n.length; s < l; s++) eu(n[s].query, e, i) && o.push(s)
      return (
        !o.length && r && (o = [-1]),
        o.length &&
          !(function (t, e) {
  ...
  var iu = D,
    nu = N,
    ru = ['areaStyle', 'lineStyle', 'nodeStyle', 'linkStyle', 'chordStyle', 'label', 'labelLine']
  function ou(t) {
    var e = t && t.itemStyle
    if (e)
  ...
  function au(t, e, i) {
    if (t && t[e] && (t[e].normal || t[e].emphasis)) {
      var n = t[e].normal,
        r = t[e].emphasis
      n && (i ? ((t[e].normal = t[e].emphasis = null), A(t[e], n)) : (t[e] = n)),
        ...
        (function (t) {
          if (nu(t)) {
            ...
            if ((n = t.markLine) && n.data) {
              var l = n.data
              for (a = 0; a < l.length; a++) O(l[a]) ? (hu(l[a][0]), hu(l[a][1])) : hu(l[a])
            }
            'gauge' === t.type
  ...
  function Au(t, e) {
    ...
    if ('ordinal' !== i)
      return (
        'time' === i && 'number' != typeof t && null != t && '-' !== t && (t = +Nl(t)),
        null == t || '' === t ? NaN : +t
      )
  ...
  var Pu = /\{@(.+?)\}/g,
    Lu = {
      ...
      getFormattedLabel: function (n, t, e, i, r) {
        ...
        var l = a.get('normal' === t ? [r || 'label', 'formatter'] : [t, r || 'label', 'formatter'])
        return 'function' == typeof l
          ...
          : 'string' == typeof l
            ? ql(l, s).replace(Pu, function (t, e) {
                var i = e.length
                return (
                  '[' === e.charAt(0) && ']' === e.charAt(i - 1) && (e = +e.slice(1, i - 1)),
                  Du(o, n, e)
                )
              })
            : void 0
  ...
  function Uu(t, e, i, n, r, o) {
    Wu.reset(i, n, r, o),
      ...
      t._callingProgress({ start: i, end: n, count: n - i, next: Wu.next }, t.context)
  }
  ;(Eu.dirty = function () {
  ...
  var Xu = Hr(),
    Yu = vh.extend({
      ...
      init: function (t, e, i, n) {
        ...
        Qu(r, this), (this.dataTask.context.data = r), (Xu(this).dataBeforeProcessed = r), ju(this)
      },
      mergeDefaultAndTheme: function (t, e) {
        var i = this.layoutMode,
          n = i ? ch(t) : {},
      ...
      formatTooltip: function (r, u, t, c) {
        ...
        N(v) && v.colorStops && (v = (v.colorStops[0] || {}).color), (v = v || 'transparent')
        var l = (
            1 < n || (s && !n)
              ? (function (t) {
                  var l = M(
                  ...
                  function e(t, e) {
                    ...
                    if (i && !1 !== i.otherDims.tooltip) {
                      var n = i.type,
                        ...
                        o = $l({ color: v, type: 'subItem', renderMode: c, markerId: r }),
        ...
        return { html: u ? w + x + l : x + w + (_ ? Xl(_) + ': ' + l : l), markers: p }
      },
      isAnimationEnabled: function () {
        if (v.node) return !1
  ...
  function vc(t, e, i, n) {
    ...
    if (r) {
      ...
      if (r[pc] !== i || a !== n) {
        ...
        ;((r = t[e] = mc(o, i, 'debounce' === n))[fc] = o), (r[gc] = n), (r[pc] = i)
      }
      return r
    }
  }
  ...
  var _c = {
      ...
      reset: function (e, t) {
        ...
        ;(n && !r) || (n = e.getColorFromPalette(e.name, null, t.getSeriesCount())),
          i.setVisual('color', n)
        var a = (e.visualBorderColorAccessPath || 'itemStyle.borderColor').split('.'),
          s = e.get(a)
    ...
    wc = function (t, e) {
      ...
      if (o.get('show'))
        if (o.get('description')) t.setAttribute('aria-label', o.get('description'))
          ...
          if (!(u < 1)) {
            ...
            i = r ? p(g('general.withTitle'), { title: r }) : g('general.withoutTitle')
            var f = []
                ...
                if (e < d) {
                  ...
                  for (var a = [], s = 0; s < o.count(); s++)
                    if (s < c) {
                      var l = o.getName(s),
                        h = Du(o, s)
                      a.push(p(g(l ? 'data.withName' : 'data.withoutName'), { name: l, value: h }))
                    }
                  ;(i += a.join(g('data.separator.middle')) + g('data.separator.end')), f.push(i)
                }
              }),
              (i +=
                f.join(g('series.multiple.separator.middle')) + g('series.multiple.separator.end')),
      ...
      function g(t) {
        var e = o.get(t)
        if (null != e) return e
        for (var i = t.split('.'), n = xc.aria, r = 0; r < i.length; ++r) n = n[i[r]]
        return n
      }
    },
    bc = Math.PI
          ...
          if (r) {
            ...
            i &&
              i.each(function (t, e) {
                ...
                ;(i.skip = !n.performRawSeries && h.isSeriesFiltered(t.context.model)),
                  Cc(t, u),
                  (d |= t.perform(i))
              })
        }
  ...
  ;(Mc.restoreData = function (t, e) {
    ...
    (Mc.updateStreamModes = function (t, e) {
      ...
      t.pipelineContext = i.context = { progressiveRender: r, modDataCount: a, large: o }
    }),
        ...
        function (t) {
          ...
          t.reset &&
            (function (n, r, t, o, a) {
              ...
              function l(t) {
                var e = t.uid,
                  i = s.get(e) || s.set(e, Ou({ plan: Pc, reset: Lc, count: Ec }))
                ;(i.context = {
                  model: t,
                  ecModel: o,
                  api: a,
            ...
            t.overallReset &&
              (function (n, t, e, i, r) {
                ...
                o.context = { ecModel: i, api: r, overallReset: t.overallReset, scheduler: n }
                ...
                function c(t) {
                  var e = t.uid,
                    i = a.get(e)
                  i || ((i = a.set(e, Ou({ reset: Ac, onDirty: kc }))), o.dirty()),
                    (i.context = { model: t, overallProgress: h, modifyOutputEnd: u }),
                    (i.agent = o),
                    (i.__block = h),
                    Nc(n, t, i)
                }
  ...
  function Lc(t) {
    ...
    var e = (t.resetDefines = Lr(t.reset(t.model, t.ecModel, t.api, t.payload)))
    return 1 < e.length
      ? P(e, function (t, e) {
          return zc(e)
        })
  ...
  function zc(o) {
    return function (t, e) {
      var i = e.data,
        n = e.resetDefines[o]
      if (n && n.dataEach) for (var r = t.start; r < t.end; r++) n.dataEach(i, r)
  ...
  Fc(Bc, Wh),
    Fc(Vc, Xh),
    (Bc.eachSeriesByType = Bc.eachRawSeriesByType =
      function (t) {
        Rc = t
      }),
  ...
  ;(Xc.categoryAxis.splitLine.show = !1),
    vh.extend({
      type: 'dataset',
      defaultOption: { seriesLayoutBy: Dh, sourceHeader: null, dimensions: null, source: null },
  ...
  var $c = {
      ...
      tspan: function (t, e) {
        ...
        var r = t.getAttribute('dx') || 0,
          o = t.getAttribute('dy') || 0,
          a = new Si()
        return Qc(e, a), ed(t, a, this._defs), (this._textX += r), (this._textY += o), a
      },
      path: function (t, e) {
  ...
  function Qc(t, e) {
    t &&
      t.__inheritedStyle &&
      (e.__inheritedStyle || (e.__inheritedStyle = {}), A(e.__inheritedStyle, t.__inheritedStyle))
  }
  function Jc(t) {
    ...
    if (
      ...
      ((function (t, e) {
        ...
        if (i) {
          ...
          for (var o = r.length - 1; 0 < o; o -= 2) {
            ...
            switch (((n = n || ee()), s)) {
              case 'translate':
                ;(a = Y(a).split(jc)), oe(n, n, [parseFloat(a[0]), parseFloat(a[1] || 0)])
                break
              case 'scale':
                ;(a = Y(a).split(jc)), se(n, n, [parseFloat(a[0]), parseFloat(a[1] || a[0])])
                break
              case 'rotate':
                ;(a = Y(a).split(jc)), ae(n, n, parseFloat(a[0]))
                break
              case 'skew':
                ;(a = Y(a).split(jc)), console.warn('Skew transform is not supported yet')
                break
              case 'matrix':
                a = Y(a).split(jc)
                ;(n[0] = parseFloat(a[0])),
      ...
      k(
        ...
        (function (t) {
          ...
          for (var o in td) td.hasOwnProperty(o) && null != r[o] && (i[td[o]] = r[o])
          return i
        })(t)
      ),
      !n)
  ...
  function wd(t, e, i) {
    ;(i = i || {}), 'string' == typeof e && (e = Ud[e]), this.id, this.group, (this._dom = t)
    var n = (this._zr = Mr(t, {
  ...
  ;(bd._onframe = function () {
    ...
    (bd.getConnectedDataURL = function (r) {
      if (!this._disposed && v.canvasSupported) {
        ...
        if (jd[a]) {
          ...
          D(Yd, function (t, e) {
            if (t.group === a) {
              var i = o ? t.getZr().painter.getSvgDom().innerHTML : t.getRenderedCanvas(b(r)),
          ...
          return (
            ...
            cd(f, function (t) {
              var e = new Yn({ style: { x: t.left * i - h, y: t.top * i - u, image: t.dom } })
              p.add(e)
            }),
            p.refreshImmediately(),
    ...
    (bd.getVisual = function (t, e) {
      var i = (t = Gr(this._model, t, { defaultMainType: 'series' })).seriesModel.getData(),
    ...
    updateTransform: function (r) {
      ...
      if (o) {
        ...
        o.eachSeries(function (t) {
          ...
          Ld(o),
          this._scheduler.performVisualTasks(o, r, { setDirty: !0, dirtyMap: n }),
          zd(a, o, s, r, n),
          Ed(o, this._api)
      }
    },
      ...
      null != l && (l = Q(Lr(l))),
        o &&
          o.eachComponent(
            ...
            function (t) {
              ;(l && null != l.get(t.id)) ||
                h(e['series' === r ? '_chartsMap' : '_componentsMap'][t.__viewId])
            },
            e
          )
  ...
  function Ad(e, t) {
    ...
    cd(
      l,
      function (t) {
        ;((u = (u = r.action(t, this._model, this._api)) || k({}, t)).type = o.event || u.type),
          c.push(u),
      ...
      'none' === s ||
        d ||
        a ||
        (this[vd] ? (Id(this), Md.update.call(this, e), (this[vd] = !1)) : Md[s].call(this, e)),
  ...
  function Pd(t, e, r, o) {
    ...
    function n(t) {
      ...
      if (!i) {
        var n = pd(t.type)
        ;(i = new (a ? ec.getClass(n.main, n.sub) : ac.getClass(n.sub))()).init(r, u),
          (l[e] = i),
          s.push(i),
          h.add(i.group)
      }
      ;(t.__viewId = i.__id = e),
        (i.__alive = !0),
        (i.__model = t),
        (i.group.__ecComponentInfo = { mainType: t.mainType, index: t.componentIndex }),
  ...
  ;(bd.resize = function (t) {
    ...
    (bd.showLoading = function (t, e) {
      if (
        !this._disposed &&
        (fd(t) && ((e = t), (t = '')), (t = t || 'default'), this.hideLoading(), Xd[t])
      ) {
        ...
        Vd[t.type] &&
          ...
          (this[md]
            ...
            : (Ad.call(this, t, e.silent),
              e.flush
                ? this._zr.flush(!0)
                : !1 !== e.flush && v.browser.weChat && this._throttledZrFlush(),
          ...
          D(t, function (t, e) {
            for (var i = !1, n = 0; n < u.length; n++) {
              ...
              if (0 < o && o === e.length - r.length) {
                var a = e.slice(0, o)
                'data' !== a && ((s.mainType = a), (s[r.toLowerCase()] = t), (i = !0))
              }
            }
  ...
  sf(2e3, _c),
    ...
    hf('default', function (r, o) {
      ...
      if ((t.add(l), o.showSpinner)) {
        var h = new as({
          shape: { startAngle: -bc / 2, endAngle: -bc / 2 + 0.1, r: o.spinnerRadius },
      ...
      return (
        (t.resize = function () {
          ...
          o.showSpinner && h.setShape({ cx: i, cy: n }),
            ...
            a.setShape({ x: 0, y: 0, width: r.getWidth(), height: r.getHeight() })
        }),
        t.resize(),
        t
      )
  ...
  gf.prototype = {
    ...
    execute: function () {
      var t = this._old,
        ...
        r = []
      for (
        mf(t, {}, n, '_oldKeyGetter', this), mf(e, i, r, '_newKeyGetter', this), o = 0;
        o < t.length;
        o++
      ) {
        if (null != (s = i[(a = n[o])]))
          (h = s.length) ? (1 === h && (i[a] = null), (s = s.shift())) : (i[a] = null),
      ...
      for (var o = 0; o < r.length; o++) {
        ...
        if (i.hasOwnProperty(a)) {
          ...
          if (s.length) for (var l = 0, h = s.length; l < h; l++) this._add && this._add(s[l])
      ...
      ;(this.dimensions = n),
        ...
        (this._dimensionsSummary = (function (n) {
          var t = {},
            ...
            s = [],
            l = [],
            h = (t.userOutput = { dimensionNames: n.dimensions.slice(), encode: {} })
  ...
  function Rf(t, e) {
    var i = t._idList[e]
    return null == i && (i = zf(t, t._idDimIdx, e)), null == i && (i = 'e\0\0' + e), i
  }
  function Bf(t) {
    return O(t) || (t = [t]), t
  }
  ...
  function Ff(t) {
    for (var e, i, n = new Array(t.length), r = 0; r < t.length; r++)
      n[r] = ((e = t[r]), (i = void 0), (i = e.constructor) === Array ? e.slice() : new i(e))
    return n
  }
  function Hf() {
    return [1 / 0, -1 / 0]
  ...
  ;(Pf.type = 'list'),
    ...
    (Pf.initData = function (t, e, i) {
      ;(Ph.isInstance(t) || L(t)) && (t = new yu(t, this.dimensions.length)),
        ...
        (this.defaultDimValueGetter = Cu[this._rawData.getSource().sourceFormat]),
      ...
      if (!(e <= t)) {
        ...
        for (var m = new Array(s), v = t; v < e; v++) {
          ...
          if (!r.pure) {
            ...
            null == D &&
              null != I &&
              ((d[I] = d[I] || 0), 0 < d[(D = I)] && (D += '__ec__' + d[I]), d[I]++),
              null != D && (u[v] = D)
          }
        }
    ...
    (Pf.each = function (t, e, i, n) {
      if (this._count) {
        ...
        for (var r = (t = P(Bf(t), this.getDimension, this)).length, o = 0; o < this.count(); o++)
          switch (r) {
            case 0:
              e.call(i, o)
              break
    ...
    (Pf.filterSelf = function (t, e, i, n) {
      if (this._count) {
        ...
        for (
          var r = this.count(), o = new (Cf(this))(r), a = [], s = t.length, l = 0, h = t[0], u = 0;
          u < r;
          u++
        ) {
          var c,
          ...
          if (!this._indices) {
            ...
            if (1 === n) {
              for (var d = this._storage[e[0]], f = 0; f < this._chunkCount; f++)
                for (
                  var p = d[f],
                    g = Math.min(this._count - f * this._chunkSize, this._chunkSize),
                    m = 0;
                  m < g;
                  m++
                ) {
                  ;((l <= (w = p[m]) && w <= h) || isNaN(w)) && (o[a++] = c), c++
                }
              u = !0
            } else if (2 === n) {
              d = this._storage[s]
              ...
              for (f = 0; f < this._chunkCount; f++) {
                ...
                var x = v[f]
                for (
                  g = Math.min(this._count - f * this._chunkSize, this._chunkSize), m = 0;
                  m < g;
                  m++
                ) {
                  var w = p[m],
          ...
          if (!u)
            if (1 === n)
              for (m = 0; m < r; m++) {
                ...
                ;((l <= (w = this._getFast(s, S)) && w <= h) || isNaN(w)) && (o[a++] = S)
              }
            else
              for (m = 0; m < r; m++) {
                var M = !0
    ...
    (Pf.map = function (t, e, i, n) {
      ...
      for (
        ...
        if (null != p) {
          ...
          for (
            var g = this.getRawIndex(d), m = Math.floor(g / s), v = g % s, y = 0;
            y < p.length;
            y++
          ) {
            var _ = t[y],
    ...
    (Pf.setVisual = function (t, e) {
      if (xf(t)) for (var i in t) t.hasOwnProperty(i) && this.setVisual(i, t[i])
      else (this._visual = this._visual || {}), (this._visual[t] = e)
    }),
    (Pf.setLayout = function (t, e) {
      if (xf(t)) for (var i in t) t.hasOwnProperty(i) && this.setLayout(i, t[i])
  ...
  function Gf(t, e, i) {
    Ph.isInstance(e) || (e = Ph.seriesDataToSource(e)), (i = i || {}), (t = (t || []).slice())
    for (
      ...
      var h = (n[s] = k({}, N(n[s]) ? n[s] : { name: n[s] })),
        u = h.name,
        c = (l[s] = new _f())
      null != u && null == r.get(u) && ((c.name = c.displayName = u), r.set(u, s)),
    ...
    !d && i.encodeDefaulter && (d = i.encodeDefaulter(e, a)),
      (d = Q(d)).each(function (t, i) {
        if (1 === (t = Lr(t).slice()).length && !E(t[0]) && t[0] < 0) d.set(i, !1)
        else {
          var n = d.set(i, [])
          D(t, function (t, e) {
            E(t) && (t = r.get(t)), null != t && t < a && ((n[e] = t), p(l[t], i, e))
          })
        }
      })
    var f = 0
    ...
    for (var y, _, x = g || 'value', w = 0; w < a; w++) {
      null == (c = l[w] = l[w] || new _f()).coordDim &&
        ...
        null == c.type &&
          ...
          (_ = w),
          c.name,
          Fh(y.data, y.sourceFormat, y.seriesLayoutBy, y.dimensionsDefine, y.startIndex, _) ===
            Lh.Must ||
  ...
  var Yf = {
    cartesian2d: function (t, e, i, n) {
      ...
      ;(e.coordSysDims = ['x', 'y']),
        ...
        jf(o) && (n.set('y', o), e.firstCategoryDimIndex, (e.firstCategoryDimIndex = 1))
    },
    ...
    polar: function (t, e, i, n) {
      ...
      ;(e.coordSysDims = ['radius', 'angle']),
        ...
        jf(a) &&
          (n.set('angle', a), null == e.firstCategoryDimIndex && (e.firstCategoryDimIndex = 1))
    },
    ...
    parallel: function (t, r, o, a) {
      ...
      D(e.parallelAxisIndex, function (t, e) {
        var i = s.getComponent('parallelAxis', t),
          n = l[e]
        o.set(n, i),
          jf(i) && null == r.firstCategoryDimIndex && (a.set(n, i), (r.firstCategoryDimIndex = e))
      })
    },
  }
  function jf(t) {
  ...
  function Qf(t, e, i) {
    ...
    a &&
      ...
      (n = n ||
        (o && (o.getDimensionsInfo ? o.getDimensionsInfo() : o.dimensions.slice())) || ['x', 'y'])
    var s,
      l,
      h = Uf(t, {
        coordDimensions: n,
  ...
  ;(Jf.prototype.parse = function (t) {
    ...
    (tp.createByAxisModel = function (t) {
      var e = t.option,
        i = e.data,
        n = i && P(i, np)
      return new tp({ categories: n, needCollect: !n, deduplication: !1 !== e.dedplication })
    })
  var ep = tp.prototype
  function ip(t) {
  ...
  ;(ep.getOrdinal = function (t) {
    ...
    (ep.parseAndCollect = function (t) {
      ...
      return (
        null == (e = n.get(t)) &&
          (i ? ((e = this.categories.length), (this.categories[e] = t), n.set(t, e)) : (e = NaN)),
        e
      )
    })
  var rp = Jf.prototype,
    op = Jf.extend({
      ...
      contain: function (t) {
        return (
          (t = this.parse(t)), rp.contain.call(this, t) && null != this._ordinalMeta.categories[t]
        )
      },
  ...
  var up = Tl,
    cp = Jf.extend({
      ...
      getTicks: function (t) {
        ...
        for (var a = n[0]; a <= n[1] && (o.push(a), (a = up(a + e, r)) !== o[o.length - 1]); )
      ...
      getMinorTicks: function (t) {
        for (var e = this.getTicks(!0), i = [], n = this.getExtent(), r = 1; r < e.length; r++) {
          for (var o = e[r], a = e[r - 1], s = 0, l = [], h = (o - a) / t; s < t - 1; ) {
            var u = Tl(a + (s + 1) * h)
      ...
      getLabel: function (t, e) {
        ...
        var i = e && e.precision
        return (
          null == i ? (i = kl(t) || 0) : 'auto' === i && (i = this._intervalPrecision),
          Hl((t = up(t, i, !0)))
        )
      },
      niceTicks: function (t, e, i) {
        ...
        if (isFinite(r)) {
          ...
          var o = (function (t, e, i, n) {
            ...
            null != i && a < i && (a = r.interval = i), null != n && n < a && (a = r.interval = n)
  ...
  var Sp = cp.prototype,
    ...
    Ap = cp.extend({
      ...
      niceExtent: function (t) {
        var e = this._extent
        if ((e[0] === e[1] && ((e[0] -= Tp), (e[1] += Tp)), e[1] === -1 / 0 && e[0] === 1 / 0)) {
          var i = new Date()
          ;(e[1] = +new Date(i.getFullYear(), i.getMonth(), i.getDate())), (e[0] = e[1] - Tp)
        }
        this.niceTicks(t.splitNumber, t.minInterval, t.maxInterval)
        var n = this._interval
        t.fixMin || (e[0] = Tl(Ip(e[0] / n) * n)), t.fixMax || (e[1] = Tl(Mp(e[1] / n) * n))
      },
      niceTicks: function (t, e, i) {
        t = t || 10
        var n = this._extent,
        ...
        var u = this.getSetting('useUTC')
          ...
          c = [Math.round(Mp((n[0] - u) / h) * h + u), Math.round(Ip((n[1] - u) / h) * h + u)]
        hp(c, n), (this._stepLvl = l), (this._interval = h), (this._niceExtent = c)
      },
      parse: function (t) {
        return +Nl(t)
      },
  ...
  var kp = Jf.prototype,
    ...
    Bp = Jf.extend({
      ...
      unionExtent: function (t) {
        ...
        var e = this.base
        ;(t[0] = Rp(t[0]) / Rp(e)), (t[1] = Rp(t[1]) / Rp(e)), kp.unionExtent.call(this, t)
      },
      unionExtentFromData: function (t, e) {
        this.unionExtent(t.getApproximateExtent(e))
      },
      niceTicks: function (t) {
        ...
        if (!(i == 1 / 0 || i <= 0)) {
          var n = Rl(i)
          for ((t / i) * n <= 0.5 && (n *= 10); !isNaN(n) && Math.abs(n) < 1 && 0 < Math.abs(n); )
            n *= 10
  ...
  function Fp(t, e) {
    ...
    'ordinal' === o
      ...
      'dataMin' === a ? (a = l[0]) : 'function' == typeof a && (a = a({ min: l[0], max: l[1] })),
    ...
    null == a && (a = 'ordinal' === o ? (i ? 0 : NaN) : l[0] - n[0] * r),
      ...
      t.setBlank(F(a) || F(s) || ('ordinal' === o && !t.getOrdinalMeta().categories.length)),
      e.getNeedCrossZero() && (0 < a && 0 < s && !h && (a = 0), a < 0 && s < 0 && !u && (s = 0))
    var c = e.ecModel
    if (c && 'time' === o) {
      var d,
        f = mp('bar', c)
  ...
  function Wp(t, e) {
    if ((e = e || t.get('type')))
      switch (e) {
        case 'category':
          return new op(t.getOrdinalMeta ? t.getOrdinalMeta() : t.getCategories(), [1 / 0, -1 / 0])
        case 'value':
          return new cp()
        default:
  ...
  var tg = ws({
    ...
    calculateTextPosition: function (t, e, i) {
      var n = dn(t, e, i),
        r = this.shape
      return (
        r && 'pin' === r.symbolType && 'inside' === e.textPosition && (n.y = i.y + 0.4 * i.height),
        n
      )
    },
    buildPath: function (t, e, i) {
  ...
  var ng = { isDimensionStacked: $f, enableDataStack: qf, getStackedDimension: Kf }
  ...
  function sg(t, e, i) {
    ...
    var s = t[0]
    return (ag(r[0], s[0]) && ag(r[1], s[1])) || (n += sa(r[0], r[1], s[0], s[1], e, i)), 0 !== n
  }
  function lg(t, e, i) {
  ...
  lg.prototype = {
    ...
    getBoundingRect: function () {
      ...
      for (
        ...
        if ('polygon' === a[s].type) Eo(a[s].exterior, r, o), _t(i, i, r), xt(n, n, o)
      }
      return (
      ...
      t: for (var n = 0, r = i.length; n < r; n++)
        if ('polygon' === i[n].type) {
          var o = i[n].exterior,
            a = i[n].interiors
          if (sg(o, t[0], t[1])) {
            for (var s = 0; s < (a ? a.length : 0); s++) if (sg(a[s])) continue t
            return !0
          }
        }
      return !1
    ...
    transformTo: function (t, e, i, n) {
      ...
      i ? (n = n || i / o) : (i = o * n)
      for (
        var a = new bi(t, e, i, n), s = r.calculateTransform(a), l = this.geometries, h = 0;
        h < l.length;
        h++
      )
        if ('polygon' === l[h].type) {
    ...
    return (
      (function (t) {
        ...
        for (var i = t.features, n = 0; n < i.length; n++)
          for (
            var r = i[n].geometry, o = r.coordinates, a = r.encodeOffsets, s = 0;
            s < o.length;
            s++
          ) {
            var l = o[s]
      ...
      : (function (i) {
          ...
          return {
            labels: P(t, function (t, e) {
              return { formattedLabel: n(t, e), rawLabel: i.scale.getLabel(t), tickValue: t }
            }),
          }
        })(t)
  }
              ...
              (i =
                'auto' === r
                  ? (function (t) {
                      ...
                      return null != e ? e : (cg(t).autoInterval = t.calculateCategoryInterval())
                    })(t)
                  : r)
            ),
  ...
  function yg(t, e, i) {
    ...
    function g(t) {
      s.push(i ? t : { formattedLabel: n(t), rawLabel: r.getLabel(t), tickValue: t })
    }
  ...
  function _g(t, i, n) {
    ...
    return (
      D(r.getTicks(), function (t) {
        var e = r.getLabel(t)
        i(t, e) && a.push(n ? t : { formattedLabel: o(t), rawLabel: e, tickValue: t })
      }),
      a
    )
  }
      ...
      return (
        (function (t, e, i, n) {
          ...
          if (1 === r) (e[0].coord = s[0]), (o = e[1] = { coord: s[0] })
            ...
            ;(a = 1 + u[1] - e[r - 1].tickValue), (o = { coord: e[r - 1].coord + h * a }), e.push(o)
          }
          var c = s[0] > s[1]
  ...
  function Ng(t, e) {
    if (!this.incremental && !this.useHoverLayer)
      if ('emphasis' === e) {
        ...
        'normal' === e && this.animateTo({ scale: this.__symbolOriginalScale }, 400, 'elasticOut')
  }
  function Rg(t) {
  ...
  ;(Ag._updateCommon = function (i, t, e, n) {
    ...
    (Ag.fadeOut = function (t, e) {
      ...
      ;(this.silent = i.silent = !0),
        ...
        il(i, { style: { opacity: 0 }, scale: [0, 0] }, this._seriesModel, this.dataIndex, t)
    }),
    w(Tg, Si)
  var Bg = Rg.prototype
  function Vg(t, e, i, n) {
    ...
    (Bg.incrementalUpdate = function (t, e, i) {
      ...
      for (var r = t.start; r < t.end; r++) {
        ...
        if (Vg(e, o, r, i)) {
          ...
          a.traverse(n), a.attr('position', o), this.group.add(a), e.setItemGraphicEl(r, a)
        }
      }
    }),
          ...
          for (var c = 0, d = i, f = 0; f < n; f++) {
            ...
            if (d === i) t[0 < o ? 'moveTo' : 'lineTo'](p[0], p[1]), Yg(qg, p)
              ...
              if (!(m = e[g]) || Kg(m)) Yg($g, p)
                ...
                var _, x
                if ((Kg(m) && !u && (m = p), st(jg, m, y), 'x' === h || 'y' === h)) {
                  var w = 'x' === h ? 0 : 1
  ...
  var tm = xa.extend({
      ...
      buildPath: function (t, e) {
        ...
        for (; n < r; )
          n += Qg(t, i, n, r, r, 1, o.min, o.max, e.smooth, e.smoothMonotone, e.connectNulls) + 1
      },
    }),
    em = xa.extend({
      type: 'ec-polygon',
      ...
      buildPath: function (t, e) {
        ...
        for (; r < o; ) {
          var h = Qg(t, i, r, o, o, 1, s.min, s.max, e.smooth, a, e.connectNulls)
          Qg(t, n, r + h - 1, h, o, -1, l.min, l.max, e.stackedOnSmooth, a, e.connectNulls),
            (r += h + 1),
            t.closePath()
        }
      },
  ...
  function im(t, e, i) {
    ...
    return (
      e && ((u.shape[r ? 'width' : 'height'] = 0), nl(u, { shape: { width: s, height: l } }, i)), u
    )
  }
  function nm(t, e, i) {
    var n = t.getArea(),
    ...
    return (
      e && ((r.shape.endAngle = n.startAngle), nl(r, { shape: { endAngle: n.endAngle } }, i)), r
    )
  }
  function rm(t, e) {
  ...
  function sm(t, e, i) {
    for (
      var n = e.getBaseAxis(), r = 'x' === n.dim || 'radius' === n.dim ? 0 : 1, o = [], a = 0;
      a < t.length - 1;
      a++
    ) {
      var s = t[a + 1],
        ...
        (!r ||
          !(function (t, e) {
            ...
            for (var r = e.count(), o = Math.max(1, Math.round(r / 5)), a = 0; a < r; a += o)
              if (1.5 * Tg.getSymbolSize(e, a)[t.isHorizontal() ? 1 : 0] > n) return !1
            return !0
          })(o, e))
      ) {
  ...
  ac.extend({
    ...
    render: function (t, e, i) {
      var n = t.coordinateSystem,
        ...
        y = (function (t, e, i) {
          ...
          for (var n = [], r = 0, o = e.count(); r < o; r++) n.push(Gg(i, t, e, r))
          return n
        })(n, o, Wg(n, o, v)),
        _ = t.get('showSymbol'),
        x = _ && !h && lm(t, o, n),
      ...
      d.useStyle(A(a.getLineStyle(), { fill: 'none', stroke: M, lineJoin: 'bevel' }))
      var I = t.get('smooth')
      if (
        ((I = am(t.get('smooth'))),
        d.setShape({
        ...
        var C = o.getCalculationInfo('stackedOnSeries'),
          T = 0
        f.useStyle(A(s.getAreaStyle(), { fill: M, opacity: 0.7, lineJoin: 'bevel' })),
          C && (T = am(C.get('smooth'))),
          f.setShape({
            smooth: I,
            stackedOnSmooth: T,
    ...
    _updateAnimation: function (t, e, i, n, r, o) {
      var a = this._polyline,
          ...
          for (
            ...
            switch (_.cmd) {
              ...
              case '+':
                var S = _.idx
                h.push(
                  r.dataToPoint([e.get(m.dataDimsForPoint[0], S), e.get(m.dataDimsForPoint[1], S)])
                ),
        ...
        })(this._data, t, this._stackedOnPoints, e, this._coordSys, i, this._valueOrigin, o),
        u = h.current,
      ...
      if (
        ...
        return a.setShape({ points: d }), void (s && s.setShape({ points: d, stackedOnPoints: f }))
    ...
    (mm.prototype = {
      ...
      clampData: function (t, e) {
        var i = this.getAxis('x').scale,
          ...
          s = n.parse(t[1])
        return (
          ((e = e || [])[0] = Math.min(Math.max(Math.min(r[0], r[1]), a), Math.max(r[0], r[1]))),
  ...
  function vm(t, e, i, n, r) {
    xg.call(this, t, e, i), (this.type = n || 'value'), (this.position = r || 'bottom')
  }
  ;(vm.prototype = {
    constructor: vm,
    index: 0,
  ...
  ;(_m.categoryAxis = m(
    ...
    (_m.timeAxis = A({ scale: !0, min: 'dataMin', max: 'dataMax' }, _m.valueAxis)),
  ...
  function xm(o, t, a, e) {
    D(wm, function (r) {
      t.extend({
        ...
        optionUpdated: function () {
          'category' === this.option.type && (this.__ordinalMeta = tp.createByAxisModel(this))
        },
  ...
  ;(Tm.type = 'grid'),
    ...
    (Tm.resize = function (t, e, i) {
      var r = lh(t.getBoxLayoutParams(), { width: e.getWidth(), height: e.getHeight() })
      this._rect = r
                  ...
                  for (var _ = 0; _ < r; _ += y) {
                    var x = v(n ? n[_] : a[0] + _),
                      ...
                      b =
                        ...
                        (d = c.width),
                        (f = c.height),
                        (p = d * Math.abs(Math.cos(u)) + Math.abs(f * Math.sin(u))),
                        (g = d * Math.abs(Math.sin(u)) + Math.abs(f * Math.cos(u))),
                        new bi(c.x, c.y, p, g))
                    s ? s.union(b) : (s = b)
                  }
                  return s
    ...
    (Tm._findConvertTarget = function (t, e) {
      ...
      else if (o && a) i = this.getCartesian(o.componentIndex, a.componentIndex)
      ...
      function i(o) {
        return function (t, e) {
          if (Im(t, a)) {
            ...
            'x' === o
              ? 'top' !== i && 'bottom' !== i && (i = s.bottom ? 'top' : 'bottom')
              : 'left' !== i && 'right' !== i && (i = s.left ? 'right' : 'left'),
              (s[i] = !0)
  ...
  ;(Cm.create = function (n, r) {
    ...
    return (
      n.eachComponent('grid', function (t, e) {
        var i = new Cm(t, n, r)
        ;(i.name = 'grid_' + e), i.resize(t, r, !0), (t.coordinateSystem = i), o.push(i)
      }),
  ...
  function Om(t, e) {
    ;(this.opt = e),
      (this.axisModel = t),
      A(e, { labelOffset: 0, nameDirection: 1, tickDirection: 1, labelDirection: 1, silent: !0 }),
      (this.group = new Si())
      ...
      axisLine: function () {
        ...
        if (t.get('axisLine.show')) {
          var e = this.axisModel.axis.getExtent(),
            ...
            n = [e[1], 0]
          i && (yt(a, a, i), yt(n, n, i))
          var s = k({ lineCap: 'round' }, t.getModel('axisLine.lineStyle').getLineStyle())
          this.group.add(
            new es({
              anid: 'line',
              subPixelOptimize: !0,
            ...
            D(
              [
                { rotate: o.rotation + Math.PI / 2, offset: h[0], r: 0 },
                {
                  ...
                  offset: h[1],
                  r: Math.sqrt((a[0] - n[0]) * (a[0] - n[0]) + (a[1] - n[1]) * (a[1] - n[1])),
                },
              ],
              function (t, e) {
                if ('none' !== l[e] && null != l[e]) {
                  var i = ig(l[e], -u / 2, -c / 2, u, c, s.stroke, !0),
                    n = t.r + t.offset,
                    r = [a[0] + n * Math.cos(o.rotation), a[1] - n * Math.sin(o.rotation)]
                  i.attr({ rotation: t.rotate, position: r, silent: !0, z2: 11 }), this.group.add(i)
                }
              },
              this
            )
      ...
      axisTickLabel: function () {
        ...
        !(function (t, e, i) {
          ...
          var o = (e = e || [])[0],
            ...
            c = i[i.length - 1],
            d = i[i.length - 2]
          !1 === n ? (Vm(o), Vm(h)) : Fm(o, a) && (n ? (Vm(a), Vm(u)) : (Vm(o), Vm(h)))
          !1 === r ? (Vm(s), Vm(c)) : Fm(l, s) && (r ? (Vm(l), Vm(d)) : (Vm(s), Vm(c)))
        })(
          t,
          (function (h, u, c) {
            var d = u.axis
            ...
            return (
              D(t, function (t, e) {
                var i = t.tickValue,
                  ...
                  r = t.rawLabel,
                  o = f
                m && m[i] && m[i].textStyle && (o = new _l(m[i].textStyle, f, u.ecModel))
                ...
                js(l.style, o, {
                  ...
                  textFill:
                    'function' == typeof a
                      ? a('category' === d.type ? r : 'value' === d.type ? i + '' : i, e)
                      : a,
                }),
                  _ &&
                    ((l.eventData = Nm(u)),
      ...
      axisName: function () {
        ...
        if (i) {
          var n,
            ...
            u = h[0] > h[1] ? -1 : 1,
            c = [
              'start' === o ? h[0] - u * l : 'end' === o ? h[1] + u * l : (h[0] + h[1]) / 2,
              ...
              : ((n = (function (t, e, i, n) {
                  ...
                  r = zl(a - zm / 2)
                    ...
                    : zl(a - 1.5 * zm)
                      ...
                      : ((o = 'middle'),
                        a < 1.5 * zm && zm / 2 < a ? (l ? 'left' : 'right') : l ? 'right' : 'left')
                  return { rotation: a, textAlign: r, textVerticalAlign: o }
                })(t, o, d || 0, h)),
                null != (r = t.axisNameAvailableWidth) &&
                  ((r = Math.abs(r / Math.sin(n.rotation))), isFinite(r) || (r = null)))
          var f = s.getFont(),
      ...
      return {
        ...
        textAlign: zl(r)
          ...
          : zl(r - zm)
            ...
            : ((n = 'middle'),
              0 < r && r < zm ? (0 < i ? 'right' : 'left') : 0 < i ? 'left' : 'right'),
        textVerticalAlign: n,
      }
    })
  ...
  function Wm(t, e, i, n, r) {
    for (var o = [], a = [], s = [], l = 0; l < t.length; l++) {
      var h = t[l].coord
      ;(a[0] = h), (s[(a[1] = 0)] = h), (s[1] = i), e && (yt(a, a, e), yt(s, s, e))
      var u = new es({
      ...
      (function (p, g, t) {
        ...
        Gm(t.getCoordinateSystems(), function (c) {
          if (c.axisPointerEnabled) {
            ...
            if ((Gm(c.getAxes(), Zm(r, !1, null)), c.getTooltipAxes && o && f.get('show'))) {
          ...
          function r(t, e, i) {
            ...
            if (r && ('auto' !== r || t || jm(n))) {
              ...
              if (null != h) {
                ...
                ;(u.axesInfo[a] = l), (u.mapper = v[h].mapper), (l.linkGroup = u)
              }
            }
          }
        })
  ...
  function Km(t, e, i, n, r, o) {
    ...
    if (a) {
      ...
      s ? (t._axisPointer || (t._axisPointer = new a())).render(e, s, n, o) : Qm(t, n)
    }
  }
  function Qm(t, e, i) {
  ...
  function tv(t, e, i) {
    ...
    ;(o.labelDirection =
      ...
      H(i.labelInside, e.get('axisLabel.inside')) && (o.labelDirection = -o.labelDirection)
  ...
  var ev = ['axisLine', 'axisTickLabel', 'axisName'],
    ...
    nv = $m.extend({
      ...
      render: function (e, t, i, n) {
        ...
        if (((this._axisGroup = new Si()), this.group.add(this._axisGroup), e.get('show'))) {
      ...
      _minorSplitLine: function (t, e) {
        ...
        if (a.length)
          for (var s = [], l = [], h = n.getLineStyle(), u = 0; u < a.length; u++)
            for (var c = 0; c < a[u].length; c++) {
              var d = i.toGlobalCoord(a[u][c].coord)
              o
                ? ((s[0] = d), (s[1] = r.y), (l[0] = d), (l[1] = r.y + r.height))
                : ((s[0] = r.x), (s[1] = d), (l[0] = r.x + r.width), (l[1] = d)),
                this._axisGroup.add(
                  new es({
    ...
    rf(gd.PROCESSOR.STATISTIC, {
      ...
      reset: function (t, e, i) {
        ...
        if ('cartesian2d' === o.type && r) {
          ...
          1 < c &&
            ('string' == typeof r ? (a = fm[r]) : 'function' == typeof r && (a = r),
    ...
    sv = ws({
      ...
      buildPath: function (t, e) {
        ...
        ;(u ? h - l < 2 * Math.PI : l - h < 2 * Math.PI) &&
          (t.moveTo(c * r + i, d * r + n), t.arc(c * s + i, d * s + n, a, -Math.PI + l, l, !u)),
          t.arc(i, n, o, l, h, !u),
    ...
    ff({
      ...
      _renderNormal: function (s, t, e) {
        ...
        function m(t) {
          var e = mv[d.type](u, t),
            i = (function (t, e, i) {
              return new ('polar' === t.type ? Wa : Ja)({ shape: bv(e, i, t), silent: !0, z2: 0 })
            })(d, l, e)
          return (
        ...
        u.diff(c)
          .add(function (t) {
            ...
            if ((y && m(t), u.hasValue(t))) {
              ...
              u.setItemGraphicEl(t, n), h.add(n), yv(n, u, t, e, i, s, l, 'polar' === d.type)
            }
          })
          .update(function (t, e) {
            ...
            if (u.hasValue(t)) {
              ...
              a ? il(a, { shape: n }, f, t) : (a = fv[d.type](t, n, l, f, !0, v)),
      ...
      _clear: function (e) {
        ...
        e && e.get('animation') && i && !this._isLargeDraw
          ? (this._removeBackground(),
            (this._backgroundEls = []),
            i.eachItemGraphicEl(function (t) {
              'sector' === t.type ? gv(t.dataIndex, e, t) : pv(t.dataIndex, e, t)
            }))
          : t.removeAll(),
          (this._data = null)
      },
  ...
  function yv(t, e, i, n, r, o, a, s) {
    ...
    s || t.setShape('r', c.get('barBorderRadius') || 0),
      t.useStyle(
        A({ stroke: vv(r) ? 'none' : u, fill: vv(r) ? 'none' : l, opacity: h }, c.getBarItemStyle())
      )
  ...
  var wv = mc(
    function (t) {
      var e = (function (t, e, i) {
        ...
        ;(hv[0] = e), (hv[1] = i)
        for (
          var h = hv[n], u = hv[1 - n], c = h - s, d = h + s, f = 0, p = o.length / 2;
          f < p;
          f++
        ) {
          var g = 2 * f,
            m = o[g + n],
            v = o[g + r]
          if (c <= m && m <= d && (l <= v ? l <= u && u <= v : v <= u && u <= l)) return a[f]
        }
        return -1
    ...
    T(function (t, e) {
      ...
      D(
        ...
        function (t) {
          ...
          ;(T[r] = T[r] || []), e.setLayout({ bandWidth: o.bandWidth, offset: a, size: s })
          for (
            ...
            var v,
              ...
              M = 0 <= b ? 'p' : 'n',
              I = p
            if ((d && (T[r][S] || (T[r][S] = { p: p, n: p }), (I = T[r][S][M])), f))
              (v = I),
  ...
  var Iv = df({
    ...
    init: function (t) {
      Iv.superApply(this, 'init', arguments),
        (this.legendVisualProvider = new Mv(C(this.getData, this), C(this.getRawData, this))),
        this.updateSelectedMap(this._createSelectableList()),
        this._defaultLabelLine(t)
    },
    mergeOption: function (t) {
      Iv.superCall(this, 'mergeOption', t), this.updateSelectedMap(this._createSelectableList())
    },
    getInitialData: function (t, e) {
      return (function (t, e, i) {
    ...
    _createSelectableList: function () {
      for (
        var t = this.getRawData(), e = t.mapDimension('value'), i = [], n = 0, r = t.count();
        n < r;
        n++
      )
        i.push({ name: t.getName(n), value: t.get(e, n), selected: ku(t, n, 'selected') })
      return i
    },
  ...
  function Cv(t, e, i, n) {
    ...
    n.dispatchAction({ type: 'pieToggleSelect', from: t, name: a, seriesId: e.id }),
      r.each(function (t) {
        Tv(r.getItemGraphicEl(t), r.getItemLayout(t), e.isSelected(r.getName(t)), s, i)
      })
  }
  function Tv(t, e, i, n, r) {
    ...
    r ? t.animate().when(200, { position: s }).start('bounceOut') : t.attr('position', s)
  }
  function Av(t, e) {
    Si.call(this)
    var i = new Wa({ z2: 2 }),
    ...
    i
      ? (n.setShape(h),
        'scale' === a.getShallow('animationType')
          ...
          : ((n.shape.endAngle = l.startAngle), il(n, { shape: { endAngle: l.endAngle } }, a, e)))
      : 'expansion' === u
        ? n.setShape(h)
        : il(n, { shape: h }, a, e)
    var c = t.getItemVisual(e, 'color')
    n.useStyle(A({ lineJoin: 'bevel', fill: c }, s.getModel('itemStyle').getItemStyle())),
        ...
        : function (t, e) {
            ...
            'emphasis' === e
              ? ((r.ignore = r.hoverIgnore),
                ...
                i &&
                  (n.stopAnimation(!0),
                  n.animateTo({ shape: { r: l.r + a.get('hoverOffset') } }, 300, 'elasticOut')))
              : ((r.ignore = r.normalIgnore),
                (o.ignore = o.normalIgnore),
                i && (n.stopAnimation(!0), n.animateTo({ shape: { r: l.r } }, 300, 'elasticOut')))
          }),
      Gs(this)
  }),
  ...
  ac.extend({
    ...
    _createClipPath: function (t, e, i, n, r, o, a, s) {
      var l = new Wa({
        shape: { cx: t, cy: e, r0: 0, r: i, startAngle: n, endAngle: n, clockwise: r },
      })
      return (s ? nl : il)(l, { shape: { endAngle: n + (r ? 1 : -1) * Math.PI * 2 } }, a, o), l
    },
  ...
  function Pv(r, t, e, i, n, o, a, s, l, h) {
    function u(t, e, i) {
      for (var n = t; n < e && !(r[n].y + i > l + a); n++)
        if (((r[n].y += i), t < n && n + 1 < e && r[n + 1].y > r[n].y + r[n].height))
          return void c(n, i / 2)
      c(e - 1, i / 2)
    }
    function c(t, e) {
    ...
    function d(t, e, i, n, r, o) {
      for (var a = e ? Number.MAX_VALUE : 0, s = 0, l = t.length; s < l; s++)
        if ('none' === t[s].labelAlignTo) {
          ...
          e && a <= d && (d = a - 10), !e && d <= a && (d = a + 10), (t[s].x = i + d * o), (a = d)
        }
    }
    r.sort(function (t, e) {
      return t.y - e.y
  ...
  function Ov(k, P, L, t, O, e) {
    ...
    N.each(function (t) {
        ...
        if ('center' === r) (f = e.cx), (p = e.cy), (m = 'center')
          ...
          if (((f = M + 3 * y), (p = I + 3 * _), !S)) {
            var C = M + y * (c + P - e.r),
              T = I + _ * (c + P - e.r),
              A = C + (y < 0 ? -1 : 1) * d
            ;(f = 'edge' === a ? (y < 0 ? O + s : O + L - s) : A + (y < 0 ? -o : o)),
              (g = [
                [M, I],
                [C, T],
                [A, (p = T)],
          ...
          m = S ? 'center' : 'edge' === a ? (0 < y ? 'right' : 'left') : 0 < y ? 'left' : 'right'
        }
        var D = n.get('rotate')
        ;(x = 'number' == typeof D ? D * (Math.PI / 180) : D ? (y < 0 ? -v + Math.PI : -v) : 0),
          (B = !!x),
          (e.label = {
            x: f,
            y: p,
      ...
      !B &&
        ...
        (function (t, e, i, n, r, o, a, s) {
          for (
            var l = [], h = [], u = Number.MAX_VALUE, c = -Number.MAX_VALUE, d = 0;
            d < t.length;
            d++
          )
            Lv(t[d]) ||
          ...
          for (
            Pv(h, e, i, n, 1, 0, o, 0, s, c), Pv(l, e, i, n, -1, 0, o, 0, s, u), d = 0;
            d < t.length;
            d++
          ) {
            var f = t[d]
      ...
      function (o) {
        ;(o.update = 'updateView'),
          of(o, function (t, e) {
            var r = {}
            return (
              e.eachComponent({ mainType: 'series', subType: Nv, query: t }, function (i) {
            ...
            l.each(function (t) {
              ...
              if (((n && r) || (e = l.getItemModel(t)), !n)) {
                var o =
                  ...
                  s.getColorFromPalette(l.getName(t) || t + '', s.__paletteScope, l.count())
      ...
      T(function (t, e, T, i) {
        e.eachSeriesByType(t, function (t) {
          var r = t.getData(),
            ...
            o = (function (t, e) {
              return lh(t.getBoxLayoutParams(), { width: e.getWidth(), height: e.getHeight() })
            })(t, T),
            i = t.get('center'),
            n = t.get('radius')
          O(n) || (n = [0, n]), O(i) || (i = [i, i])
            ...
            if (b <= 0.001) {
              ...
              r.each(e, function (t, e) {
                if (!isNaN(t)) {
                  ...
                  ;(i.angle = C), (i.startAngle = f + I * e * C), (i.endAngle = f + I * (e + 1) * C)
                }
              })
            } else
              (v = b / S),
  ...
  ;(Fv.isPersistent = function () {
    ...
    (Fv._setCommon = function (i, t, e, n) {
      ...
      i.useStyle(
        r.getModel('itemStyle').getItemStyle(a ? ['color', 'shadowBlur', 'shadowColor'] : ['color'])
      )
    ...
    ff({
      ...
      render: function (t, e, i) {
        var n = t.getData()
        this._updateSymbolDraw(n, t).updateData(n, { clipShape: this._getClipShape(t) }),
          (this._finished = !0)
      },
      incrementalPrepareRender: function (t, e, i) {
        var n = t.getData()
      ...
      updateTransform: function (t, e, i) {
        ...
        if (
          ...
          return { update: !0 }
        var r = cm().reset(t)
        r.progress && r.progress({ start: 0, end: n.count() }, n), this._symbolDraw.updateLayout(n)
      },
      ...
      D(
        ...
        function (t, e) {
          ...
          i &&
            ...
            (function (t, e) {
              if (!t) return
              ;(t.hv = e.hv = [Uv(e, ['left', 'right']), Uv(e, ['top', 'bottom'])]),
                'group' === t.type &&
      ...
      if (t) {
        ...
        D(t, function (t) {
          ...
          'text' === t.type &&
            ...
            !a.hasOwnProperty('textStroke') && a.stroke && (a.textStroke = a.stroke))
          var s = (function (e) {
            return (
              (e = k({}, e)),
              D(['id', 'parentId', '$action', 'hv', 'bounding'].concat(rh), function (t) {
                delete e[t]
              }),
              e
            )
          ...
          l &&
            ...
            (function (t, e) {
              ...
              t.silent ||
                ...
                i ||
                (i = t.eventData =
                  { componentType: 'graphic', componentIndex: e.componentIndex, name: t.name })
              i && (i.info = t.info)
            })(l, h))
        })
      }
    ...
    _relocate: function (t, e) {
      for (
        ...
        if ((u = r.get(l.id)) && u.isGroup) {
          var h = (c = u.parent) === n
          ;(u.__ecGraphicWidth = Cl(u.__ecGraphicWidthOption, h ? o : c.__ecGraphicWidth) || 0),
            (u.__ecGraphicHeight = Cl(u.__ecGraphicHeightOption, h ? a : c.__ecGraphicHeight) || 0)
        }
      }
            ...
            return (
              Yv(t.seriesModels, function (e, t) {
                ...
                if (e.getAxisTooltipData) {
                  ...
                  if (
                    !(n = e.getData().indicesOfNearest(r[0], l, 'category' === h.type ? 0.5 : null))
                      .length
                  )
                    return
                ...
                if (null != i && isFinite(i)) {
                  var a = l - i,
                    s = Math.abs(a)
                  s <= f &&
                    ((s < f || (0 <= a && p < 0)) && ((f = s), (p = a), (c = i), (d.length = 0)),
                    Yv(n, function (t) {
                      d.push({
  ...
  var sy = cf({
      ...
      remove: function (t, e) {
        ay(e.getZr(), 'axisPointer'), sy.superApply(this._model, 'remove', arguments)
      },
      dispose: function (t, e) {
  ...
  function vy(t, e, r, i, n) {
    ...
    var o = e.scale.getLabel(t, { precision: n.precision }),
      a = n.formatter
    if (a) {
      var s = { value: Zp(e, t), axisDimension: e.dim, axisIndex: e.index, seriesData: [] }
      D(i, function (t) {
  ...
  function yy(t, e, i) {
    ...
    return (
      ...
      oe(n, n, i.position),
      ol(
        [t.dataToCoord(e), (i.labelOffset || 0) + (i.labelDirection || 1) * (i.labelMargin || 0)],
        n
      )
    )
  }
    ...
    ((cy.prototype = {
      ...
      _renderHandle: function (t) {
        if (!this._dragging && this.updateHandleTransform) {
          ...
          O(s) || (s = [s, s]),
            ...
            vc(this, '_doDispatchAxisPointer', o.get('throttle') || 0, 'fixRate'),
      ...
      _moveHandleToValue: function (t, e) {
        dy(
          ...
          this._handle,
          py(this.getHandleTransform(t, this._axisModel, this._axisPointerModel))
        )
      },
      _onHandleDragMove: function (t, e) {
        ...
        if (i) {
          this._dragging = !0
          var n = this.updateHandleTransform(py(i), [t, e], this._axisModel, this._axisPointerModel)
          ;(this._payloadInfo = n),
            i.stopAnimation(),
            i.attr(py(n)),
            (ly(i).lastProp = null),
  ...
  var _y = cy.extend({
    ...
    getHandleTransform: function (t, e, i) {
      ...
      return (
        ...
        { position: yy(e.axis, t, n), rotation: n.rotation + (n.labelDirection < 0 ? Math.PI : 0) }
      )
    },
  ...
  $m.registerAxisPointerClass('CartesianAxisPointer', _y),
    ...
    of(
      ...
      function (t, e, i) {
        ...
        if (s) {
          ty(a) && (a = Xv({ seriesIndex: r.seriesIndex, dataIndex: r.dataIndex }, e).point)
          var l = ty(a),
            h = r.axesInfo,
            u = s.axesInfo,
            c = 'leave' === n || ty(a),
          ...
          Yv(s.coordSysMap, function (t, e) {
            ...
            Yv(s.coordSysAxesInfo[e], function (t, e) {
              ...
              if (!c && o && (!h || n)) {
                var r = n && n.value
                null != r || l || (r = i.pointToData(a)), null != r && $v(t, r, g, !1, d)
              }
            })
          })
          var m = {}
            ...
            Yv(u, function (r, t) {
              ...
              o &&
                ...
                Yv(o.axesInfo, function (t, e) {
                  ...
                  if (t !== r && i) {
                    var n = i.value
                    o.mapper && (n = r.axis.scale.parse(o.mapper(n, Jv(t), Jv(r)))), (m[r.key] = n)
                  }
                })
            }),
            Yv(m, function (t, e) {
    ...
    return (
      ...
      e &&
        (v.canvasSupported
          ...
          : (o.push('background-Color:#' + Ve(e)), o.push('filter:alpha(opacity=70)'))),
      ...
      o.push(
        (function (i) {
          ...
          null == r && (r = Math.round((3 * t) / 2)), t && n.push('line-height:' + r + 'px')
  ...
  cf({
      ...
      if (!v.node) {
        ...
        ;(this._renderMode = Xr(r)),
          'html' === this._renderMode
            ? ((i = new Ay(e.getDom(), e, { appendToBody: n.get('appendToBody', !0) })),
              (this._newLine = '<br/>'))
    ...
    manuallyShowTip: function (t, e, i, n) {
      if (n.from !== this.uid && !v.node) {
        ...
        if (n.tooltip && null != n.x && null != n.y) {
          ...
          null != l &&
            null != h &&
            this._tryShow({ offsetX: l, offsetY: h, position: n.position, target: s.el }, r)
        } else
          null != n.x &&
            null != n.y &&
    ...
    _manuallyAxisShowTip: function (t, e, i, n) {
      ...
      if (null != r && null != o && null != a) {
        ...
        if (s)
          if (
            'axis' ===
            (t = Ey([s.getData().getItemModel(o), s, (s.coordinateSystem || {}).model, t])).get(
              'trigger'
            )
          )
            return (
    ...
    _showAxisTooltip: function (t, e) {
        ...
        function (t) {
          Ly(t.dataByAxis, function (s) {
            ...
            if (l && null != h) {
              ...
              var t = c
              'html' !== p ? r.push(u.join(a)) : r.push((t ? Xl(t) + a : '') + u.join(a))
            }
          })
        },
        this
      ...
      this._showOrMove(o, function () {
        this._updateContentNotChangedOnAxis(t)
          ...
          : this._showTooltipContent(o, r, f, Math.random(), n[0], n[1], s, void 0, g)
      })
    },
    _showSeriesItemTooltip: function (t, e, i) {
      var n = this._ecModel,
        ...
        l = e.dataType,
        h = a.getData(l),
        u = Ey([h.getItemModel(s), a, o && (o.coordinateSystem || {}).model, this._tooltipModel]),
        c = u.get('trigger')
      if (null == c || 'item' === c) {
        var d,
          f,
      ...
      if (((this._ticket = ''), i.get('showContent') && i.get('show'))) {
        ...
        if (u && 'string' == typeof u) c = ql(u, n, !0)
          ...
          var d = Py(function (t, e) {
            t === this._ticket && (h.setContent(e, l, i), this._updatePosition(i, a, r, o, h, n, s))
          }, this)
          ;(this._ticket = e), (c = u(n, e, d))
        }
        h.setContent(c, l, i), h.show(i), this._updatePosition(i, a, r, o, h, n, s)
      }
    },
    _updatePosition: function (t, e, i, n, r, o, a) {
      ...
      if (
        ...
        'function' == typeof e &&
          (e = e([i, n], o, r.el, d, { viewSize: [s, l], contentSize: h.slice() })),
        O(e))
      )
            ...
            ;(a &= i.length === o.length) &&
              Ly(i, function (t, e) {
                ...
                ;(a &=
                  ...
                  Ly(n, function (t, e) {
                    var i = r[e]
                    a &= t.seriesIndex === i.seriesIndex && t.dataIndex === i.dataIndex
                  })
              })
          }),
    ...
    of({ type: 'showTip', event: 'showTip', update: 'tooltip:manuallyShowTip' }, function () {}),
    of({ type: 'hideTip', event: 'hideTip', update: 'tooltip:manuallyHideTip' }, function () {})
      ...
      _updateData: function (r) {
        ...
        r.eachRawSeries(function (t) {
          ...
          if ((a.push(i), t.legendVisualProvider)) {
            ...
            r.isSeriesFiltered(t) || (a = a.concat(n)), n.length ? (o = o.concat(n)) : (e = !0)
          } else e = !0
  ...
  var Gy = T,
    ...
    Xy = cf({
                  ...
                  if (t) {
                    ...
                    c.eachRawSeries(function (t) {
                      if (!p.get(s) && t.legendVisualProvider) {
                        ...
                        this._createItem(s, a, o, u, 'roundRect', null, h, n, r, g)
      ...
      _createSelector: function (t, o, a, e, i) {
        ...
        Zy(t, function (t) {
          !(function (t) {
            ...
            Ys(i.style, (i.hoverStyle = {}), n, r, { defaultText: t.title, isRectText: !1 }), Gs(i)
          })(t)
        })
      },
      _createItem: function (t, e, i, n, r, o, a, s, l, h) {
        ...
        if ((v.add(Yy(b, r, g, l, f, m)), !_ && o && (o !== r || 'none' === o))) {
          var S = 0.8 * c
          'none' === o && (o = 'circle')
          var M = ig(o, (u - S) / 2, (c - S) / 2, S, S, m ? s : d, null == p || p)
  ...
  function qy(t, e, i, n) {
    ...
    ;(r && r.useHoverLayer) ||
      i.dispatchAction({ type: 'highlight', seriesName: t, name: e, excludeSeriesId: n })
  }
  function $y(t, e, i, n) {
    var r = i.getZr().storage.getDisplayList()[0]
    ;(r && r.useHoverLayer) ||
      i.dispatchAction({ type: 'downplay', seriesName: t, name: e, excludeSeriesId: n })
  }
  ...
  var Jy = Si,
    ...
    i_ = Xy.extend({
      ...
      _layoutContentAndController: function (t, e, i, n, r, o, a) {
        ...
        sh(t.get('orient'), s, t.get('itemGap'), n ? i.width : null, n ? null : i.height),
        ...
        d &&
          ('end' === t.get('pageButtonPosition', !0) ? (g[n] += i[r] - c[r]) : (p[n] += c[r] + m))
        ;(g[1 - n] += u[o] / 2 - c[o] / 2),
          s.attr('position', f),
          l.attr('position', p),
          h.attr('position', g)
      ...
      _updatePageInfoView: function (n, r) {
        ...
        D(['pagePrev', 'pageNext'], function (t) {
          ...
          i &&
            (i.setStyle(
              'fill',
              e ? n.get('pageIconColor', !0) : n.get('pageIconInactiveColor', !0)
            ),
        ...
        t &&
          ...
          t.setStyle(
            'text',
            E(e) ? e.replace('{current}', a).replace('{total}', s) : e({ current: a, total: s })
          )
      },
      _getPageInfo: function (t) {
        ...
        for (var p = s + 1, g = f, m = f, v = null; p <= u; ++p)
          ((!(v = y(l[p])) && m.e > g.s + n) || (v && !_(v, g.s))) &&
            (g = m.i > g.i ? m : v) &&
            (null == d.pageNextDataIndex && (d.pageNextDataIndex = g.i), ++d.pageCount),
            (m = v)
  ...
  m_.extend({
    ...
    updateTransform: function (t, e, i) {
      e.eachSeries(function (t) {
        ...
        e && (v_(e.getData(), t, i), this.markerGroupMap.get(t.id).updateLayout(e))
      }, this)
    },
  ...
  function M_(t, e, i) {
    ...
    if (n && 'none' !== n) {
      ...
      return (
        (s.__specifiedRotation = null == a || isNaN(a) ? void 0 : (+a * Math.PI) / 180 || 0),
        (s.name = t),
        s
      )
    }
  ...
  ;(T_.beforeUpdate = function () {
      ...
      if (this.__dirty || o.__dirty) {
        ...
        if (!i.ignore) {
          ...
          switch (i.__position) {
            ...
            case 'insideStart':
            case 'insideStartBottom':
              ;(d = [v * S + s[0], s[1] + b]), (f = u[0] < 0 ? 'right' : 'left'), (g = [-v * S, -b])
              break
            case 'insideMiddleTop':
            case 'insideMiddle':
            case 'insideMiddleBottom':
    ...
    (T_._createLine = function (i, n, t) {
      ...
      ;(r.shape.percent = 0), nl(r, { shape: { percent: 1 } }, e, n), this.add(r)
    ...
    (T_._updateCommonStl = function (t, e, i) {
      ...
      r.useStyle(A({ strokeNoScale: !0, fill: 'none', stroke: u, opacity: c }, o)),
        (r.hoverStyle = a),
        D(
          b_,
          function (t) {
      ...
      if (
        (p || g) &&
        ((d = u || '#000'), null == (f = n.getFormattedLabel(e, 'normal', t.dataType)))
      ) {
  ...
  ;(D_.isPersistent = function () {
    ...
    (D_.incrementalPrepareUpdate = function (t) {
      ;(this._seriesScope = k_(t)), (this._lineData = null), this.group.removeAll()
    }),
  ...
  function E_(t, e, i, n) {
    var r = 1 - t,
      o = n.dimensions[t]
    return z_(e[r]) && z_(i[r]) && e[t] === i[t] && n.getAxis(o).containData(e[t])
  }
  function N_(t, e) {
    if ('cartesian2d' === t.type) {
      var i = e[0].coord,
  ...
  function R_(t, e, i, n, r) {
    ...
    if (isNaN(l) || isNaN(h)) {
      if (n.getMarkerPosition) o = n.getMarkerPosition(t.getValues(t.dimensions, e))
      else {
        var u = a.dimensions,
          c = t.get(u[0], e),
          d = t.get(u[1], e)
      ...
      if ('cartesian2d' === a.type) {
        ...
        z_(t.get(u[0], e))
          ...
          : z_(t.get(u[1], e)) && (o[1] = p.toGlobalCoord(p.getExtent()[i ? 0 : 1]))
      }
  ...
  function H_(t, e) {
    var i = e.coord[0],
      n = e.coord[1]
    return (
      !('cartesian2d' !== t.type || !i || !n || (!F_(1, i, n) && !F_(0, i, n))) ||
    ...
    if (isNaN(l) || isNaN(h)) {
      ...
      if ('cartesian2d' === a.type) {
        ...
        V_(f)
          ...
          : V_(p) && (o[1] = d.toGlobalCoord(d.getExtent()['y0' === i[1] ? 0 : 1]))
      }
      isNaN(l) || (o[0] = l), isNaN(h) || (o[1] = h)
    } else o = [l, h]
    return o
    ...
    renderSeries: function (e, a, t, i) {
      ...
      var h = (function (t, i, e) {
        ...
        r = t
          ? ((n = P(t && t.dimensions, function (t) {
              var e = i.getData()
              return A({ name: t }, e.getDimensionInfo(e.mapDimension(t)) || {})
            })),
            new kf(
      ...
      a.setData(h),
        ...
        h.eachItemGraphicEl(function (t, e) {
          ...
          t.useStyle(A(i.getModel('itemStyle').getItemStyle(), { fill: Ze(o, 0.4), stroke: o })),
  ...
  var U_,
    ...
    q_ =
      ...
      (Y_ = P((U_ = (U_ = ['x', 'y', 'z', 'radius', 'angle', 'single']).slice()), Jl)),
      (j_ = P((X_ = (X_ || []).slice()), Jl)),
      function (r, o) {
        D(U_, function (t, e) {
          for (var i = { name: t, capital: Y_[e] }, n = 0; n < X_.length; n++) i[X_[n]] = t + j_[n]
          r.call(o, i)
        })
      })
  function $_(r, o, a) {
  ...
  tx.prototype = {
    ...
    calculateDataWindow: function (r) {
      ...
      function t(t, e, i, n, r) {
        ...
        for (var a = 0; a < 2; a++) (e[a] = Il(t[a], i, n, !0)), r && (e[a] = s.parse(e[a]))
      }
      return o ? t(c, u, a, h, !1) : t(u, c, h, a, !0), { valueWindow: c, percentWindow: u }
    },
    reset: function (t) {
      if (t === this._dataZoomModel) {
        ...
        ;(this._valueWindow = i.valueWindow), (this._percentWindow = i.percentWindow), nx(this)
      }
    },
    restore: function (t) {
      t === this._dataZoomModel && ((this._valueWindow = this._percentWindow = null), nx(this, !0))
    },
  ...
  var rx = D,
    ...
    ax = uf({
      ...
      doInit: function (t) {
        var i = this.option
        v.canvasSupported || (i.realtime = !1), this._setDefaultThrottle(t), lx(this, t)
      ...
      _giveAxisProxies: function () {
        ...
        this.eachTargetAxis(function (t, e, i, n) {
          var r = this.dependentModels[t.axis][e],
            o = r.__dzAxisProxy || (r.__dzAxisProxy = new tx(t.name, e, this, n))
          a[t.name + '_' + e] = o
        }, this)
      },
            ...
            this.ecModel.eachSeries(function (r) {
              this._isSeriesHasAllAxesTypeOf(r, 'value') &&
                ox(function (t) {
                  ...
                  x(
                    e,
                    (i = r.ecModel.queryComponents({ mainType: t.axis, index: i, id: n })[0]
                      .componentIndex)
                  ) < 0 && e.push(i)
                })
            }, this)
    ...
    yx = hx.extend({
      ...
      render: function (t, e, i, n) {
        yx.superApply(this, 'render', arguments),
          vc(this, '_dispatchZoomAction', this.dataZoomModel.get('throttle'), 'fixRate'),
      ...
      remove: function () {
        yx.superApply(this, 'remove', arguments), yc(this, '_dispatchZoomAction')
      },
      dispose: function () {
        yx.superApply(this, 'dispose', arguments), yc(this, '_dispatchZoomAction')
      },
      _buildView: function () {
        var t = this.group
            ...
            n.each([r], function (t, e) {
              if (0 < p && e % p) f += d
                ...
                var i = null == t || isNaN(t) || '' === t,
                  n = i ? 0 : cx(t, o, l, !0)
                i && !s && e
                  ? (u.push([u[u.length - 1][0], 0]), c.push([c[c.length - 1][0], 0]))
              ...
              D(
                ...
                function (t) {
                  if (!(l || (!0 !== s && x(vx, t.get('type')) < 0))) {
                    ...
                    null != n && r.getOtherAxis && (e = r.getOtherAxis(i).inverse),
      ...
      _resetInterval: function () {
        ...
        this._handleEnds = [cx(t[0], [0, 100], e, !0), cx(t[1], [0, 100], e, !0)]
      },
      ...
      _updateView: function (t) {
        ...
        px(
          ...
          function (t) {
            ...
            e.attr({ scale: [i / 2, i / 2], position: [r[t], o[1] / 2 - i / 2] })
          },
          this
        ),
          n.filler.setShape({ x: e[0], y: 0, width: e[1] - e[0], height: o[1] }),
    ...
    It.call(this),
      ...
      (this.enable = function (t, e) {
        this.disable(),
          ...
          (!0 !== t && 'scale' !== t && 'zoom' !== t) || (i.on('mousewheel', a), i.on('pinch', s))
      }),
  ...
  function Cx(t) {
    if (
      ...
      ;(this._x = e),
        ...
        Px(this, 'pan', 'moveOnMouseMove', t, { dx: o, dy: a, oldX: n, oldY: r, newX: e, newY: i })
    }
  }
  function Tx(t) {
  ...
  of({ type: 'takeGlobalCursor', event: 'globalCursorTaken', update: 'update' }, function () {}),
    S(Mx, It)
  ...
  function zx(t, n) {
    ...
    var i = e[o]
    i ||
      (((i = e[o] = { coordId: o, dataZoomInfos: {}, count: 0 }).controller = (function (t, a) {
              ...
              D(a.dataZoomInfos, function (t) {
                if (n.isAvailableBehavior(t.dataZoomModel.option)) {
                  ...
                  !t.dataZoomModel.get('disabled', !0) &&
                    i &&
                    r.push({ dataZoomId: t.dataZoomId, start: i[0], end: i[1] })
                }
              }),
    ...
    var a = (function (t) {
      ...
      return (
        D(t, function (t) {
          ...
          r['type_' + n] < r['type_' + i] && (n = i), (o &= e.get('preventDefaultMouseMove', !0))
        }),
        {
          controlType: n,
          opt: {
      ...
      zoom: function (t, e, i, n) {
        ...
        if (a) {
          var s = Gx[e](null, [n.originX, n.originY], a, i, t),
            l =
              ((0 < s.signal ? s.pixelStart + s.pixelLength - s.pixel : s.pixel - s.pixelStart) /
                s.pixelLength) *
                (o[1] - o[0]) +
              o[0],
  ...
  function Wx(l) {
    return function (t, e, i, n) {
      ...
      if (a) {
        var s = l(o, a, t, e, i, n)
        return (
          K_(s, o, [0, 100], 'all'), (this._range = o), r[0] !== o[0] || r[1] !== o[1] ? o : void 0
        )
      }
    }
  }
    ...
    render: function (u, c, d, l) {
      ...
      if ((f.removeAll(), u.get('show'))) {
        ...
        D(h, function (t, e) {
          ...
          new gf(this._featureNames || [], m).add(t).update(t).remove(T(t, null)).execute(),
          ...
          (function (t, e, i) {
            var n = e.getBoxLayoutParams(),
              ...
              a = lh(n, o, r)
            sh(e.get('orient'), t, e.get('itemGap'), a.width, a.height), hh(t, n, o, r)
          })(f, u, d),
          ...
          f.eachChild(function (t) {
            ...
            if (i && e) {
              ...
              r + n.width / 2 > d.getWidth()
                ...
                : r - n.width / 2 < 0 && ((i.textPosition = [0, a]), (i.textAlign = 'left'))
            }
          })
      }
      function t(t, e) {
        ...
        if ((l && null != l.newTitle && l.featureName === n && (o.title = l.newTitle), n && !r)) {
          if (
            (function (t) {
        ...
        n || !r
          ? a.get('show') && !i.unusable
            ? ((function (r, o, t) {
                ...
                var h = (r.iconPaths = {})
                D(e, function (t, e) {
                  var i = hl(t, {}, { x: -p / 2, y: -p / 2, width: p, height: p })
  ...
  ;(qx.defaultOption = {
    ...
    (qx.prototype.onclick = function (t, e) {
      var i = this.model,
        ...
        r = 'svg' === e.getZr().painter.getType() ? 'svg' : i.get('type', !0) || 'png',
      ...
      if ('function' != typeof MouseEvent || v.browser.ie || v.browser.edge)
        ...
        var f = new MouseEvent('click', { view: document.defaultView, bubbles: !0, cancelable: !1 })
        d.dispatchEvent(f)
      }
    }),
    Ux('saveAsImage', qx)
        ...
        t.eachRawSeries(function (t) {
          ...
          if (!e || ('cartesian2d' !== e.type && 'polar' !== e.type)) o.push(t)
            ...
            if ('category' === i.type) {
              ...
              r[n] ||
                ((r[n] = { categoryAxis: i, valueAxis: e.getOtherAxis(i), series: [] }),
            ...
            return P(t, function (t) {
              ...
              return (
                r.each(r.dimensions, function () {
                  for (
                    var t = arguments.length, e = arguments[t - 1], i = r.getName(e), n = 0;
                    n < t - 1;
                    n++
                  )
                    a[n] = arguments[n]
        ...
        if (
          ...
          var i = (function (t) {
              for (
                ...
                i.push(o.shift())
                for (var a = 0; a < o.length; a++) n[a] && (n[a].data[r] = o[a])
              }
          ...
          i = (function (t) {
            for (var e = t.split(/\n+/g), i = aw(e.shift()), n = [], r = 0; r < e.length; r++) {
              var o = aw(e[r])
              if (o) {
                var a,
                  s = o.split(sw),
  ...
  var uw = T,
    ...
    ww = { w: 'ew', e: 'ew', n: 'ns', s: 'ns', ne: 'nesw', sw: 'nesw', nw: 'nwse', se: 'nwse' },
    bw = {
  ...
  function Bw(n, r) {
    ...
    e.useStyle(Fw(t)),
      ...
      cw(['w', 'e', 'n', 's', 'se', 'sw', 'ne', 'nw'], function (t) {
        ...
        e && e.attr({ silent: !o, invisible: !o, cursor: o ? ww[i] + '-resize' : null })
      })
  }
    ...
    updateCovers: function (r) {
      ...
      function t(t, e) {
        ...
        if (null != e && o[e] === l) a[t] = o[e]
          ...
          var n = (a[t] = null != e ? ((o[e].__brushOption = i), o[e]) : Cw(s, Iw(s, i)))
          Dw(s, n)
        }
      }
    },
  ...
  function Kw(t, e) {
    if (t._dragging) {
      ...
      var i = e.offsetX,
        ...
        o = jw(t, e, r, !0)
      ;(t._dragging = !1), (t._track = []), (t._creatingCover = null), o && zw(t, o)
    }
  }
  var Qw = {
    lineX: Jw(0),
  ...
  var nb = D,
    ...
    sb = ['grid', 'xAxis', 'yAxis', 'geo', 'graph', 'polar', 'radiusAxis', 'angleAxis', 'bmap']
  function lb(t, e, i) {
  ...
  ;(hb.setOutputRanges = function (t, e) {
    ...
    (hb.findTargetInfo = function (t, e) {
      for (var i = this._targetInfoList, n = cb(e, t), r = 0; r < i.length; r++) {
        var o = i[r],
          a = t.panelId
        if (a) {
        ...
        ;(r || o || e) &&
          ...
          i.each(function (t) {
            ...
            nb(e.getCartesians(), function (t, e) {
              ;(0 <= rb(r, t.getAxis('x').model) || 0 <= rb(o, t.getAxis('y').model)) && i.push(t)
            }),
              n.push({
                panelId: 'grid--' + t.id,
                gridModel: t,
  ...
  ax.extend({ type: 'dataZoom.select' }), hx.extend({ type: 'dataZoom.select' })
  var Sb = xc.toolbox.dataZoom,
    Mb = D
  function Ib(t, e, i) {
    ;(this._brushController = new Mw(i.getZr())).on('brush', C(this._onBrush, this)).mount(),
      this._isZoomActive
  }
  Ib.defaultOption = {
    show: !0,
    ...
    ;(this.model = t),
      ...
      (function (t, e, i, n, r) {
        ...
        i._brushController
          ...
          .enableBrush(
            !!o && { brushType: 'auto', brushStyle: t.getModel('brushStyle').getItemStyle() }
          )
      })(t, e, this, n, i),
      (function (t, e) {
        t.setIconStatus(
  ...
  ;(Cb._onBrush = function (t, e) {
    if (e.isEnd && t.length) {
      ...
      this._brushController.updateCovers([]),
        new lb(Ab(this.model.option), l, { include: ['grid'] }).matchOutputRanges(
          t,
          l,
          function (t, e, i) {
        ...
        (function (o, t) {
          ...
          xb(t, function (t, e) {
            ...
            if (i < 0) {
              var n = o.queryComponents({ mainType: 'dataZoom', subType: 'select', id: e })[0]
              if (n) {
    ...
    function r(t, e, i) {
      var n = e.getAxis(t),
        ...
        o = (function (e, i, t) {
          var n
          return (
            t.eachComponent({ mainType: 'dataZoom', subType: 'select' }, function (t) {
    ...
    nf(function (s) {
      ...
      function i(n, r) {
        if (r) {
          var o = n + 'Index',
            a = r[o]
          null == a || 'all' === a || O(a) || (a = !1 === a || 'none' === a ? [] : [a]),
            (function (t, e) {
              var i = s[t]
              O(i) || (i = i ? [i] : [])
              Mb(i, e)
  ...
  ;(kb.defaultOption = {
    ...
    Ux('restore', kb),
    of({ type: 'restore', event: 'restore', update: 'prepareAndUpdate' }, function (t, e) {
  ...
  if (!v.canvasSupported) {
            ...
            r
              ? (function (t, e, i) {
                  ...
                  if (null != o)
                    if (o instanceof rs) {
                      ...
                      for (var M = S.length, I = [], C = [], T = 0; T < M; T++) {
                        var A = S[T],
                          D = ((n = A.color), void 0, (r = Ne(n)), [$b(r[0], r[1], r[2]), r[3]])
                        C.push(A.offset * u + h + ' ' + D[0]), (0 !== T && T !== M - 1) || I.push(D)
                      }
                      if (2 <= M) {
                        var k = I[0][0],
                          P = I[1][0],
              ...
              : (function (t, e) {
                  e.lineDash && (t.dashstyle = e.lineDash.join(' ')),
                    null == e.stroke || e.stroke instanceof rs || eS(t, e.stroke, e.opacity)
                })(o, i),
            Kb(t, o))
      ...
      this.__dirtyPath &&
        ...
        (i.path = (function (t, e) {
          ...
          for (o = 0; o < g; ) {
            switch (((n = ''), (i = 0), (r = p[o++]))) {
              case l:
                ;(n = ' m '), (i = 1), (a = p[o++]), (s = p[o++]), (nS[0][0] = a), (nS[0][1] = s)
                break
              case u:
                ;(n = ' l '), (i = 1), (a = p[o++]), (s = p[o++]), (nS[0][0] = a), (nS[0][1] = s)
                break
              case d:
              case h:
                ;(n = ' c '), (i = 3)
              ...
              case c:
                ...
                var O = p[o++],
                  z = T + Wb(P) * D,
                  E = A + Gb(P) * k,
                  N = ((y = T + Wb(L) * D), (_ = A + Gb(L) * k), O ? ' wa ' : ' at ')
                Math.abs(z - y) < 1e-4 &&
                  (0.01 < Math.abs(L - P)
                    ? O && (z += 0.0125)
                    : Math.abs(E - A) < 1e-4
            ...
            if (0 < i) {
              ...
              for (var V = 0; V < i; V++) {
                var F = nS[V]
                e && yt(F, F, e),
                  f.push(Vb(F[0] * Yb - jb), Ub, Vb(F[1] * Yb - jb), V < i - 1 ? Ub : '')
              }
            }
          }
          return f.join('')
    ...
    ;(Yn.prototype.brushVML = function (t) {
      ...
      if (r) {
        ...
        if (v) {
          if (e && i)
            (O.width = Vb((b * e * c) / f) + 'px'), (O.height = Vb((S * i * d) / p) + 'px')
          else {
            var z = new Image(),
              E = this
            ;(z.onload = function () {
          ...
          L || (((L = Eb.createElement('div')).style.overflow = 'hidden'), (this._cropEl = L))
          var N = L.style
          ;(N.width = Vb((c + (g * c) / f) * b)),
            (N.height = Vb((d + (m * d) / p) * S)),
            (N.filter =
              Xb + '.Matrix(Dx=' + ((-g * c) / f) * b + ',Dy=' + ((-m * d) / p) * S + ')'),
    ...
    ;(Rb = function (t, e) {
      ...
      return (rS.innerHTML = ''), rS.appendChild(i.createTextNode(t)), { width: rS.offsetWidth }
    }),
      (sn['measureText'] = Rb)
    for (
      var hS = new bi(),
        uS = function (t, e, i, n) {
          ...
          if ((null != o && (o += ''), o)) {
            ...
            var c,
              ...
              m =
                g.style + ' ' + g.variant + ' ' + g.weight + ' ' + g.size + 'px "' + g.family + '"'
            i = i || hn(o, m, f, p, r.textPadding, r.textLineHeight)
            var v = this.transform
            if ((v && !n && (hS.copy(e), hS.applyTransform(v), (e = hS)), n)) (c = e.x), (d = e.y)
            else {
              var y = r.textPosition
              if (y instanceof Array)
                (c = e.x + tS(y[0], e.width)), (d = e.y + tS(y[1], e.height)), (f = f || 'left')
              else {
            ...
            ;(c = un(c, i.width, f)), (d = cn(d, i.height, p)), (d += i.height / 2)
            var x,
              w,
              b,
              S = Nb,
            ...
            iS(M, 'fill', { fill: r.textFill, opacity: r.opacity }, this),
              iS(
                M,
                'stroke',
                { stroke: r.textStroke, opacity: r.opacity, lineDash: r.lineDash || null },
                this
              ),
      ...
      ;(gS.drawRectText = uS), (gS.removeRectText = cS), (gS.appendRectText = dS)
    }
  ...
  function vS(t, e) {
    !(function () {
      if (!zb && Eb) {
        ...
        t.length < 31
          ? Eb.createStyleSheet().addRule('.zrvml', 'behavior:url(#default#VML)')
  ...
  ;(vS.prototype = {
    ...
    _paintList: function (t) {
      for (var e = this._vmlRoot, i = 0; i < t.length; i++) {
        ...
        n.invisible || n.ignore
          ? (n.__alreadyNotVisible || n.onRemove(e), (n.__alreadyNotVisible = !0))
    ...
    _getWidth: function () {
      var t = this.root,
        e = t.currentStyle
      return ((t.clientWidth || mS(e.width)) - mS(e.paddingLeft) - mS(e.paddingRight)) | 0
    },
    _getHeight: function () {
      var t = this.root,
        e = t.currentStyle
      return ((t.clientHeight || mS(e.height)) - mS(e.paddingTop) - mS(e.paddingBottom)) | 0
    },
  }),
    D(
      [
  ...
  function OS(t, e, i, n) {
    if (
      ...
      LS(t, 'fill', (r = 'transparent' === r ? wS : r)),
        LS(t, 'fill-opacity', null != e.fillOpacity ? e.fillOpacity * e.opacity : e.opacity)
    } else LS(t, 'fill', wS)
    if (
      (function (t, e) {
      ...
      LS(t, 'stroke', (o = 'transparent' === o ? wS : o)),
        LS(
          t,
          'stroke-width',
          (i ? e.textStrokeWidth : e.lineWidth) / (!i && e.strokeNoScale ? n.getLineScale() : 1)
        ),
        LS(t, 'paint-order', i ? 'stroke' : 'fill'),
        LS(t, 'stroke-opacity', null != e.strokeOpacity ? e.strokeOpacity : e.opacity),
        e.lineDash
  ...
  zS.brush = function (t) {
        ...
        for (var e = [], i = t.data, n = t.len(), r = 0; r < n; ) {
          ...
          switch (i[r++]) {
            ...
            case _S.A:
              ...
              var _ = DS(s + h * MS(c)),
                x = DS(l + u * SS(c))
              m && ((d = p ? CS - 1e-4 : 1e-4 - CS), (y = !0), 9 === r && e.push('M', _, x))
              var w = DS(s + h * MS(c + d)),
                b = DS(l + u * SS(c + d))
    ...
    OS(i, e, !1, t), PS(i, t.transform), null != e.text ? HS(t, t.getBoundingRect()) : GS(t)
  }
  var ES = {
      brush: function (t) {
        var e = t.style,
    ...
    HS = function (t, e) {
      ...
      var o = i.text
      if ((null != o && (o += ''), Gn(o, i))) {
        null == o && (o = ''), !r && n && (RS.copy(e), RS.applyTransform(n), (e = RS))
        var a = t.__textSvgEl
        a || ((a = yS('text')), (t.__textSvgEl = a))
        var s = a.style,
          l = i.font || an,
          h = a.__computedFont
        l !== a.__styleFont && ((s.font = a.__styleFont = l), (h = a.__computedFont = s.font))
        var u = i.textPadding,
          c = i.textLineHeight,
          d = t.__textCotentBlock
        ;(d && !t.__dirtyText) || (d = t.__textCotentBlock = yn(o, h, u, c, i.truncate))
        var f = d.outerHeight,
          p = d.lineHeight
        Rn(BS, t, i, e)
        var g = BS.baseX,
        ...
        if (w && t.__canCacheByTextString && t.__text === o) {
          if (t.__dirtyText && S) for (var M = 0; M < S; ++M) WS(b[M], v, _, x + M * p)
        } else {
          ...
          for (M = 0; M < C; M++) {
            var T = b[M],
              A = I[M]
            T
              ? T.__zrText !== A && ((T.innerHTML = ''), T.appendChild(document.createTextNode(A)))
              : ((T = b[M] = yS('tspan')),
                a.appendChild(T),
  ...
  function WS(t, e, i, n) {
    LS(t, 'dominant-baseline', 'middle'), LS(t, 'text-anchor', FS[e]), LS(t, 'x', i), LS(t, 'y', n)
  }
  function GS(t) {
    t &&
      t.__textSvgEl &&
      (t.__textSvgEl.parentNode && t.__textSvgEl.parentNode.removeChild(t.__textSvgEl),
      (t.__textSvgEl = null),
      (t.__tspanList = []),
      (t.__text = null))
  }
            ...
            if (o || a) {
              if (
                (!o || (a && i.newPos < n.newPos)
                  ? ((e = { newPos: (s = n).newPos, components: s.components.slice(0) }),
                    u.pushComponent(e.components, void 0, !0))
                  : ((e = i).newPos++, u.pushComponent(e.components, !0, void 0)),
  ...
  function jS(t, e) {
    YS.call(this, t, e, ['linearGradient', 'radialGradient'], '__gradient_in_use__')
  }
  function qS(t, e) {
  ...
  ;(YS.prototype.createElement = yS),
    (YS.prototype.getDefs = function (t) {
      ...
      return 0 === n.length
        ? t
          ? ((n = e.insertBefore(this.createElement('defs'), e.firstChild)).contains ||
    ...
    (YS.prototype.getSvgProxy = function (t) {
      return t instanceof xa ? zS : t instanceof Yn ? ES : t instanceof Ba ? NS : zS
    }),
    ...
    (jS.prototype.addWithoutUpdate = function (o, a) {
      if (a && a.style) {
        ...
        D(['fill', 'stroke'], function (t) {
          if (a.style[t] && ('linear' === a.style[t].type || 'radial' === a.style[t].type)) {
            var e,
              i = a.style[t],
              n = s.getDefs(!0)
            i._dom ? ((e = i._dom), n.contains(i._dom) || s.addDom(e)) : (e = s.add(i)),
              s.markUsed(a)
    ...
    (jS.prototype.update = function (i) {
      ...
      YS.prototype.update.call(this, i, function () {
        var t = i.type,
          e = i._dom.tagName
        ;('linear' === t && 'linearGradient' === e) || ('radial' === t && 'radialGradient' === e)
    ...
    (jS.prototype.markUsed = function (t) {
      if (t.style) {
        ...
        e && e._dom && YS.prototype.markUsed.call(this, e._dom),
          (e = t.style.stroke) && e._dom && YS.prototype.markUsed.call(this, e._dom)
      }
    }),
    w(qS, YS),
    ...
    (qS.prototype.updateDom = function (t, e, i) {
      if (e && 0 < e.length) {
        var n,
          ...
          s = i ? '_textDom' : '_dom'
        a[s]
          ? ((r = a[s].getAttribute('id')), (n = a[s]), o.contains(n) || o.appendChild(n))
        ...
        if (a.transform && a.parent.invTransform && !i) {
          ...
          re(a.transform, a.parent.invTransform, a.transform), l.brush(a), (a.transform = h)
        } else l.brush(a)
    ...
    ($S.prototype.updateDom = function (t, e) {
      ...
      i.setAttribute('dx', n / l), i.setAttribute('dy', r / h), i.setAttribute('flood-color', a)
      var u = o / 2 / l + ' ' + o / 2 / h
  ...
  ;(oM.prototype = {
    ...
    _paintList: function (t) {
      ...
      for (e = 0; e < o; e++) {
        var s = t[e],
          l = (i = s) instanceof xa ? zS : i instanceof Yn ? ES : i instanceof Ba ? NS : zS,
          h = rM(s) || nM(s)
        s.invisible ||
          (s.__dirty &&
            (l && l.brush(s),
      ...
      for (e = 0; e < c.length; e++) {
        ...
        if ((p = c[e]).added)
          ...
          for (d = 0; d < p.count; d++) {
            ;(h = rM((s = a[p.indices[d]]))), (f = nM(s)), (h = rM(s)), (f = nM(s))
    ...
    _getSize: function (t) {
      ...
      var a = this.root,
        s = document.defaultView.getComputedStyle(a)
      return ((a[n] || QS(s[i]) || QS(a.style[i])) - (QS(s[r]) || 0) - (QS(s[o]) || 0)) | 0
    },
    dispose: function () {
      ;(this.root.innerHTML = ''),
        (this._svgRoot =

        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e, i, a, s, r, n, o) {
              ...
              var c = function (t) {
                return (
                  'radar' === h.config.chart.type && (n = 1), 'M 0 '.concat(h.globals.gridHeight)
                )
              }
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              if (
                ((r =
                  a.globals.gridHeight - o - parseFloat(t.label.style.fontSize) - t.marker.size),
                ...
                if (
                  ...
                  h && (n *= -1),
                    ...
                    (o =
                      ...
                      r.line(
                        l + n,
                        e.barYPosition + e.barHeight - e.strokeWidth - (h ? -1 * n : n)
                      ) +
                      r.quadraticCurve(
                        l + n,
            ...
            value: function (t, e, i, a, s) {
              ...
              return t.config.series[e].type && t.config.series[e].type !== s
                ...
                : '<div class="apexcharts-tooltip-box apexcharts-tooltip-'.concat(
                    ...
                    '</span></div>' +
                    (o
                      ? '<div>'.concat(a[2], ': <span class="value">') + o + '</span></div>'
                      : '') +
        ...
        a(i, [
          ...
          },
          {
            ...
            value: function (t, e, i) {
              var a = new R(i),
                s =
                  'bar' === t && i.plotOptions && i.plotOptions.bar && i.plotOptions.bar.horizontal,
                r =
                  'pie' === t ||
                  'polarArea' === t ||
                  'donut' === t ||
        ...
        a(t, [
          {
            ...
            value: function () {
              ...
              if (i.globals.isXNumeric) {
                ...
                (t = i.globals.gridWidth / o.length), (n = n + t + i.config.xaxis.labels.offsetX)
              for (
                var d = function (s) {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (r.config.stroke.show && !this.pointsChart) {
                var u = null
                u =
                  'line' === e ? l.fillPath({ seriesNumber: i, i: a }) : r.globals.stroke.colors[i]
              ...
              if (s.comboCharts) {
                if (
                  ...
                  if (i.config.chart.stacked) {
                    ...
                    (this.ctx.bar = new X(this.ctx, e)), x.push(this.ctx.bar.draw(h.series, h.i))
                if (
      ...
      function t(t, s, r, n, o, l, h) {
        for (
          ...
          g == c.length &&
            ...
            g == d.length &&
              d.push(['C', f.pos[0], f.pos[1], f.pos[0], f.pos[1], f.pos[0], f.pos[1]])
        }

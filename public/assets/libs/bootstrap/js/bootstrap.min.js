...
!(function (t, e) {
  ...
  const i = {
    ...
    d = (t) =>
      h(t) ? (t.jquery ? t[0] : t) : 'string' == typeof t && t.length > 0 ? i.findOne(t) : null,
    u = (t, e) => {
      let s = !1
      const i = e + 5
            ...
            return function i(n) {
              ...
              for (let { target: r } = n; r && r !== this; r = r.parentNode)
                for (let a = o.length; a--; )
                  if (o[a] === r)
                    return (
                      (n.delegateTarget = r), i.oneOff && $.off(t, n.type, e, s), s.apply(r, [n])
                    )
              return null
            }
          })(t, s, i)
  ...
  $.on(document, 'click.bs.alert.data-api', '[data-bs-dismiss="alert"]', U.handleDismiss(new U())),
    w(U)
  class q extends z {
    static get NAME() {
      return 'button'
  ...
  class At extends z {
    ...
    show(t) {
      ...
      this._isShown ||
        ...
        $.on(this._element, 'click.dismiss.bs.modal', '[data-bs-dismiss="modal"]', (t) =>
          this.hide(t)
        ),
  ...
  class Ct extends z {
    ...
    _addEventListeners() {
      $.on(this._element, 'click.dismiss.bs.offcanvas', '[data-bs-dismiss="offcanvas"]', () =>
        this.hide()
      ),

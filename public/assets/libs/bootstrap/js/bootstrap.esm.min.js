  ...
  return function i(s) {
    ...
    for (let { target: a } = s; a && a !== this; a = a.parentNode)
      for (let r = o.length; r--; )
        if (o[r] === a)
          return (
            (s.delegateTarget = a), i.oneOff && EventHandler.off(e, s.type, t, n), n.apply(a, [s])
          )
    return null
  }
}
...
class BaseComponent {
  ...
  _queueCallback(e, t, n = !0) {
    ...
    EventHandler.one(t, 'transitionend', () => execute(e)), emulateTransitionEnd(t, i)
  }
...
class Carousel extends BaseComponent {
  ...
  _getConfig(e) {
    return (e = { ...Default$9, ...e }), typeCheckConfig(NAME$a, e, DefaultType$9), e
  }
  _handleSwipe() {
  ...
  _keydown(e) {
    ;/input|textarea/i.test(e.target.tagName) ||
      ('ArrowLeft' === e.key
        ...
        : 'ArrowRight' === e.key && (e.preventDefault(), this._slide(DIRECTION_LEFT)))
  }
  _getItemIndex(e) {
    return (
...
class Collapse extends BaseComponent {
  ...
  show() {
    ...
    if (e) {
      ...
      if (((t = i ? Data.get(i, DATA_KEY$8) : null), t && t._isTransitioning)) return
    }
...
class Dropdown extends BaseComponent {
  ...
  _selectMenuItem(e) {
    const t = SelectorEngine.find(SELECTOR_VISIBLE_ITEMS, this._menu).filter(isVisible)
    if (!t.length) return
...
const SELECTOR_FIXED_CONTENT = '.fixed-top, .fixed-bottom, .is-fixed, .sticky-top',
  ...
  Default$6 = { isVisible: !0, isAnimated: !1, rootElement: document.body, clickCallback: null },
  DefaultType$6 = {
    isVisible: 'boolean',
    isAnimated: 'boolean',
    rootElement: 'element',
...
class Modal extends BaseComponent {
  ...
  _getConfig(e) {
    return (
      (e = { ...Default$5, ...Manipulator.getDataAttributes(this._element), ...e }),
  ...
  static jQueryInterface(e, t) {
    return this.each(function () {
      const n = Modal.getInstance(this) || new Modal(this, 'object' == typeof e ? e : {})
      if ('string' == typeof e) {
...
class Offcanvas extends BaseComponent {
  ...
  show(e) {
    this._isShown ||
      ...
      this._backdrop.show(),
      this._config.scroll || (hide(), this._enforceFocusOnElement(this._element)),
      this._element.removeAttribute('aria-hidden'),
      this._element.setAttribute('aria-modal', !0),
      this._element.setAttribute('role', 'dialog'),
      this._element.classList.add('show'),
  ...
  show() {
    ...
    Data.set(i, this.constructor.DATA_KEY, this),
      this._element.ownerDocument.documentElement.contains(this.tip) ||
        (r.appendChild(i), EventHandler.trigger(this._element, this.constructor.Event.INSERTED)),
      this._popper
        ? this._popper.update()
        : (this._popper = Popper.createPopper(this._element, i, this._getPopperConfig(a))),
...
class Popover extends Tooltip {
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      ...
      if (
        (t || !/dispose|hide/.test(e)) &&
        (t || ((t = new Popover(this, n)), Data.set(this, DATA_KEY$3, t)), 'string' == typeof e)
      ) {
        if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`)
        t[e]()
      }
...
class ScrollSpy extends BaseComponent {
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      const t = ScrollSpy.getInstance(this) || new ScrollSpy(this, 'object' == typeof e ? e : {})
      if ('string' == typeof e) {
        if (void 0 === t[e]) throw new TypeError(`No method named "${e}"`)
        t[e]()
      }
  ...
  hide() {
    this._element.classList.contains('show') &&
      (EventHandler.trigger(this._element, EVENT_HIDE).defaultPrevented ||
        ...
        this._queueCallback(
          () => {
            this._element.classList.add('hide'), EventHandler.trigger(this._element, EVENT_HIDDEN)
          },
          this._element,
          this._config.animation
        )))

...
!(function (t, e) {
  ...
  const t = {
    ...
    l = (e) =>
      a(e) ? (e.jquery ? e[0] : e) : 'string' == typeof e && e.length > 0 ? t.findOne(e) : null,
    c = (t, e) => {
      let i = !1
      const n = e + 5
            ...
            return function n(s) {
              ...
              for (let { target: r } = s; r && r !== this; r = r.parentNode)
                for (let a = o.length; a--; )
                  if (o[a] === r)
                    return (
                      (s.delegateTarget = r), n.oneOff && H.off(t, s.type, e, i), i.apply(r, [s])
                    )
              return null
            }
          })(t, i, n)
  ...
  function ut(t) {
    return (
      'undefined' != typeof ShadowRoot && (t instanceof ct(t).ShadowRoot || t instanceof ShadowRoot)
    )
  }
  var ft = {
    name: 'applyStyles',
  ...
  class Ie extends R {
    ...
    show(t) {
      ...
      this._isShown ||
        ...
        H.on(this._element, 'click.dismiss.bs.modal', '[data-bs-dismiss="modal"]', (t) =>
          this.hide(t)
        ),
  ...
  class Me extends R {
    ...
    _addEventListeners() {
      H.on(this._element, 'click.dismiss.bs.offcanvas', '[data-bs-dismiss="offcanvas"]', () =>
        this.hide()
      ),

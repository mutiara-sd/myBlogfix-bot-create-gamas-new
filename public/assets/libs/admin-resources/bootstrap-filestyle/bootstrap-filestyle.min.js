  ...
  i.prototype = {
    ...
    size: function (e) {
      ...
      t.removeClass('btn-lg btn-sm'),
        ...
        'nr' != this.options.size &&
          (t.addClass('btn-' + this.options.size), i.addClass('form-control-' + this.options.size))
    },
    ...
    text: function (e) {
      return void 0 === e
        ? this.options.text
        : ((this.options.text = e),
          void this.$elementFilestyle.find('label .text').html(this.options.text))
    },
    btnClass: function (e) {
      return void 0 === e
        ...
        : ((this.options.btnClass = e),
          void this.$elementFilestyle
            .find('label')
            .attr({ class: 'btn ' + this.options.btnClass + ' btn-' + this.options.size }))
    },
    badge: function (e) {
      if (e === !0) {
        ...
        this.$elementFilestyle
          .find('label')
          .append(' <span class="badge ' + this.options.badgeName + '">' + t.length + '</span>')
      } else {
    ...
    htmlInput: function () {
      return this.options.input
        ? '<input type="text" class="form-control ' +
            ('nr' == this.options.size ? '' : 'form-control-' + this.options.size) +
            '" placeholder="' +
            this.options.placeholder +
            '" disabled> '
        : ''
    ...
    constructor: function () {
      var i = this,
        ...
        s = i.$element.attr('id'),
        l = ''
      ;('' !== s && s) || ((s = 'filestyle-' + t), i.$element.attr({ id: s }), t++),
        (l =
          ...
          '" ' +
          (i.options.disabled || i.$element.attr('disabled') ? ' disabled="true"' : '') +
          '>' +
          i.htmlIcon() +
        ...
        (i.$elementFilestyle = e(
          '<div class="bootstrap-filestyle input-group"><div name="filedrag"></div>' + n + '</div>'
        )),
        i.$elementFilestyle
        ...
        i.$elementFilestyle
          ...
          .css({ 'border-top-left-radius': '.25rem', 'border-bottom-left-radius': '.25rem' }),
        i.$elementFilestyle
          .find('[name="filedrag"]')
          .css({
            position: 'absolute',
          ...
          i.options.badge
            ? 0 == i.$elementFilestyle.find('.badge').length
              ? i.$elementFilestyle
                  .find('label')
                  .append(
                    ' <span class="badge ' + i.options.badgeName + '">' + e.length + '</span>'
                  )
              : 0 == e.length
              ...
              i.options.badge
                ? 0 == i.$elementFilestyle.find('.badge').length
                  ? i.$elementFilestyle
                      .find('label')
                      .append(
                        ' <span class="badge ' + i.options.badgeName + '">' + n.length + '</span>'
                      )
                  : 0 == n.length
                    ? i.$elementFilestyle.find('.badge').remove()

...
!(function (d) {
  ...
  ;(a.DEFAULTS = {
    ...
    (a.prototype.createButtonToolbar = function () {
      var t = this
      ;(this.$btnToolbar = d('[data-responsive-table-toolbar="' + this.id + '"]').addClass(
        'btn-toolbar'
      )),
                ...
                n.$table.hasClass('display-all') &&
                  ...
                  i.each(function () {
                    ...
                    if (e.is(':checked')) {
                      ...
                      !t.closest('thead').length && 1 < parseInt(t.prop('colSpan'))
                        ? t.prop('colSpan', parseInt(t.prop('colSpan')) - 1)
                        : t.hide()
                  })
              })
    ...
    (a.prototype.updateSpanningCells = function () {
      this.$table.find('.spn-cell').each(function () {
        for (
          var t = d(this), i = t.attr('data-columns').split(' '), e = i.length, o = 0, a = 0;
          a < e;
          a++
        )
  ...
  ;(d.fn.responsiveTable = function (o) {
    return this.each(function () {
      ...
      '' !== e.pattern &&
        (i || t.data('responsiveTable', (i = new a(this, e))), 'string' == typeof o && i[o]())
    })
  }),

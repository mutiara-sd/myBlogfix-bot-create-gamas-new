    ...
    w = (function () {
      ...
      function w(d) {
        y.defaults.preventBodyShift &&
          (d && document.documentElement.scrollHeight > document.documentElement.clientHeight
            ...
            : d || ((Ba = Ja), (document.body.style.top = Ia), c(document.body, Ha.fixed), r()))
      }
      function x(a, d, e) {
      ...
      function Q(a) {
        a.get('pinned')
          ...
          : (b(a.elements.root, Ha.unpinned), a.isOpen() && !a.isModal() && N(a))
      }
      function R(a) {
        a.get('maximizable')
      ...
      function W(a) {
        ...
        var b = q[q.length - 1],
          c = a.keyCode
        return 0 === b.__internal.buttons.length && c === o.ESC && !0 === b.get('closable')
          ? (G(b), !1)
          : Ca.indexOf(c) > -1
            ? (U(b, function (a) {
                return a.key === c
      ...
      function Y(a, b) {
        if (b) b.focus()
          ...
          ;(!0 !== a.get('defaultFocusOff') &&
            ((void 0 !== d && null !== d) || 0 !== a.__internal.buttons.length)) ||
      ...
      function ea(a, c) {
        if (null === Wa && !c.isMaximized() && c.get('movable')) {
          ...
          if (
            ('touchstart' === a.type
              ? (a.preventDefault(), (d = a.targetTouches[0]), (Ra = 'clientX'), (Sa = 'clientY'))
              : 0 === a.button && (d = a),
            d)
          ) {
          ...
          if ('get' === d.op)
            return d.found
              ...
              : void 0 !== this.settings
                ? F(this, this.settings, this.settingUpdated || function () {}, a, b).value
                : void 0
          if ('set' === d.op) {
            if (d.items.length > 0)
              for (
        ...
        show: function (a, d) {
          if ((m(this), this.__internal.isOpen)) {
            ...
            if (
              ...
              q.push(this),
              y.defaults.maintainFocus && (this.__internal.activeElement = document.activeElement),
              ...
              this.get('startMaximized') ? this.maximize() : this.isMaximized() && L(this),
              P(this),
          ...
          return (
            this.__internal.isOpen &&
              ...
              y.defaults.maintainFocus &&
                ...
                (this.__internal.activeElement.focus(), (this.__internal.activeElement = null)),
    ...
    x = (function () {
      function d(a) {
        if (!a.__internal) {
          ...
          ;('transitionOff' in p.notifier ? p.notifier.transitionOff : p.transitionOff) &&
      ...
      function i(d, h) {
        function i(a, b) {
          ;(b.__internal.closeButton && 'true' !== a.target.getAttribute('data-close')) ||
            b.dismiss(!0)
        }
        function m(a, b) {
        ...
        return o({
          ...
          dismiss: function (a) {
            return (
              this.__internal.pushed &&
                (p(this),
                ('function' == typeof this.ondismiss && !1 === this.ondismiss.call(this)) ||
          ...
          delay: function (a) {
            if (
              (p(this),
              (this.__internal.delay = void 0 === a || isNaN(+a) ? x.__internal.delay : +a),
      ...
      return {
        ...
        create: function (a, b) {
          ...
          return (
            (c.className =
              n.message + ('string' == typeof a && '' !== a ? ' ' + n.prefix + a : '')),
            i(c, b)
          )
        },
    ...
    y.dialog('confirm', function () {
      ...
      return {
        ...
        setup: function () {
          return {
            buttons: [
              { text: y.defaults.glossary.ok, key: o.ENTER, className: y.defaults.theme.ok },
              {
          ...
          switch (a.index) {
            case 0:
              ;(this.settings.value = b.value),
                'function' == typeof this.get('onok') &&
                  void 0 !== (c = this.get('onok').call(this, a, this.settings.value)) &&
                  (a.cancel = !c)
              break
            case 1:
              'function' == typeof this.get('oncancel') &&
